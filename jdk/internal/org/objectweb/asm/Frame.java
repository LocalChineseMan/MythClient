...
final class Frame {
  ...
  private static int type(ClassWriter paramClassWriter, String paramString) {
    ...
    int i = 0x1700000 | paramClassWriter.addType(str);
    return j - b << 28 | i;
  }
  ...
  boolean merge(ClassWriter paramClassWriter, Frame paramFrame, int paramInt) {
    ...
    for (b = 0; b < this.outputStackTop; b++) {
      ...
      if (i1 == 16777216) {
        ...
        if (i1 == 33554432) {
          i2 = n + this.inputLocals[m & 0x7FFFFF];
        } else {
          i2 = n + this.inputStack[j - (m & 0x7FFFFF)];
        } 
        if ((m & 0x800000) != 0 && (i2 == 16777220 || i2 == 16777219))
          i2 = 16777216; 
      } 
      if (this.initializations != null)
        i2 = init(paramClassWriter, i2); 
      bool |= merge(paramClassWriter, i2, paramFrame.inputStack, k + b);
    } 
    return bool;
  }
