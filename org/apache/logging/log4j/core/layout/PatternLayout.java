...
public final class PatternLayout extends AbstractStringLayout {
  ...
  private static final class PatternLayout {}
    ...
    public AbstractStringLayout.Serializer build() {
      ...
      if (this.patternSelector == null)
        try {
          ...
          return (this.replace == null) ? serializer : (AbstractStringLayout.Serializer)new PatternLayout.PatternSerializerWithReplacement(serializer, this.replace, null);
        } catch (RuntimeException ex) {
          throw new IllegalArgumentException("Cannot parse pattern '" + this.pattern + "'", ex);
        }  
      return (AbstractStringLayout.Serializer)new PatternLayout.PatternSelectorSerializer(this.patternSelector, this.replace, null);
    }
