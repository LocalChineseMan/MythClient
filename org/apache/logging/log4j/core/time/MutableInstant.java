...
public class MutableInstant implements Instant, Serializable, TemporalAccessor {
  ...
  public boolean isSupported(TemporalField field) {
    ...
    return (field != null && field.isSupportedBy((TemporalAccessor)this));
  }
  
  public long getLong(TemporalField field) {
    if (field instanceof ChronoField) {
      switch (null.$SwitchMap$java$time$temporal$ChronoField[((ChronoField)field).ordinal()]) {
        case 1:
          return this.nanoOfSecond;
        case 2:
    ...
    return field.getFrom((TemporalAccessor)this);
  }
  ...
  public int get(TemporalField field) {
    ...
    return range(field).checkValidIntValue(field.getFrom((TemporalAccessor)this), field);
  }
  ...
  public <R> R query(TemporalQuery<R> query) {
    ...
    if (query == TemporalQueries.chronology() || query == 
      ...
      return null; 
    return query.queryFrom((TemporalAccessor)this);
  }
