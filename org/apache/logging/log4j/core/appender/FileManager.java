  ...
  private static class FileManagerFactory implements ManagerFactory<FileManager, FactoryData> {
    ...
    public FileManager createManager(String name, FileManager.FactoryData data) {
      ...
      try {
        ...
        boolean writeHeader = (!FileManager.FactoryData.access$100(data) || !file.exists());
        int actualSize = FileManager.FactoryData.access$200(data) ? FileManager.FactoryData.access$300(data) : Constants.ENCODER_BYTE_BUFFER_SIZE;
        ByteBuffer byteBuffer = ByteBuffer.wrap(new byte[actualSize]);
        FileOutputStream fos = FileManager.FactoryData.access$400(data) ? null : new FileOutputStream(file, FileManager.FactoryData.access$100(data));
        FileManager fm = new FileManager(data.getLoggerContext(), name, fos, FileManager.FactoryData.access$100(data), FileManager.FactoryData.access$500(data), FileManager.FactoryData.access$400(data), FileManager.FactoryData.access$600(data), FileManager.FactoryData.access$700(data), FileManager.FactoryData.access$800(data), FileManager.FactoryData.access$900(data), FileManager.FactoryData.access$1000(data), writeHeader, byteBuffer);
