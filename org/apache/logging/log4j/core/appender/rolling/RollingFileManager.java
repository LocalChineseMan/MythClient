...
public class RollingFileManager extends FileManager {
  ...
  private static class RollingFileManager {}
  ...
  private static class RollingFileManagerFactory implements ManagerFactory<RollingFileManager, FactoryData> {
    ...
    public RollingFileManager createManager(String name, RollingFileManager.FactoryData data) {
      long size = 0L;
      File file = null;
      if (RollingFileManager.FactoryData.access$200(data) != null) {
        file = new File(RollingFileManager.FactoryData.access$200(data));
        try {
          FileUtils.makeParentDirs(file);
          boolean created = RollingFileManager.FactoryData.access$300(data) ? false : file.createNewFile();
        ...
        size = RollingFileManager.FactoryData.access$600(data) ? file.length() : 0L;
      } 
      try {
        int actualSize = RollingFileManager.FactoryData.access$700(data) ? RollingFileManager.FactoryData.access$800(data) : Constants.ENCODER_BYTE_BUFFER_SIZE;
        ByteBuffer buffer = ByteBuffer.wrap(new byte[actualSize]);
        OutputStream os = (RollingFileManager.FactoryData.access$300(data) || RollingFileManager.FactoryData.access$200(data) == null) ? null : new FileOutputStream(RollingFileManager.FactoryData.access$200(data), RollingFileManager.FactoryData.access$600(data));
        ...
        RollingFileManager rm = new RollingFileManager(data.getLoggerContext(), RollingFileManager.FactoryData.access$200(data), RollingFileManager.FactoryData.access$1000(data), os, RollingFileManager.FactoryData.access$600(data), RollingFileManager.FactoryData.access$300(data), size, initialTime, RollingFileManager.FactoryData.access$1100(data), RollingFileManager.FactoryData.access$1200(data), RollingFileManager.FactoryData.access$1300(data), RollingFileManager.FactoryData.access$1400(data), RollingFileManager.FactoryData.access$1500(data), RollingFileManager.FactoryData.access$1600(data), RollingFileManager.FactoryData.access$1700(data), writeHeader, buffer);
