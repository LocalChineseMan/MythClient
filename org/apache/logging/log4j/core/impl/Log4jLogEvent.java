...
public class Log4jLogEvent implements LogEvent {
  ...
  public Builder asBuilder() {
    return new Builder((LogEvent)this);
  }
  
  public Log4jLogEvent toImmutable() {
    if (getMessage() instanceof org.apache.logging.log4j.message.ReusableMessage)
  ...
  public void makeMessageImmutable() {
    this.message = (Message)new MementoMessage(this.message.getFormattedMessage(), this.message.getFormat(), this.message.getParameters());
  }
  ...
  public static Log4jLogEvent deserialize(Serializable event) {
    ...
    if (event instanceof LogEventProxy) {
      ...
      Log4jLogEvent result = new Log4jLogEvent(LogEventProxy.access$900(proxy), LogEventProxy.access$1000(proxy), LogEventProxy.access$1100(proxy), LogEventProxy.access$1200(proxy), LogEventProxy.access$1300(proxy), LogEventProxy.access$1400(proxy), LogEventProxy.access$1500(proxy), LogEventProxy.access$1600(proxy), LogEventProxy.access$1700(proxy), LogEventProxy.access$1800(proxy), LogEventProxy.access$1900(proxy), LogEventProxy.access$2000(proxy), LogEventProxy.access$2100(proxy), LogEventProxy.access$2200(proxy), LogEventProxy.access$2300(proxy), LogEventProxy.access$2400(proxy));
      result.setEndOfBatch(LogEventProxy.access$2500(proxy));
      result.setIncludeLocation(LogEventProxy.access$2600(proxy));
      return result;
    } 
  ...
  public static LogEvent createMemento(LogEvent logEvent) {
    return (LogEvent)(new Builder(logEvent)).build();
  }
