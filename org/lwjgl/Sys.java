...
public final class Sys {
  ...
  private static SysImplementation createImplementation() {
    switch (LWJGLUtil.getPlatform()) {
      case 1:
        return (SysImplementation)new LinuxSysImplementation();
      case 3:
        return new WindowsSysImplementation();
      case 2:
        return (SysImplementation)new MacOSXSysImplementation();
    } 
  ...
  public static boolean openURL(String url) {
    try {
      ...
      Method lookupMethod = AccessController.<Method>doPrivileged((PrivilegedExceptionAction<Method>)new Object(serviceManagerClass));
      ...
      Method showDocumentMethod = AccessController.<Method>doPrivileged((PrivilegedExceptionAction<Method>)new Object(basicServiceClass));
      try {
