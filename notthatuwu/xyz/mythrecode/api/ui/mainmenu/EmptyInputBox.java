  ...
  public void drawTextBox() {
    if (getVisible()) {
      ...
      if (s.length() > 0) {
        ...
        j1 = (int)FontLoaders.Sfui16.drawStringWithShadow(this.text, (this.xPosition - 3 - this.text.length()), (this.yPosition + 6), -1);
      } 
      ...
      if (s.length() > 0 && flag && j < s.length())
        j1 = (int)FontLoaders.Sfui16.drawString(s.substring(j), j1, i1, i); 
      if (flag1)
        if (flag2) {
          Gui.drawRect(k1, (i1 - 1), (k1 + 1), (i1 + 1 + this.fontRendererInstance.FONT_HEIGHT), (new Color(50, 50, 50)).getRGB());
        } else {
          FontLoaders.Sfui16.drawString("_", k1 + 2.0F, i1, i);
        }  
      if (k != j) {
