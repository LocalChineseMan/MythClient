...
public class MethodHandles {
  ...
  public static <T extends java.lang.reflect.Member> T reflectAs(Class<T> paramClass, MethodHandle paramMethodHandle) {
    ...
    return lookup.revealDirect(paramMethodHandle).reflectAs(paramClass, lookup);
  }
  ...
  public static final class Lookup {
    ...
    public Lookup in(Class<?> param1Class) {
      ...
      if ((i & 0x8) != 0 && 
        !VerifyAccess.isSamePackage(this.lookupClass, param1Class))
        i &= 0xFFFFFFF5; 
      if ((i & 0x2) != 0 && 
        !VerifyAccess.isSamePackageMember(this.lookupClass, param1Class))
        i &= 0xFFFFFFFD; 
      if ((i & 0x1) != 0 && 
        !VerifyAccess.isClassAccessible(param1Class, this.lookupClass, this.allowedModes))
        i = 0; 
    ...
    private static void checkUnprivilegedlookupClass(Class<?> param1Class, int param1Int) {
      ...
      if (param1Int == 15 && param1Class.getClassLoader() == null && (
        str.startsWith("java.") || (str
        .startsWith("sun.") && !str.startsWith("sun.invoke."))))
        throw MethodHandleStatics.newIllegalArgumentException("illegal lookupClass: " + param1Class); 
    }
    ...
    private MethodHandle findVirtualForMH(String param1String, MethodType param1MethodType) {
      ...
      if ("invokeBasic".equals(param1String))
        return MethodHandles.basicInvoker(param1MethodType); 
    ...
    private MethodHandle unreflectForMH(Method param1Method) {
      if (MemberName.isMethodHandleInvokeName(param1Method.getName()))
        return MethodHandleImpl.fakeMethodHandleInvoke(new MemberName(param1Method)); 
      return null;
    }
    ...
    public MethodHandle unreflectGetter(Field param1Field) throws IllegalAccessException {
      return unreflectField(param1Field, false);
    }
    ...
    public MethodHandle unreflectSetter(Field param1Field) throws IllegalAccessException {
      return unreflectField(param1Field, true);
    }
    ...
    MemberName resolveOrFail(byte param1Byte, Class<?> param1Class1, String param1String, Class<?> param1Class2) throws NoSuchFieldException, IllegalAccessException {
      ...
      return MethodHandles.IMPL_NAMES.resolveOrFail(param1Byte, new MemberName(param1Class1, param1String, param1Class2, param1Byte), lookupClassOrNull(), NoSuchFieldException.class);
    }
    ...
    MemberName resolveOrFail(byte param1Byte, Class<?> param1Class, String param1String, MethodType param1MethodType) throws NoSuchMethodException, IllegalAccessException {
      ...
      return MethodHandles.IMPL_NAMES.resolveOrFail(param1Byte, new MemberName(param1Class, param1String, param1MethodType, param1Byte), lookupClassOrNull(), NoSuchMethodException.class);
    }
    ...
    MemberName resolveOrFail(byte param1Byte, MemberName param1MemberName) throws ReflectiveOperationException {
      ...
      return MethodHandles.IMPL_NAMES.resolveOrFail(param1Byte, param1MemberName, lookupClassOrNull(), ReflectiveOperationException.class);
    }
    ...
    void checkSecurityManager(Class<?> param1Class, MemberName param1MemberName) {
      ...
      if (!bool || 
        !VerifyAccess.classLoaderIsAncestor(this.lookupClass, param1Class))
    ...
    void checkField(byte param1Byte, Class<?> param1Class, MemberName param1MemberName) throws IllegalAccessException {
      String str;
      boolean bool = !MethodHandleNatives.refKindHasReceiver(param1Byte);
    ...
    void checkAccess(byte param1Byte, Class<?> param1Class, MemberName param1MemberName) throws IllegalAccessException {
      assert param1MemberName.referenceKindIsConsistentWith(param1Byte) && 
        MethodHandleNatives.refKindIsValid(param1Byte) && 
        MethodHandleNatives.refKindIsField(param1Byte) == param1MemberName.isField();
      int i = this.allowedModes;
      if (i == -1)
        return; 
      int j = param1MemberName.getModifiers();
      if (Modifier.isProtected(j) && param1Byte == 5 && param1MemberName
        
        .getDeclaringClass() == Object.class && param1MemberName
        .getName().equals("clone") && param1Class
        .isArray())
        j ^= 0x5; 
      if (Modifier.isProtected(j) && param1Byte == 8)
        j ^= 0x4; 
      if (Modifier.isFinal(j) && 
        MethodHandleNatives.refKindIsSetter(param1Byte))
      ...
      int k = fixmods(j);
      if ((k & i) != 0) {
        if (VerifyAccess.isMemberAccessible(param1Class, param1MemberName.getDeclaringClass(), j, 
            lookupClass(), i))
          return; 
      } else if ((k & 0x4) != 0 && (i & 0x8) != 0 && 
        VerifyAccess.isSamePackage(param1MemberName.getDeclaringClass(), lookupClass())) {
        return;
      } 
    ...
    String accessFailedMessage(Class<?> param1Class, MemberName param1MemberName) {
      ...
      boolean bool = (Modifier.isPublic(clazz.getModifiers()) && (clazz == param1Class || Modifier.isPublic(param1Class.getModifiers()))) ? true : false;
      if (!bool && (this.allowedModes & 0x8) != 0)
        bool = (VerifyAccess.isClassAccessible(clazz, lookupClass(), 15) && (clazz == param1Class || VerifyAccess.isClassAccessible(param1Class, lookupClass(), 15))) ? true : false; 
      if (!bool)
    ...
    private void checkSpecialCaller(Class<?> param1Class) throws IllegalAccessException {
      ...
      if (i == -1)
        return; 
      if (!hasPrivateAccess() || param1Class != 
        lookupClass())
        throw (new MemberName(param1Class))
          .makeAccessException("no private access for invokespecial", this); 
    }
    
    private boolean restrictProtectedReceiver(MemberName param1MemberName) {
      if (param1MemberName.isProtected() && !param1MemberName.isStatic() && this.allowedModes != -1 && param1MemberName
    ...
    private MethodHandle restrictReceiver(MemberName param1MemberName, DirectMethodHandle param1DirectMethodHandle, Class<?> param1Class) throws IllegalAccessException {
      ...
      if (methodType1.parameterType(0) == param1Class)
    ...
    private MethodHandle getDirectMethod(byte param1Byte, Class<?> param1Class1, MemberName param1MemberName, Class<?> param1Class2) throws IllegalAccessException {
      return getDirectMethodCommon(param1Byte, param1Class1, param1MemberName, true, true, param1Class2);
    }
    ...
    private MethodHandle getDirectMethodNoRestrict(byte param1Byte, Class<?> param1Class1, MemberName param1MemberName, Class<?> param1Class2) throws IllegalAccessException {
      return getDirectMethodCommon(param1Byte, param1Class1, param1MemberName, true, false, param1Class2);
    }
    ...
    private MethodHandle getDirectMethodNoSecurityManager(byte param1Byte, Class<?> param1Class1, MemberName param1MemberName, Class<?> param1Class2) throws IllegalAccessException {
      return getDirectMethodCommon(param1Byte, param1Class1, param1MemberName, false, true, param1Class2);
    }
    ...
    private MethodHandle getDirectMethodCommon(byte param1Byte, Class<?> param1Class1, MemberName param1MemberName, boolean param1Boolean1, boolean param1Boolean2, Class<?> param1Class2) throws IllegalAccessException {
      ...
      if (param1Byte == 7 && param1Class1 != 
        lookupClass() && 
        !param1Class1.isInterface() && param1Class1 != 
        lookupClass().getSuperclass() && param1Class1
        ...
        do {
          ...
          memberName = MethodHandles.IMPL_NAMES.resolveOrNull(param1Byte, memberName, lookupClassOrNull());
      ...
      MethodHandle methodHandle = directMethodHandle;
      if (param1Boolean2 && (param1Byte == 7 || (
        
        MethodHandleNatives.refKindHasReceiver(param1Byte) && 
        restrictProtectedReceiver(param1MemberName))))
        methodHandle = restrictReceiver(param1MemberName, directMethodHandle, lookupClass()); 
      methodHandle = maybeBindCaller(param1MemberName, methodHandle, param1Class2);
      methodHandle = methodHandle.setVarargs(param1MemberName);
      return methodHandle;
    }
    ...
    private MethodHandle getDirectField(byte param1Byte, Class<?> param1Class, MemberName param1MemberName) throws IllegalAccessException {
      return getDirectFieldCommon(param1Byte, param1Class, param1MemberName, true);
    }
    ...
    private MethodHandle getDirectFieldNoSecurityManager(byte param1Byte, Class<?> param1Class, MemberName param1MemberName) throws IllegalAccessException {
      return getDirectFieldCommon(param1Byte, param1Class, param1MemberName, false);
    }
    ...
    private MethodHandle getDirectFieldCommon(byte param1Byte, Class<?> param1Class, MemberName param1MemberName, boolean param1Boolean) throws IllegalAccessException {
      ...
      boolean bool = (MethodHandleNatives.refKindHasReceiver(param1Byte) && restrictProtectedReceiver(param1MemberName)) ? true : false;
      if (bool)
        return restrictReceiver(param1MemberName, directMethodHandle, lookupClass()); 
    ...
    private MethodHandle getDirectConstructor(Class<?> param1Class, MemberName param1MemberName) throws IllegalAccessException {
      return getDirectConstructorCommon(param1Class, param1MemberName, true);
    }
    ...
    private MethodHandle getDirectConstructorNoSecurityManager(Class<?> param1Class, MemberName param1MemberName) throws IllegalAccessException {
      return getDirectConstructorCommon(param1Class, param1MemberName, false);
    }
    ...
    MethodHandle linkMethodHandleConstant(byte param1Byte, Class<?> param1Class, String param1String, Object param1Object) throws ReflectiveOperationException {
      ...
      MethodHandle methodHandle = LOOKASIDE_TABLE.get(memberName1);
      if (methodHandle != null) {
        checkSymbolicClass(param1Class);
        return methodHandle;
      } 
      ...
      if (methodHandle instanceof DirectMethodHandle && 
        canBeCached(param1Byte, param1Class, memberName2)) {
    ...
    private boolean canBeCached(byte param1Byte, Class<?> param1Class, MemberName param1MemberName) {
      if (param1Byte == 7)
        return false; 
      if (!Modifier.isPublic(param1Class.getModifiers()) || 
        !Modifier.isPublic(param1MemberName.getDeclaringClass().getModifiers()) || 
        !param1MemberName.isPublic() || param1MemberName
        .isCallerSensitive())
        return false; 
      ...
      try {
        MemberName memberName = MethodHandles.publicLookup().resolveOrFail(param1Byte, new MemberName(param1Byte, param1Class, param1MemberName
              .getName(), param1MemberName.getType()));
  ...
  public static MethodHandle explicitCastArguments(MethodHandle paramMethodHandle, MethodType paramMethodType) {
    ...
    if (methodType == paramMethodType)
      return paramMethodHandle; 
    if (methodType.explicitCastEquivalentToAsType(paramMethodType))
  ...
  public static MethodHandle permuteArguments(MethodHandle paramMethodHandle, MethodType paramMethodType, int... paramVarArgs) {
    ...
    while ((j = findFirstDupOrDrop(paramVarArgs, i)) != 0) {
      if (j > 0) {
        ...
        int k = j ^ 0xFFFFFFFF;
        byte b = 0;
        while (b < paramVarArgs.length && paramVarArgs[b] < k)
          b++; 
    ...
    if (paramMethodType == boundMethodHandle.type() && lambdaForm == boundMethodHandle.internalForm())
      return boundMethodHandle; 
    return boundMethodHandle.copyWith(paramMethodType, lambdaForm);
  }
  ...
  public static MethodHandle constant(Class<?> paramClass, Object paramObject) {
    if (paramClass.isPrimitive()) {
      ...
      if (wrapper.zero().equals(paramObject))
        return zero(wrapper, paramClass); 
  ...
  public static MethodHandle insertArguments(MethodHandle paramMethodHandle, int paramInt, Object... paramVarArgs) {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      Class<?> clazz = arrayOfClass[paramInt + b];
  ...
  private static int dropArgumentChecks(MethodType paramMethodType, int paramInt, List<Class<?>> paramList) {
    ...
    if (paramInt < 0 || paramInt > j)
      throw MethodHandleStatics.newIllegalArgumentException("no argument type to remove" + 
          Arrays.asList(new Object[] { paramMethodType, Integer.valueOf(paramInt), paramList, Integer.valueOf(k), Integer.valueOf(j) })); 
    return i;
  }
  ...
  static MethodHandle filterArgument(MethodHandle paramMethodHandle1, int paramInt, MethodHandle paramMethodHandle2) {
    ...
    LambdaForm lambdaForm = boundMethodHandle.editor().filterArgumentForm(1 + paramInt, LambdaForm.BasicType.basicType(clazz));
    MethodType methodType3 = methodType1.changeParameterType(paramInt, clazz);
    boundMethodHandle = boundMethodHandle.copyWithExtendL(methodType3, lambdaForm, paramMethodHandle2);
    return boundMethodHandle;
  }
  ...
  private static void filterArgumentChecks(MethodHandle paramMethodHandle1, int paramInt, MethodHandle paramMethodHandle2) throws RuntimeException {
    MethodType methodType1 = paramMethodHandle1.type();
    MethodType methodType2 = paramMethodHandle2.type();
    if (methodType2.parameterCount() != 1 || methodType2
      .returnType() != methodType1.parameterType(paramInt))
  ...
  private static void filterReturnValueChecks(MethodType paramMethodType1, MethodType paramMethodType2) throws RuntimeException {
    ...
    if ((i == 0) ? (clazz != void.class) : (clazz != paramMethodType2
  ...
  public static MethodHandle foldArguments(MethodHandle paramMethodHandle1, MethodHandle paramMethodHandle2) {
    ...
    BoundMethodHandle boundMethodHandle = paramMethodHandle1.rebind();
    boolean bool = (clazz == void.class) ? true : false;
    LambdaForm lambdaForm = boundMethodHandle.editor().foldArgumentsForm(1 + b, bool, methodType2.basicType());
  ...
  private static Class<?> foldArgumentChecks(int paramInt, MethodType paramMethodType1, MethodType paramMethodType2) {
    ...
    int j = paramInt + b;
    boolean bool = (paramMethodType1.parameterCount() >= j + i) ? true : false;
    if (bool && 
      !paramMethodType2.parameterList().equals(paramMethodType1.parameterList().subList(j, j + i)))
      bool = false; 
    if (bool && b != 0 && paramMethodType2.returnType() != paramMethodType1.parameterType(0))
      bool = false; 
    if (!bool)
  ...
  public static MethodHandle guardWithTest(MethodHandle paramMethodHandle1, MethodHandle paramMethodHandle2, MethodHandle paramMethodHandle3) {
    ...
    List<Class<?>> list1 = methodType2.parameterList();
    List<Class<?>> list2 = methodType1.parameterList();
    if (!list1.equals(list2)) {
      int i = list2.size(), j = list1.size();
  ...
  public static MethodHandle catchException(MethodHandle paramMethodHandle1, Class<? extends Throwable> paramClass, MethodHandle paramMethodHandle2) {
    ...
    if (methodType2.parameterCount() < 1 || 
      !methodType2.parameterType(0).isAssignableFrom(paramClass))
    ...
    List<Class<?>> list1 = methodType1.parameterList();
