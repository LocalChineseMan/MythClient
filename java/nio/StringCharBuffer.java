...
class StringCharBuffer extends CharBuffer {
  ...
  public CharBuffer slice() {
    return new StringCharBuffer(this.str, -1, 0, 
        
        remaining(), 
        remaining(), this.offset + 
        position());
  }
  ...
  public CharBuffer duplicate() {
    return new StringCharBuffer(this.str, markValue(), 
        position(), limit(), capacity(), this.offset);
  }
  ...
  public final char get(int paramInt) {
    return this.str.charAt(checkIndex(paramInt) + this.offset);
  }
  
  char getUnchecked(int paramInt) {
    return this.str.charAt(paramInt + this.offset);
  }
  ...
  final String toString(int paramInt1, int paramInt2) {
    return this.str.toString().substring(paramInt1 + this.offset, paramInt2 + this.offset);
  }
  
  public final CharBuffer subSequence(int paramInt1, int paramInt2) {
    try {
      int i = position();
      return new StringCharBuffer(this.str, -1, i + 
          
          checkIndex(paramInt1, i), i + 
          checkIndex(paramInt2, i), 
