...
public final class FileTime implements Comparable<FileTime> {
  ...
  public Instant toInstant() {
    if (this.instant == null) {
      long l = 0L;
      int i = 0;
      switch (null.$SwitchMap$java$util$concurrent$TimeUnit[this.unit.ordinal()]) {
        case 1:
  ...
  public boolean equals(Object paramObject) {
    return (paramObject instanceof FileTime) ? ((compareTo((FileTime)paramObject) == 0)) : false;
  }
  ...
  private long toExcessNanos(long paramLong) {
    ...
    return TimeUnit.SECONDS.toNanos(toInstant().getEpochSecond() - TimeUnit.DAYS
        .toSeconds(paramLong));
  }
