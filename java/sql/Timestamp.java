...
public class Timestamp extends Date {
  ...
  public static Timestamp valueOf(String paramString) {
    ...
    if (i3 > 0 && i4 > 0 && i4 < str1.length() - 1) {
      ...
      if (str7.length() == 4 && str8
        .length() >= 1 && str8.length() <= 2 && str9
        .length() >= 1 && str9.length() <= 2) {
    ...
    if (!bool)
      throw new IllegalArgumentException(str3); 
    if ((((i6 > 0) ? 1 : 0) & ((i7 > 0) ? 1 : 0) & (
      (i7 < str2.length() - 1) ? 1 : 0)) != 0) {
  ...
  public int compareTo(Timestamp paramTimestamp) {
    ...
    boolean bool = (l1 < l2) ? true : ((l1 == l2) ? false : true);
    if (!bool) {
      if (this.nanos > paramTimestamp.nanos)
        return 1; 
      if (this.nanos < paramTimestamp.nanos)
  ...
  public static Timestamp valueOf(LocalDateTime paramLocalDateTime) {
    return new Timestamp(paramLocalDateTime.getYear() - 1900, paramLocalDateTime
        .getMonthValue() - 1, paramLocalDateTime
        .getDayOfMonth(), paramLocalDateTime
        .getHour(), paramLocalDateTime
        .getMinute(), paramLocalDateTime
        .getSecond(), paramLocalDateTime
        .getNano());
  }
