...
class MutableBigInteger {
  ...
  private long toLong() {
    ...
    return (this.intLen == 2) ? (l << 32L | this.value[this.offset + 1] & 0xFFFFFFFFL) : l;
  }
  ...
  BigDecimal toBigDecimal(int paramInt1, int paramInt2) {
    ...
    long l = (i == 2) ? (arrayOfInt[1] & 0xFFFFFFFFL | (j & 0xFFFFFFFFL) << 32L) : (j & 0xFFFFFFFFL);
  ...
  void clear() {
    ...
    byte b;
    int i;
    for (b = 0, i = this.value.length; b < i; b++)
      this.value[b] = 0; 
  }
  ...
  final int compare(MutableBigInteger paramMutableBigInteger) {
    ...
    for (int j = this.offset, k = paramMutableBigInteger.offset; j < this.intLen + this.offset; j++, k++) {
  ...
  private int compareShifted(MutableBigInteger paramMutableBigInteger, int paramInt) {
    ...
    if (j > i)
      return 1; 
    int[] arrayOfInt = paramMutableBigInteger.value;
    for (int k = this.offset, m = paramMutableBigInteger.offset; k < j + this.offset; k++, m++) {
  ...
  final int compareHalf(MutableBigInteger paramMutableBigInteger) {
    ...
    int m;
    byte b2;
    for (m = this.offset, b2 = b1; m < j + this.offset; ) {
  ...
  private final long getLong(int paramInt) {
    return this.value[this.offset + paramInt] & 0xFFFFFFFFL;
  }
  ...
  int[] toIntArray() {
    ...
    for (byte b = 0; b < this.intLen; b++)
      arrayOfInt[b] = this.value[this.offset + b]; 
    return arrayOfInt;
  }
  ...
  boolean isOdd() {
    return isZero() ? false : (((this.value[this.offset + this.intLen - 1] & 0x1) == 1));
  }
  ...
  void leftShift(int paramInt) {
    ...
    if (this.value.length < m) {
      ...
      for (byte b = 0; b < m - this.intLen; b++)
        this.value[this.offset + this.intLen + b] = 0; 
    } else {
      int n;
  ...
  private int mulsub(int[] paramArrayOfint1, int[] paramArrayOfint2, int paramInt1, int paramInt2, int paramInt3) {
    ...
    for (int i = paramInt2 - 1; i >= 0; i--) {
      ...
      l2 = (l3 >>> 32L) + (((l4 & 0xFFFFFFFFL) > (((int)l3 ^ 0xFFFFFFFF) & 0xFFFFFFFFL)) ? 1L : 0L);
    } 
    return (int)l2;
  }
  ...
  private final void primitiveRightShift(int paramInt) {
    ...
    int i = 32 - paramInt;
    for (int j = this.offset + this.intLen - 1, k = arrayOfInt[j]; j > this.offset; j--) {
      int m = k;
      k = arrayOfInt[j - 1];
  ...
  private final void primitiveLeftShift(int paramInt) {
    int[] arrayOfInt = this.value;
    int i = 32 - paramInt;
    for (int j = this.offset, k = arrayOfInt[j], m = j + this.intLen - 1; j < m; j++) {
      int n = k;
      k = arrayOfInt[j + 1];
  ...
  private BigInteger getLower(int paramInt) {
    ...
    return new BigInteger(Arrays.copyOfRange(this.value, this.offset + this.intLen - i, this.offset + this.intLen), bool);
  }
  ...
  void addShifted(MutableBigInteger paramMutableBigInteger, int paramInt) {
    ...
    while (i > 0 && j > 0) {
      i--;
      j--;
      boolean bool = (j + paramMutableBigInteger.offset < paramMutableBigInteger.value.length) ? paramMutableBigInteger.value[j + paramMutableBigInteger.offset] : false;
      long l1 = (this.value[i + this.offset] & 0xFFFFFFFFL) + (bool & 0xFFFFFFFFL) + l;
      arrayOfInt[m--] = (int)l1;
      l = l1 >>> 32L;
    } 
    while (i > 0) {
  ...
  int subtract(MutableBigInteger paramMutableBigInteger) {
    ...
    while (m > 0) {
      k--;
      m--;
      l = (mutableBigInteger.value[k + mutableBigInteger.offset] & 0xFFFFFFFFL) - (paramMutableBigInteger.value[m + paramMutableBigInteger.offset] & 0xFFFFFFFFL) - (int)-(l >> 32L);
      arrayOfInt[n--] = (int)l;
    } 
    while (k > 0) {
      k--;
      l = (mutableBigInteger.value[k + mutableBigInteger.offset] & 0xFFFFFFFFL) - (int)-(l >> 32L);
      arrayOfInt[n--] = (int)l;
    } 
    this.value = arrayOfInt;
    this.intLen = j;
  ...
  private int difference(MutableBigInteger paramMutableBigInteger) {
    ...
    while (k > 0) {
      j--;
      k--;
      l = (mutableBigInteger.value[mutableBigInteger.offset + j] & 0xFFFFFFFFL) - (paramMutableBigInteger.value[paramMutableBigInteger.offset + k] & 0xFFFFFFFFL) - (int)-(l >> 32L);
      mutableBigInteger.value[mutableBigInteger.offset + j] = (int)l;
    } 
    while (j > 0) {
      j--;
      l = (mutableBigInteger.value[mutableBigInteger.offset + j] & 0xFFFFFFFFL) - (int)-(l >> 32L);
      mutableBigInteger.value[mutableBigInteger.offset + j] = (int)l;
    } 
    mutableBigInteger.normalize();
    return i;
  ...
  int divideOneWord(int paramInt, MutableBigInteger paramMutableBigInteger) {
    ...
    while (--k > 0) {
      int m;
      long l = l2 << 32L | this.value[this.offset + this.intLen - k] & 0xFFFFFFFFL;
      if (l >= 0L) {
        m = (int)(l / l1);
        j = (int)(l - m * l1);
      } else {
  ...
  long divide(long paramLong, MutableBigInteger paramMutableBigInteger) {
    ...
    paramMutableBigInteger.clear();
    if (i == 0)
      return divideOneWord((int)paramLong, paramMutableBigInteger) & 0xFFFFFFFFL; 
  ...
  private static void copyAndShift(int[] paramArrayOfint1, int paramInt1, int paramInt2, int[] paramArrayOfint2, int paramInt3, int paramInt4) {
    ...
    for (byte b = 0; b < paramInt2 - 1; b++) {
      ...
      paramArrayOfint2[paramInt3 + b] = k << paramInt4 | j >>> i;
    } 
  ...
  private MutableBigInteger divideMagnitude(MutableBigInteger paramMutableBigInteger1, MutableBigInteger paramMutableBigInteger2, boolean paramBoolean) {
    ...
    if (i > 0) {
      ...
      if (Integer.numberOfLeadingZeros(this.value[this.offset]) >= i) {
        ...
        int i8 = 0;
        int i9 = 32 - i;
        for (byte b = 1; b < this.intLen + 1; b++, i7++) {
          int i10 = i8;
          i8 = this.value[i7];
    ...
    for (i2 = 0; i2 < m - 1; i2++) {
      ...
      if (i9 == n) {
        i7 = -1;
        i8 = i9 + i11;
        bool1 = (i8 + Integer.MIN_VALUE < i10) ? true : false;
      } else {
        long l1 = i9 << 32L | i11 & 0xFFFFFFFFL;
        if (l1 >= 0L) {
          i7 = (int)(l1 / l);
          i8 = (int)(l1 - i7 * l);
        } else {
    ...
    if (i4 == n) {
      i2 = -1;
      i3 = i4 + i6;
      bool = (i3 + Integer.MIN_VALUE < i5) ? true : false;
    } else {
      long l1 = i4 << 32L | i6 & 0xFFFFFFFFL;
      if (l1 >= 0L) {
        i2 = (int)(l1 / l);
        i3 = (int)(l1 - i2 * l);
      } else {
    ...
    if (i2 != 0) {
      int i7;
      if (!bool) {
        long l1 = mutableBigInteger.value[m + 1 + mutableBigInteger.offset] & 0xFFFFFFFFL;
        long l2 = (i3 & 0xFFFFFFFFL) << 32L | l1;
        long l3 = (i1 & 0xFFFFFFFFL) * (i2 & 0xFFFFFFFFL);
        if (unsignedLongCompare(l3, l2)) {
          i2--;
          i3 = (int)((i3 & 0xFFFFFFFFL) + l);
          if ((i3 & 0xFFFFFFFFL) >= l) {
            l3 -= i1 & 0xFFFFFFFFL;
            l2 = (i3 & 0xFFFFFFFFL) << 32L | l1;
            if (unsignedLongCompare(l3, l2))
              i2--; 
          } 
        } 
  ...
  private MutableBigInteger divideLongMagnitude(long paramLong, MutableBigInteger paramMutableBigInteger) {
    ...
    for (byte b = 0; b < j; b++) {
      ...
      int i2 = 0;
      boolean bool = false;
      int i3 = mutableBigInteger.value[b + mutableBigInteger.offset];
      int i4 = i3 + Integer.MIN_VALUE;
      int i5 = mutableBigInteger.value[b + 1 + mutableBigInteger.offset];
      if (i3 == m) {
        i1 = -1;
        i2 = i3 + i5;
        bool = (i2 + Integer.MIN_VALUE < i4) ? true : false;
      } else {
        long l1 = i3 << 32L | i5 & 0xFFFFFFFFL;
        if (l1 >= 0L) {
          i1 = (int)(l1 / l);
          i2 = (int)(l1 - i1 * l);
        } else {
          long l2 = divWord(l1, m);
          i1 = (int)(l2 & 0xFFFFFFFFL);
          i2 = (int)(l2 >>> 32L);
        } 
      } 
      if (i1 != 0) {
        if (!bool) {
          long l1 = mutableBigInteger.value[b + 2 + mutableBigInteger.offset] & 0xFFFFFFFFL;
          long l2 = (i2 & 0xFFFFFFFFL) << 32L | l1;
          long l3 = (n & 0xFFFFFFFFL) * (i1 & 0xFFFFFFFFL);
          if (unsignedLongCompare(l3, l2)) {
            i1--;
            i2 = (int)((i2 & 0xFFFFFFFFL) + l);
            if ((i2 & 0xFFFFFFFFL) >= l) {
              l3 -= n & 0xFFFFFFFFL;
              l2 = (i2 & 0xFFFFFFFFL) << 32L | l1;
              if (unsignedLongCompare(l3, l2))
                i1--; 
            } 
          } 
        } 
        mutableBigInteger.value[b + mutableBigInteger.offset] = 0;
        int i6 = mulsubLong(mutableBigInteger.value, m, n, i1, b + mutableBigInteger.offset);
        if (i6 + Integer.MIN_VALUE > i4) {
          divaddLong(m, n, mutableBigInteger.value, b + 1 + mutableBigInteger.offset);
          i1--;
        } 
        arrayOfInt[b] = i1;
      } 
  ...
  private int mulsubLong(int[] paramArrayOfint, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    long l4 = (l2 >>> 32L) + (((l3 & 0xFFFFFFFFL) > (((int)l2 ^ 0xFFFFFFFF) & 0xFFFFFFFFL)) ? 1L : 0L);
    l2 = (paramInt1 & 0xFFFFFFFFL) * l1 + l4;
    l3 = paramArrayOfint[paramInt4] - l2;
    paramArrayOfint[paramInt4--] = (int)l3;
    l4 = (l2 >>> 32L) + (((l3 & 0xFFFFFFFFL) > (((int)l2 ^ 0xFFFFFFFF) & 0xFFFFFFFFL)) ? 1L : 0L);
    return (int)l4;
  }
  ...
  static long divWord(long paramLong, int paramInt) {
    ...
    if (l1 == 1L) {
      ...
      long l4 = 0L;
      return l4 << 32L | l5 & 0xFFFFFFFFL;
    } 
    long l3 = (paramLong >>> 1L) / (l1 >>> 1L);
  ...
  MutableBigInteger mutableModInverse(MutableBigInteger paramMutableBigInteger) {
    ...
    MutableBigInteger mutableBigInteger3 = modInverseMP2(i);
    MutableBigInteger mutableBigInteger4 = modInverseBP2(mutableBigInteger1, i);
  ...
  MutableBigInteger modInverseMP2(int paramInt) {
    ...
    if (this.intLen > 1)
      l1 |= this.value[this.offset + this.intLen - 2] << 32L; 
    ...
    mutableBigInteger.value[0] = (int)(l2 >>> 32L);
