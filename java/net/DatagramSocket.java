...
public class DatagramSocket implements Closeable {
  ...
  private synchronized void connectInternal(InetAddress paramInetAddress, int paramInt) throws SocketException {
    ...
    if (this.oldImpl || (this.impl instanceof AbstractPlainDatagramSocketImpl && ((AbstractPlainDatagramSocketImpl)this.impl)
  ...
  void createImpl() throws SocketException {
    if (this.impl == null)
      if (factory != null) {
        ...
        boolean bool = (this instanceof MulticastSocket) ? true : false;
      ...
      if (this.connectState == 0) {
        ...
        if (securityManager != null)
          if (paramDatagramPacket.getAddress().isMulticastAddress()) {
            ...
            securityManager.checkConnect(paramDatagramPacket.getAddress().getHostAddress(), paramDatagramPacket
                .getPort());
          }  
      } else {
        ...
        } else if (!inetAddress.equals(this.connectedAddress) || paramDatagramPacket
          .getPort() != this.connectedPort) {
