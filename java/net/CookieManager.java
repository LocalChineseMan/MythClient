...
public class CookieManager extends CookieHandler {
  ...
  public Map<String, List<String>> get(URI paramURI, Map<String, List<String>> paramMap) throws IOException {
    ...
    for (HttpCookie httpCookie : this.cookieJar.get(paramURI)) {
      if (pathMatches(str, httpCookie.getPath()) && (bool || 
    ...
    List<String> list = sortByPath(arrayList);
  ...
  public void put(URI paramURI, Map<String, List<String>> paramMap) throws IOException {
    ...
    for (String str : paramMap.keySet()) {
      if (str == null || (
        !str.equalsIgnoreCase("Set-Cookie2") && 
        !str.equalsIgnoreCase("Set-Cookie")))
        continue; 
          ...
          for (HttpCookie httpCookie : list) {
            ...
            if (str2 != null) {
              ...
              if (isInPortList(str2, i) && 
                shouldAcceptInternal(paramURI, httpCookie))
                this.cookieJar.add(paramURI, httpCookie); 
              continue;
            } 
            if (shouldAcceptInternal(paramURI, httpCookie))
  ...
  static class CookiePathComparator implements Comparator<HttpCookie> {
    public int compare(HttpCookie param1HttpCookie1, HttpCookie param1HttpCookie2) {
      if (param1HttpCookie1 == param1HttpCookie2)
        return 0; 
      if (param1HttpCookie1 == null)
        return -1; 
      if (param1HttpCookie2 == null)
        return 1; 
      if (!param1HttpCookie1.getName().equals(param1HttpCookie2.getName()))
        return 0; 
      if (param1HttpCookie1.getPath().startsWith(param1HttpCookie2.getPath()))
        return -1; 
      if (param1HttpCookie2.getPath().startsWith(param1HttpCookie1.getPath()))
        return 1; 
      return 0;
    }
  }
