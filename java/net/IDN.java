...
public final class IDN {
  ...
  static {
    ...
    try {
      if (System.getSecurityManager() != null) {
        inputStream = AccessController.<InputStream>doPrivileged((PrivilegedAction<InputStream>)new Object());
      } else {
  ...
  private static String toASCIIInternal(String paramString, int paramInt) {
    ...
    boolean bool1 = ((paramInt & 0x2) != 0) ? true : false;
    if (bool1) {
  ...
  private static int searchDots(String paramString, int paramInt) {
    int i;
    for (i = paramInt; i < paramString.length() && 
      !isLabelSeparator(paramString.charAt(i)); i++);
    return i;
  }
