...
public class InetAddress implements Serializable {
  ...
  static {
    preferIPv6Address = ((Boolean)AccessController.<Boolean>doPrivileged(new GetBooleanAction("java.net.preferIPv6Addresses"))).booleanValue();
    ...
    str1 = AccessController.<String>doPrivileged(new GetPropertyAction(str2 + b));
    while (str1 != null) {
  ...
  private static NameService createNSProvider(String paramString) {
    ...
    if (paramString.equals("default")) {
      ...
      try {
        nameService = AccessController.<NameService>doPrivileged((PrivilegedExceptionAction<NameService>)new Object(str));
