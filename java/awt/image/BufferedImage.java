...
public class BufferedImage extends Image implements WritableRenderedImage, Transparency {
  ...
  public BufferedImage(int paramInt1, int paramInt2, int paramInt3) {
    ...
    switch (paramInt3) {
      ...
      case 5:
        ...
        this.raster = Raster.createInterleavedRaster(0, paramInt1, paramInt2, paramInt1 * 3, 3, arrayOfInt3, (Point)null);
        break;
      case 6:
        colorSpace = ColorSpace.getInstance(1000);
        ...
        this.raster = Raster.createInterleavedRaster(0, paramInt1, paramInt2, paramInt1 * 4, 4, arrayOfInt3, (Point)null);
        break;
      case 7:
        colorSpace = ColorSpace.getInstance(1000);
        arrayOfInt2 = new int[] { 8, 8, 8, 8 };
      ...
      case 12:
        ...
        this.raster = Raster.createPackedRaster(0, paramInt1, paramInt2, 1, 1, (Point)null);
        break;
      case 13:
        ...
        for (i = 0; i < 256; i += 51) {
          for (byte b1 = 0; b1 < 'Ā'; b1 += 51) {
            for (byte b2 = 0; b2 < 'Ā'; b2 += 51)
              arrayOfInt1[b++] = i << 16 | b1 << 8 | b2; 
          } 
        } 
        i = 256 / (256 - b);
        j = i * 3;
        for (; b < 'Ā'; b++) {
          arrayOfInt1[b] = j << 16 | j << 8 | j;
          j += i;
        } 
  ...
  public BufferedImage(int paramInt1, int paramInt2, int paramInt3, IndexColorModel paramIndexColorModel) {
    ...
    switch (paramInt3) {
      case 12:
        ...
        this.raster = Raster.createPackedRaster(0, paramInt1, paramInt2, 1, b, (Point)null);
        break;
      case 13:
        this.raster = Raster.createInterleavedRaster(0, paramInt1, paramInt2, 1, null);
        break;
  ...
  public BufferedImage(ColorModel paramColorModel, WritableRaster paramWritableRaster, boolean paramBoolean, Hashtable<?, ?> paramHashtable) {
    ...
    if (j != 5) {
      if (j == 6 && bool2 && paramColorModel instanceof ComponentColorModel) {
        if (sampleModel instanceof ComponentSampleModel && ((ComponentSampleModel)sampleModel)
          .getPixelStride() != i) {
          this.imageType = 0;
        } else if (paramWritableRaster instanceof ByteComponentRaster && paramWritableRaster
          .getNumBands() == 1 && paramColorModel
          .getComponentSize(0) == 8 && ((ByteComponentRaster)paramWritableRaster)
          .getPixelStride() == 1) {
          this.imageType = 10;
        } else if (paramWritableRaster instanceof ShortComponentRaster && paramWritableRaster
          .getNumBands() == 1 && paramColorModel
          .getComponentSize(0) == 16 && ((ShortComponentRaster)paramWritableRaster)
          .getPixelStride() == 1) {
          this.imageType = 11;
        } 
      } else {
    ...
    if (paramWritableRaster instanceof IntegerComponentRaster && (i == 3 || i == 4)) {
      ...
      if (integerComponentRaster.getPixelStride() == 1 && bool2 && paramColorModel instanceof DirectColorModel && (k == 32 || k == 24)) {
        ...
        } else if (m == 255 && n == 65280 && i1 == 16711680) {
          if (!directColorModel.hasAlpha())
            this.imageType = 4; 
        } 
      } 
    } else if (paramColorModel instanceof IndexColorModel && i == 1 && bool2 && (
      
      !paramColorModel.hasAlpha() || !bool1)) {
    ...
    } else if (paramWritableRaster instanceof ShortComponentRaster && paramColorModel instanceof DirectColorModel && bool2 && i == 3 && 
      
      !paramColorModel.hasAlpha()) {
      DirectColorModel directColorModel = (DirectColorModel)paramColorModel;
      if (directColorModel.getRedMask() == 63488) {
        if (directColorModel.getGreenMask() == 2016 && directColorModel
          .getBlueMask() == 31)
          this.imageType = 8; 
      } else if (directColorModel.getRedMask() == 31744 && 
        directColorModel.getGreenMask() == 992 && directColorModel
        .getBlueMask() == 31) {
        this.imageType = 9;
      } 
    } else if (paramWritableRaster instanceof ByteComponentRaster && paramColorModel instanceof ComponentColorModel && bool2 && paramWritableRaster
      
      .getSampleModel() instanceof PixelInterleavedSampleModel && (i == 3 || i == 4)) {
      ...
      if (componentColorModel.getNumComponents() != i)
        throw new RasterFormatException("Number of components in ColorModel (" + componentColorModel
            
            .getNumComponents() + ") does not match # in " + " Raster (" + i + ")"); 
      ...
      if (bool && byteComponentRaster
        .getPixelStride() == i && arrayOfInt1[0] == i - 1 && arrayOfInt1[1] == i - 2 && arrayOfInt1[2] == i - 3)
  ...
  private static boolean isStandard(ColorModel paramColorModel, WritableRaster paramWritableRaster) {
    ...
    PrivilegedAction<Boolean> privilegedAction = new PrivilegedAction<Boolean>() {
        public Boolean run() {
          ...
          return Boolean.valueOf((cmClass.getClassLoader() == classLoader && smClass
              .getClassLoader() == classLoader && wrClass
              .getClassLoader() == classLoader));
        }
      };
    return ((Boolean)AccessController.<Boolean>doPrivileged(privilegedAction)).booleanValue();
  }
  ...
  public int getRGB(int paramInt1, int paramInt2) {
    return this.colorModel.getRGB(this.raster.getDataElements(paramInt1, paramInt2, null));
  }
  ...
  public int[] getRGB(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint, int paramInt5, int paramInt6) {
    ...
    for (int m = paramInt2; m < paramInt2 + paramInt4; m++, i += paramInt6) {
      int n = i;
  ...
  public synchronized void setRGB(int paramInt1, int paramInt2, int paramInt3) {
    this.raster.setDataElements(paramInt1, paramInt2, this.colorModel.getDataElements(paramInt3, null));
  }
  ...
  public void setRGB(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint, int paramInt5, int paramInt6) {
    int i = paramInt5;
    Object object = null;
    for (int j = paramInt2; j < paramInt2 + paramInt4; j++, i += paramInt6) {
      int k = i;
  ...
  public BufferedImage getSubimage(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    return new BufferedImage(this.colorModel, this.raster
        .createWritableChild(paramInt1, paramInt2, paramInt3, paramInt4, 0, 0, (int[])null), this.colorModel
        
        .isAlphaPremultiplied(), this.properties);
  }
  ...
  public void coerceData(boolean paramBoolean) {
    if (this.colorModel.hasAlpha() && this.colorModel
  ...
  public Raster getData() {
    ...
    WritableRaster writableRaster = Raster.createWritableRaster(this.raster.getSampleModel(), new Point(this.raster
          .getSampleModelTranslateX(), this.raster
  ...
  public Raster getData(Rectangle paramRectangle) {
    ...
    WritableRaster writableRaster = Raster.createWritableRaster(sampleModel2, paramRectangle
        .getLocation());
