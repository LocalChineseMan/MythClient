...
public class DataFlavor implements Externalizable, Cloneable {
  ...
  private String paramString() {
    ...
    if (DataTransferer.isFlavorCharsetTextType(this) && (
      ...
      .equals(this.representationClass)))
  ...
  public static final DataFlavor selectBestTextFlavor(DataFlavor[] paramArrayOfDataFlavor) {
    ...
    if (textFlavorComparator == null)
      textFlavorComparator = (Comparator<DataFlavor>)new TextFlavorComparator(); 
    DataFlavor dataFlavor = Collections.<DataFlavor>max(Arrays.asList(paramArrayOfDataFlavor), textFlavorComparator);
  ...
  public boolean equals(DataFlavor paramDataFlavor) {
    ...
    if (this.mimeType == null) {
      ...
      if ("text".equals(getPrimaryType())) {
        if (DataTransferer.doesSubtypeSupportCharset(this) && this.representationClass != null && 
  ...
  public final boolean isMimeTypeEqual(DataFlavor paramDataFlavor) {
    return isMimeTypeEqual(paramDataFlavor.mimeType);
  }
  
  private boolean isMimeTypeEqual(MimeType paramMimeType) {
    if (this.mimeType == null)
      return (paramMimeType == null); 
    return this.mimeType.match(paramMimeType);
  }
  
  private boolean isStandardTextRepresentationClass() {
    return (isRepresentationClassReader() || String.class
      .equals(this.representationClass) || 
      isRepresentationClassCharBuffer() || char[].class
      .equals(this.representationClass));
  }
  ...
  public boolean isFlavorRemoteObjectType() {
    return (isRepresentationClassRemote() && 
      ...
      isMimeTypeEqual("application/x-java-remote-object"));
  }
  
  public boolean isFlavorJavaFileListType() {
    if (this.mimeType == null || this.representationClass == null)
      return false; 
    return (List.class.isAssignableFrom(this.representationClass) && this.mimeType
      .match(javaFileListFlavor.mimeType));
  }
