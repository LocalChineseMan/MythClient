...
public class AffineTransform implements Cloneable, Serializable {
  ...
  private void calculateType() {
    ...
    switch (this.state) {
      ...
      case 6:
        ...
        bool1 = (d1 >= 0.0D) ? true : false;
        bool2 = (d2 >= 0.0D) ? true : false;
        if (bool1 == bool2) {
          if (d1 != d2 || d3 != -d4) {
            i |= 0x14;
            break;
      ...
      case 5:
        i = 1;
      case 4:
        bool1 = ((d1 = this.m01) >= 0.0D) ? true : false;
        bool2 = ((d2 = this.m10) >= 0.0D) ? true : false;
        if (bool1 != bool2) {
          if (d1 != -d2) {
            i |= 0xC;
            break;
      ...
      case 3:
        i = 1;
      case 2:
        bool1 = ((d1 = this.m00) >= 0.0D) ? true : false;
        bool2 = ((d2 = this.m11) >= 0.0D) ? true : false;
        if (bool1 == bool2) {
          if (bool1) {
            if (d1 == d2) {
              i |= 0x2;
  ...
  public void setToRotation(double paramDouble) {
    double d2, d1 = Math.sin(paramDouble);
    if (d1 == 1.0D || d1 == -1.0D) {
      d2 = 0.0D;
      this.state = 4;
      this.type = 8;
  ...
  public void concatenate(AffineTransform paramAffineTransform) {
    ...
    double d3 = paramAffineTransform.m00, d4 = paramAffineTransform.m01, d7 = paramAffineTransform.m02;
    double d5 = paramAffineTransform.m10, d6 = paramAffineTransform.m11, d8 = paramAffineTransform.m12;
    switch (i) {
      default:
        stateError();
      case 6:
