...
public class Rectangle extends Rectangle2D implements Shape, Serializable {
  ...
  public Rectangle(Rectangle paramRectangle) {
    this(paramRectangle.x, paramRectangle.y, paramRectangle.width, paramRectangle.height);
  }
  ...
  public Rectangle(Point paramPoint, Dimension paramDimension) {
    this(paramPoint.x, paramPoint.y, paramDimension.width, paramDimension.height);
  }
  
  public Rectangle(Point paramPoint) {
    this(paramPoint.x, paramPoint.y, 0, 0);
  }
  
  public Rectangle(Dimension paramDimension) {
    this(0, 0, paramDimension.width, paramDimension.height);
  }
  ...
  public boolean contains(Rectangle paramRectangle) {
    return contains(paramRectangle.x, paramRectangle.y, paramRectangle.width, paramRectangle.height);
  }
  ...
  public Rectangle2D createIntersection(Rectangle2D paramRectangle2D) {
    ...
    Rectangle2D.intersect(this, paramRectangle2D, double_);
    return double_;
  }
  ...
  public Rectangle2D createUnion(Rectangle2D paramRectangle2D) {
    ...
    Rectangle2D.Double double_ = new Rectangle2D.Double();
    Rectangle2D.union(this, paramRectangle2D, double_);
    return double_;
  }
