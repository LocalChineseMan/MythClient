...
public final class AlphaComposite implements Composite {
  ...
  public AlphaComposite derive(int paramInt) {
    return (this.rule == paramInt) ? this : 
      
      getInstance(paramInt, this.extraAlpha);
  }
  
  public AlphaComposite derive(float paramFloat) {
    return (this.extraAlpha == paramFloat) ? this : 
      
      getInstance(this.rule, paramFloat);
  }
  ...
  public boolean equals(Object paramObject) {
    ...
    if (this.rule != alphaComposite.rule)
      return false; 
    if (this.extraAlpha != alphaComposite.extraAlpha)
      return false; 
    return true;
  }
}
