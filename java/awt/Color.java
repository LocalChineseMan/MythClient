...
public class Color implements Paint, Serializable {
  ...
  public Color brighter() {
    ...
    if (k > 0 && k < b)
      k = b; 
    return new Color(Math.min((int)(i / 0.7D), 255), 
        Math.min((int)(j / 0.7D), 255), 
        Math.min((int)(k / 0.7D), 255), m);
  }
  
  public Color darker() {
    return new Color(Math.max((int)(getRed() * 0.7D), 0), 
  ...
  public static Color getColor(String paramString) {
    return getColor(paramString, (Color)null);
  }
