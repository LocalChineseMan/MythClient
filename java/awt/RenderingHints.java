...
public class RenderingHints implements Map<Object, Object>, Cloneable {
  public static abstract class Key {
    ...
    private String getIdentity() {
      return getClass().getName() + "@" + 
        ...
        Integer.toHexString(this.privatekey);
    }
    ...
    private static synchronized void recordIdentity(Key param1Key) {
      ...
      if (object != null) {
        Key key = ((WeakReference<Key>)object).get();
  ...
  public boolean containsKey(Object paramObject) {
    return this.hintmap.containsKey(paramObject);
  }
  ...
  public Object get(Object paramObject) {
    return this.hintmap.get(paramObject);
  }
  ...
  public Object put(Object paramObject1, Object paramObject2) {
    ...
    return this.hintmap.put(paramObject1, paramObject2);
  }
  ...
  public Object remove(Object paramObject) {
    return this.hintmap.remove(paramObject);
  }
  ...
  public Set<Map.Entry<Object, Object>> entrySet() {
    return Collections.<Object, Object>unmodifiableMap(this.hintmap).entrySet();
  }
  ...
  public Object clone() {
    ...
    try {
      ...
      if (this.hintmap != null)
        renderingHints.hintmap = (HashMap<Object, Object>)this.hintmap.clone(); 
  ...
  public String toString() {
    if (this.hintmap == null)
      return getClass().getName() + "@" + 
        Integer.toHexString(hashCode()) + " (0 hints)"; 
