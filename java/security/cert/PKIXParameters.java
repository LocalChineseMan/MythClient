...
public class PKIXParameters implements CertPathParameters {
  ...
  public void setTrustAnchors(Set<TrustAnchor> paramSet) throws InvalidAlgorithmParameterException {
    ...
    for (Iterator<TrustAnchor> iterator = paramSet.iterator(); iterator.hasNext();) {
  ...
  public void setCertStores(List<CertStore> paramList) {
    if (paramList == null) {
      ...
      for (Iterator<CertStore> iterator = paramList.iterator(); iterator.hasNext();) {
  ...
  public void setExplicitPolicyRequired(boolean paramBoolean) {
    this.explicitPolicyRequired = paramBoolean;
  }
  ...
  public void setPolicyMappingInhibited(boolean paramBoolean) {
    this.policyMappingInhibited = paramBoolean;
  }
  ...
  public void setAnyPolicyInhibited(boolean paramBoolean) {
    this.anyPolicyInhibited = paramBoolean;
  }
  ...
  public void setPolicyQualifiersRejected(boolean paramBoolean) {
    this.policyQualifiersRejected = paramBoolean;
  }
  ...
  public Object clone() {
    try {
      ...
      if (this.certPathCheckers != null) {
        pKIXParameters
          .certPathCheckers = new ArrayList<>(this.certPathCheckers.size());
        for (PKIXCertPathChecker pKIXCertPathChecker : this.certPathCheckers)
          pKIXParameters.certPathCheckers.add((PKIXCertPathChecker)pKIXCertPathChecker
              .clone()); 
      } 
  ...
  public String toString() {
    ...
    if (this.unmodInitialPolicies != null)
      if (this.unmodInitialPolicies.isEmpty()) {
        ...
        stringBuffer.append("  Initial Policy OIDs: [" + this.unmodInitialPolicies
            .toString() + "]\n");
      }  
    ...
    if (this.certPathCheckers != null)
      stringBuffer.append("  Certification Path Checkers: [" + this.certPathCheckers
          .toString() + "]\n"); 
    if (this.certStores != null)
