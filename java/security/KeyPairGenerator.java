...
public abstract class KeyPairGenerator extends KeyPairGeneratorSpi {
  ...
  private static KeyPairGenerator getInstance(GetInstance.Instance paramInstance, String paramString) {
    ...
    if (paramInstance.impl instanceof KeyPairGenerator) {
      keyPairGenerator = (KeyPairGenerator)paramInstance.impl;
    } else {
      KeyPairGeneratorSpi keyPairGeneratorSpi = (KeyPairGeneratorSpi)paramInstance.impl;
      keyPairGenerator = new Delegate(keyPairGeneratorSpi, paramString);
    } 
    keyPairGenerator.provider = paramInstance.provider;
    if (!skipDebug && pdebug != null)
      pdebug.println("KeyPairGenerator." + paramString + " algorithm from: " + keyPairGenerator.provider
          .getName()); 
    return keyPairGenerator;
  }
  
  public static KeyPairGenerator getInstance(String paramString) throws NoSuchAlgorithmException {
    List<Provider.Service> list = GetInstance.getServices("KeyPairGenerator", paramString);
    ...
    while (true) {
      ...
      try {
        ...
        return new Delegate(instance, iterator, paramString);
  ...
  private static final class Delegate extends KeyPairGenerator {
    ...
    Delegate(GetInstance.Instance param1Instance, Iterator<Provider.Service> param1Iterator, String param1String) {
      ...
      if (!KeyPairGenerator.skipDebug && KeyPairGenerator.pdebug != null)
        KeyPairGenerator.pdebug.println("KeyPairGenerator." + param1String + " algorithm from: " + this.provider
            .getName()); 
    }
      ...
      synchronized (this.lock) {
        ...
        while (this.serviceIterator.hasNext()) {
          ...
          try {
            ...
            if (!(object instanceof KeyPairGeneratorSpi))
              continue; 
