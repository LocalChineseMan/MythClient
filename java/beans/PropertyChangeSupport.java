...
public class PropertyChangeSupport implements Serializable {
  ...
  public void addPropertyChangeListener(PropertyChangeListener paramPropertyChangeListener) {
    ...
    if (paramPropertyChangeListener instanceof PropertyChangeListenerProxy) {
      ...
      addPropertyChangeListener(propertyChangeListenerProxy.getPropertyName(), propertyChangeListenerProxy
          .getListener());
    } else {
  ...
  public void removePropertyChangeListener(PropertyChangeListener paramPropertyChangeListener) {
    ...
    if (paramPropertyChangeListener instanceof PropertyChangeListenerProxy) {
      PropertyChangeListenerProxy propertyChangeListenerProxy = (PropertyChangeListenerProxy)paramPropertyChangeListener;
      removePropertyChangeListener(propertyChangeListenerProxy.getPropertyName(), propertyChangeListenerProxy
          .getListener());
    } else {
  ...
  public PropertyChangeListener[] getPropertyChangeListeners(String paramString) {
    return this.map.getListeners(paramString);
  }
  ...
  public void firePropertyChange(PropertyChangeEvent paramPropertyChangeEvent) {
    ...
    if (object1 == null || object2 == null || !object1.equals(object2)) {
      ...
      PropertyChangeListener[] arrayOfPropertyChangeListener1 = this.map.get(null);
      PropertyChangeListener[] arrayOfPropertyChangeListener2 = (str != null) ? this.map.get(str) : null;
  ...
  private void readObject(ObjectInputStream paramObjectInputStream) throws ClassNotFoundException, IOException {
    ...
    Hashtable hashtable = (Hashtable)getField.get("children", (Object)null);
    this.source = getField.get("source", (Object)null);
  ...
  private static final ObjectStreamField[] serialPersistentFields = new ObjectStreamField[] { new ObjectStreamField("children", Hashtable.class), new ObjectStreamField("source", Object.class), new ObjectStreamField("propertyChangeSupportSerializedDataVersion", int.class) };
  ...
  private static final class PropertyChangeListenerMap extends ChangeListenerMap<PropertyChangeListener> {
    ...
    protected PropertyChangeListener[] newArray(int param1Int) {
      return (0 < param1Int) ? new PropertyChangeListener[param1Int] : EMPTY;
    }
    
    protected PropertyChangeListener newProxy(String param1String, PropertyChangeListener param1PropertyChangeListener) {
      return new PropertyChangeListenerProxy(param1String, param1PropertyChangeListener);
    }
    ...
    public final PropertyChangeListener extract(PropertyChangeListener param1PropertyChangeListener) {
      while (param1PropertyChangeListener instanceof PropertyChangeListenerProxy)
        param1PropertyChangeListener = ((PropertyChangeListenerProxy)param1PropertyChangeListener).getListener(); 
