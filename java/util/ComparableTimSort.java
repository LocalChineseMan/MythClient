...
class ComparableTimSort {
  ...
  private ComparableTimSort(Object[] paramArrayOfObject1, Object[] paramArrayOfObject2, int paramInt1, int paramInt2) {
    ...
    if (paramArrayOfObject2 == null || paramInt2 < b1 || paramInt1 + b1 > paramArrayOfObject2.length) {
      this.tmp = new Object[b1];
      this.tmpBase = 0;
      this.tmpLen = b1;
    } else {
  ...
  static void sort(Object[] paramArrayOfObject1, int paramInt1, int paramInt2, Object[] paramArrayOfObject2, int paramInt3, int paramInt4) {
    ...
    ComparableTimSort comparableTimSort = new ComparableTimSort(paramArrayOfObject1, paramArrayOfObject2, paramInt3, paramInt4);
  ...
  private static void binarySort(Object[] paramArrayOfObject, int paramInt1, int paramInt2, int paramInt3) {
    ...
    for (; paramInt3 < paramInt2; paramInt3++) {
      Comparable<Object> comparable = (Comparable)paramArrayOfObject[paramInt3];
      int i = paramInt1;
      int j = paramInt3;
      assert i <= j;
      while (i < j) {
  ...
  private static int countRunAndMakeAscending(Object[] paramArrayOfObject, int paramInt1, int paramInt2) {
    ...
    if (i == paramInt2)
      return 1; 
    if (((Comparable<Object>)paramArrayOfObject[i++]).compareTo(paramArrayOfObject[paramInt1]) < 0) {
      while (i < paramInt2 && ((Comparable<Object>)paramArrayOfObject[i]).compareTo(paramArrayOfObject[i - 1]) < 0)
        i++; 
  ...
  private void mergeAt(int paramInt) {
    ...
    this.stackSize--;
    int n = gallopRight((Comparable<Object>)this.a[k], this.a, i, j, 0);
    assert n >= 0;
    i += n;
    j -= n;
    if (j == 0)
      return; 
    m = gallopLeft((Comparable<Object>)this.a[i + j - 1], this.a, k, m, m - 1);
    assert m >= 0;
    if (m == 0)
      return; 
    if (j <= m) {
  ...
  private void mergeLo(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (((Comparable<Object>)arrayOfObject1[j]).compareTo(arrayOfObject2[i]) < 0) {
          arrayOfObject1[k++] = arrayOfObject1[j++];
          i1++;
          n = 0;
          if (--paramInt4 == 0)
        ...
        if ((n | i1) >= m) {
          label79: while (true) {
            assert paramInt2 > 1 && paramInt4 > 0;
            n = gallopRight((Comparable<Object>)arrayOfObject1[j], arrayOfObject2, i, paramInt2, 0);
            if (n != 0) {
            ...
            if (--paramInt4 == 0)
              break; 
            i1 = gallopLeft((Comparable<Object>)arrayOfObject2[i], arrayOfObject1, j, paramInt4, 0);
            if (i1 != 0) {
  ...
  private void mergeHi(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (((Comparable<Object>)arrayOfObject2[k]).compareTo(arrayOfObject1[j]) < 0) {
          arrayOfObject1[m--] = arrayOfObject1[j--];
          i1++;
          i2 = 0;
          if (--paramInt2 == 0)
        ...
        if ((i1 | i2) >= n) {
          label79: while (true) {
            assert paramInt2 > 0 && paramInt4 > 1;
            i1 = paramInt2 - gallopRight((Comparable<Object>)arrayOfObject2[k], arrayOfObject1, paramInt1, paramInt2, paramInt2 - 1);
            if (i1 != 0) {
              m -= i1;
              j -= i1;
              paramInt2 -= i1;
            ...
            if (--paramInt4 == 1)
              break; 
            i2 = paramInt4 - gallopLeft((Comparable<Object>)arrayOfObject1[j], arrayOfObject2, i, paramInt4, paramInt4 - 1);
            if (i2 != 0) {
              m -= i2;
              k -= i2;
              paramInt4 -= i2;
