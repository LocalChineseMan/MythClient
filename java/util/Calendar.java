...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
  ...
  private static final ConcurrentMap<Locale, int[]> cachedLocaleData = (ConcurrentMap)new ConcurrentHashMap<>(3);
  ...
  public static class Builder {
    ...
    public Builder setInstant(Date param1Date) {
      return setInstant(param1Date.getTime());
    }
    ...
    public Builder setDate(int param1Int1, int param1Int2, int param1Int3) {
      return setFields(new int[] { 1, param1Int1, 2, param1Int2, 5, param1Int3 });
    }
    
    public Builder setTimeOfDay(int param1Int1, int param1Int2, int param1Int3) {
      return setTimeOfDay(param1Int1, param1Int2, param1Int3, 0);
    }
    
    public Builder setTimeOfDay(int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
      return setFields(new int[] { 11, param1Int1, 12, param1Int2, 13, param1Int3, 14, param1Int4 });
    }
    ...
    public Builder setCalendarType(String param1String) {
      ...
      if (!Calendar.getAvailableCalendarTypes().contains(param1String) && 
        !param1String.equals("iso8601"))
    ...
    public Builder setWeekDefinition(int param1Int1, int param1Int2) {
      if (!isValidWeekParameter(param1Int1) || 
        !isValidWeekParameter(param1Int2))
        throw new IllegalArgumentException(); 
    ...
    public Calendar build() {
      ...
      if (this.type == null)
        if (this.locale.getCountry() == "TH" && this.locale
          .getLanguage() == "th") {
          this.type = "buddhist";
        } else {
          this.type = "gregory";
      ...
      if (this.fields != null) {
        boolean bool = (isSet(17) && this.fields[17] > this.fields[1]) ? true : false;
        ...
        byte b;
        for (b = 2; b < this.nextStamp; b++) {
          for (byte b1 = 0; b1 <= this.maxFieldIndex; b1++) {
            if (this.fields[b1] == b) {
              japaneseImperialCalendar.set(b1, this.fields[18 + b1]);
              break;
            } 
          } 
        } 
        if (bool) {
          b = isSet(3) ? this.fields[21] : 1;
          int i = isSet(7) ? this.fields[25] : japaneseImperialCalendar.getFirstDayOfWeek();
          japaneseImperialCalendar.setWeekDate(this.fields[35], b, i);
        } 
        japaneseImperialCalendar.complete();
      } 
      return japaneseImperialCalendar;
    ...
    private boolean isSet(int param1Int) {
      return (this.fields != null && this.fields[param1Int] > 0);
    }
    
    private boolean isValidWeekParameter(int param1Int) {
      return (param1Int > 0 && param1Int <= 7);
    }
  }
  ...
  private static Calendar createCalendar(TimeZone paramTimeZone, Locale paramLocale) {
    CalendarProvider calendarProvider = LocaleProviderAdapter.getAdapter((Class)CalendarProvider.class, paramLocale).getCalendarProvider();
    ...
    if (gregorianCalendar == null)
      if (paramLocale.getLanguage() == "th" && paramLocale.getCountry() == "TH") {
        gregorianCalendar = new BuddhistCalendar(paramTimeZone, paramLocale);
      } else if (paramLocale.getVariant() == "JP" && paramLocale.getLanguage() == "ja" && paramLocale
        .getCountry() == "JP") {
  ...
  public void setTimeInMillis(long paramLong) {
    if (this.time == paramLong && this.isTimeSet && this.areFieldsSet && this.areAllFieldsSet && this.zone instanceof ZoneInfo && 
      !((ZoneInfo)this.zone).isDirty())
      return; 
    this.time = paramLong;
    this.isTimeSet = true;
  ...
  final void internalSet(int paramInt1, int paramInt2) {
    this.fields[paramInt1] = paramInt2;
  }
  ...
  public final void clear() {
    for (byte b = 0; b < this.fields.length; ) {
      this.fields[b] = 0;
      this.stamp[b] = 0;
      this.isSet[b++] = false;
    } 
  ...
  public String getDisplayName(int paramInt1, int paramInt2, Locale paramLocale) {
    if (!checkDisplayNameParams(paramInt1, paramInt2, 1, 4, paramLocale, 645))
      return null; 
    if (isStandaloneStyle(paramInt2) || isNarrowStyle(paramInt2))
      return CalendarDataUtility.retrieveFieldValueName(getCalendarType(), paramInt1, 
          get(paramInt1), paramInt2, paramLocale); 
  ...
  public Map<String, Integer> getDisplayNames(int paramInt1, int paramInt2, Locale paramLocale) {
    if (!checkDisplayNameParams(paramInt1, paramInt2, 0, 4, paramLocale, 645))
      return null; 
    if (paramInt2 == 0 || isStandaloneStyle(paramInt2))
      return CalendarDataUtility.retrieveFieldValueNames(getCalendarType(), paramInt1, paramInt2, paramLocale); 
  ...
  public boolean equals(Object paramObject) {
    ...
    try {
      ...
      return (compareTo(getMillisOf(calendar)) == 0 && this.lenient == calendar.lenient && this.firstDayOfWeek == calendar.firstDayOfWeek && this.minimalDaysInFirstWeek == calendar.minimalDaysInFirstWeek && this.zone
        
        .equals(calendar.zone));
  ...
  public int hashCode() {
    ...
    return (int)l ^ (int)(l >> 32L) ^ i;
  }
  
  public boolean before(Object paramObject) {
    return (paramObject instanceof Calendar && 
      compareTo((Calendar)paramObject) < 0);
  }
  ...
  private void setWeekCountData(Locale paramLocale) {
    int[] arrayOfInt = cachedLocaleData.get(paramLocale);
    if (arrayOfInt == null) {
  ...
  private void readObject(ObjectInputStream paramObjectInputStream) throws IOException, ClassNotFoundException {
    ObjectInputStream objectInputStream = paramObjectInputStream;
    ...
    try {
      zoneInfo = AccessController.<ZoneInfo>doPrivileged((PrivilegedExceptionAction<ZoneInfo>)new Object(this, objectInputStream), 
