...
public class ReentrantReadWriteLock implements ReadWriteLock, Serializable {
  ...
  static abstract class Sync extends AbstractQueuedSynchronizer {
    ...
    protected final boolean tryRelease(int param1Int) {
      ...
      boolean bool = (exclusiveCount(i) == 0) ? true : false;
      if (bool)
    ...
    protected final boolean tryAcquire(int param1Int) {
      ...
      if (writerShouldBlock() || 
        !compareAndSetState(i, i + param1Int))
        return false; 
    ...
    protected final int tryAcquireShared(int param1Int) {
      ...
      if (exclusiveCount(i) != 0 && 
        ...
        return -1; 
      int j = sharedCount(i);
      if (!readerShouldBlock() && j < 65535 && 
        
        compareAndSetState(i, i + 65536)) {
        if (j == 0) {
          ...
          HoldCounter holdCounter = this.cachedHoldCounter;
          if (holdCounter == null || holdCounter.tid != ReentrantReadWriteLock.getThreadId(thread)) {
            this.cachedHoldCounter = holdCounter = this.readHolds.get();
    ...
    final int fullTryAcquireShared(Thread param1Thread) {
      ...
      while (true) {
        ...
        if (exclusiveCount(i) != 0) {
          ...
          if (this.firstReader != param1Thread) {
            if (holdCounter == null) {
  ...
  public static class ReadLock implements Lock, Serializable {
    ...
    protected ReadLock(ReentrantReadWriteLock param1ReentrantReadWriteLock) {
      this.sync = param1ReentrantReadWriteLock.sync;
    }
    ...
    public boolean tryLock(long param1Long, TimeUnit param1TimeUnit) throws InterruptedException {
      return this.sync.tryAcquireSharedNanos(1, param1TimeUnit.toNanos(param1Long));
    }
  ...
  public static class WriteLock implements Lock, Serializable {
    ...
    public boolean tryLock(long param1Long, TimeUnit param1TimeUnit) throws InterruptedException {
      return this.sync.tryAcquireNanos(1, param1TimeUnit.toNanos(param1Long));
    }
    ...
    public String toString() {
      ...
      return super.toString() + ((thread == null) ? "[Unlocked]" : ("[Locked by thread " + thread
