...
public final class StreamSupport {
  public static <T> Stream<T> stream(Spliterator<T> paramSpliterator, boolean paramBoolean) {
    ...
    return new ReferencePipeline.Head<>(paramSpliterator, 
        StreamOpFlag.fromCharacteristics(paramSpliterator), paramBoolean);
  }
  ...
  public static DoubleStream doubleStream(Supplier<? extends Spliterator.OfDouble> paramSupplier, int paramInt, boolean paramBoolean) {
    return new DoublePipeline.Head((Supplier)paramSupplier, 
        StreamOpFlag.fromCharacteristics(paramInt), paramBoolean);
  }
}
