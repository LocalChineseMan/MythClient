...
public final class Formatter implements Closeable, Flushable {
  ...
  public Formatter(PrintStream paramPrintStream) {
    this(Locale.getDefault(Locale.Category.FORMAT), 
        Objects.<Appendable>requireNonNull(paramPrintStream));
  }
  ...
  public Formatter format(String paramString, Object... paramVarArgs) {
    return format(this.l, paramString, paramVarArgs);
  }
  ...
  private FormatString[] parse(String paramString) {
    ArrayList<FixedString> arrayList = new ArrayList();
    Matcher matcher = fsPattern.matcher(paramString);
    for (int i = 0, j = paramString.length(); i < j; ) {
      if (matcher.find(i)) {
        if (matcher.start() != i) {
    ...
    return arrayList.<FormatString>toArray(new FormatString[arrayList.size()]);
  }
  
  private static void checkText(String paramString, int paramInt1, int paramInt2) {
    for (int i = paramInt1; i < paramInt2; i++) {
      if (paramString.charAt(i) == '%') {
        boolean bool = (i == paramInt2 - 1) ? true : paramString.charAt(i + 1);
        throw new UnknownFormatConversionException(String.valueOf(bool));
      } 
    } 
  }
  ...
  private class FixedString implements FormatString {
    ...
    FixedString(String param1String) {
      this.s = param1String;
    }
  ...
  private class FormatSpecifier implements FormatString {
    ...
    public String toString() {
      ...
      stringBuilder.append(this.f.contains(Formatter.Flags.UPPERCASE) ? 
          Character.toUpperCase(this.c) : this.c);
      return stringBuilder.toString();
    }
    
    private void checkGeneral() {
      if ((this.c == 'b' || this.c == 'h') && this.f
        .contains(Formatter.Flags.ALTERNATE))
    ...
    private void checkNumeric() {
      ...
      if (this.precision != -1 && this.precision < 0)
        throw new IllegalFormatPrecisionException(this.precision); 
      if (this.width == -1 && (this.f
        .contains(Formatter.Flags.LEFT_JUSTIFY) || this.f.contains(Formatter.Flags.ZERO_PAD)))
        throw new MissingFormatWidthException(toString()); 
      if ((this.f.contains(Formatter.Flags.PLUS) && this.f.contains(Formatter.Flags.LEADING_SPACE)) || (this.f
        .contains(Formatter.Flags.LEFT_JUSTIFY) && this.f.contains(Formatter.Flags.ZERO_PAD)))
    ...
    private void checkText() {
      ...
      switch (this.c) {
        case '%':
          if (this.f.valueOf() != Formatter.Flags.LEFT_JUSTIFY.valueOf() && this.f
            .valueOf() != Formatter.Flags.NONE.valueOf())
            throw new IllegalFormatFlagsException(this.f.toString()); 
          if (this.width == -1 && this.f.contains(Formatter.Flags.LEFT_JUSTIFY))
            throw new MissingFormatWidthException(toString()); 
          return;
    ...
    private void print(long param1Long, Locale param1Locale) throws IOException {
      ...
      if (this.c == 'd') {
        char[] arrayOfChar;
        boolean bool = (param1Long < 0L) ? true : false;
        if (param1Long < 0L) {
    ...
    private void print(BigInteger param1BigInteger, Locale param1Locale) throws IOException {
      StringBuilder stringBuilder = new StringBuilder();
      boolean bool = (param1BigInteger.signum() == -1) ? true : false;
    ...
    private void print(float param1Float, Locale param1Locale) throws IOException {
      print(param1Float, param1Locale);
    }
    
    private void print(double param1Double, Locale param1Locale) throws IOException {
      StringBuilder stringBuilder = new StringBuilder();
      boolean bool = (Double.compare(param1Double, 0.0D) == -1) ? true : false;
    ...
    private void print(StringBuilder param1StringBuilder, double param1Double, Locale param1Locale, Formatter.Flags param1Flags, char param1Char, int param1Int, boolean param1Boolean) throws IOException {
      if (param1Char == 'e') {
        boolean bool = (param1Int == -1) ? true : param1Int;
        FormattedFloatingDecimal formattedFloatingDecimal = FormattedFloatingDecimal.valueOf(param1Double, bool, FormattedFloatingDecimal.Form.SCIENTIFIC);
        char[] arrayOfChar1 = addZeros(formattedFloatingDecimal.getMantissa(), bool);
        if (param1Flags.contains(Formatter.Flags.ALTERNATE) && !bool)
        ...
        param1StringBuilder.append(localizedMagnitude((StringBuilder)null, arrayOfChar3, flags, -1, param1Locale));
      } else if (param1Char == 'f') {
        boolean bool = (param1Int == -1) ? true : param1Int;
        FormattedFloatingDecimal formattedFloatingDecimal = FormattedFloatingDecimal.valueOf(param1Double, bool, FormattedFloatingDecimal.Form.DECIMAL_FLOAT);
        char[] arrayOfChar = addZeros(formattedFloatingDecimal.getMantissa(), bool);
        if (param1Flags.contains(Formatter.Flags.ALTERNATE) && !bool)
        ...
        if (arrayOfChar1 != null) {
          ...
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, arrayOfChar, flags, -1, param1Locale));
        } 
    ...
    private char[] addZeros(char[] param1ArrayOfchar, int param1Int) {
      byte b;
      for (b = 0; b < param1ArrayOfchar.length && 
        param1ArrayOfchar[b] != '.'; b++);
      boolean bool = false;
      if (b == param1ArrayOfchar.length)
        bool = true; 
      int i = param1ArrayOfchar.length - b - (bool ? 0 : 1);
      assert i <= param1Int;
      if (i == param1Int)
        return param1ArrayOfchar; 
      char[] arrayOfChar = new char[param1ArrayOfchar.length + param1Int - i + (bool ? 1 : 0)];
      System.arraycopy(param1ArrayOfchar, 0, arrayOfChar, 0, param1ArrayOfchar.length);
      int j = param1ArrayOfchar.length;
      if (bool) {
    ...
    private String hexDouble(double param1Double, int param1Int) {
      ...
      boolean bool1 = (i == -1023) ? true : false;
      if (bool1) {
        Formatter.scaleUp = Math.scalb(1.0D, 54);
        param1Double *= Formatter.scaleUp;
      ...
      long l2 = (l1 & Long.MAX_VALUE) >> k;
      long l3 = l1 & (-1L << k ^ 0xFFFFFFFFFFFFFFFFL);
      boolean bool2 = ((l2 & 0x1L) == 0L) ? true : false;
      boolean bool3 = ((1L << k - 1 & l3) != 0L) ? true : false;
      boolean bool4 = (k > 1 && ((1L << k - 1 ^ 0xFFFFFFFFFFFFFFFFL) & l3) != 0L) ? true : false;
      if ((bool2 && bool3 && bool4) || (!bool2 && bool3))
        l2++; 
      long l4 = l1 & Long.MIN_VALUE;
      l2 = l4 | l2 << k;
    ...
    private void print(BigDecimal param1BigDecimal, Locale param1Locale) throws IOException {
      ...
      StringBuilder stringBuilder = new StringBuilder();
      boolean bool = (param1BigDecimal.signum() == -1) ? true : false;
    ...
    private void print(StringBuilder param1StringBuilder, BigDecimal param1BigDecimal, Locale param1Locale, Formatter.Flags param1Flags, char param1Char, int param1Int, boolean param1Boolean) throws IOException {
      if (param1Char == 'e') {
        ...
        int i = param1BigDecimal.scale();
        int j = param1BigDecimal.precision();
        int k = 0;
        if (b > j - 1) {
          m = j;
          k = b - j - 1;
        ...
        MathContext mathContext = new MathContext(m);
        BigDecimal bigDecimal = new BigDecimal(param1BigDecimal.unscaledValue(), i, mathContext);
        BigDecimalLayout bigDecimalLayout = new BigDecimalLayout(this, bigDecimal.unscaledValue(), bigDecimal.scale(), Formatter.BigDecimalLayoutForm.SCIENTIFIC);
        char[] arrayOfChar1 = bigDecimalLayout.mantissa();
        if ((j == 1 || !bigDecimalLayout.hasDot()) && (k > 0 || param1Flags
          .contains(Formatter.Flags.ALTERNATE)))
          arrayOfChar1 = addDot(arrayOfChar1); 
        arrayOfChar1 = trailingZeros(arrayOfChar1, k);
        char[] arrayOfChar2 = bigDecimalLayout.exponent();
        int n = this.width;
        if (this.width != -1)
          n = adjustWidth(this.width - arrayOfChar2.length - 1, param1Flags, param1Boolean); 
        localizedMagnitude(param1StringBuilder, arrayOfChar1, param1Flags, n, param1Locale);
        param1StringBuilder.append(param1Flags.contains(Formatter.Flags.UPPERCASE) ? 69 : 101);
        Formatter.Flags flags = param1Flags.dup().remove(Formatter.Flags.GROUP);
        char c = arrayOfChar2[0];
        assert c == '+' || c == '-';
        ...
        if (i > b) {
          int j = param1BigDecimal.precision();
          if (j <= i) {
            param1BigDecimal = param1BigDecimal.setScale(b, RoundingMode.HALF_UP);
          } else {
            j -= i - b;
            param1BigDecimal = new BigDecimal(param1BigDecimal.unscaledValue(), i, new MathContext(j));
          } 
        } 
        BigDecimalLayout bigDecimalLayout = new BigDecimalLayout(this, param1BigDecimal.unscaledValue(), param1BigDecimal.scale(), Formatter.BigDecimalLayoutForm.DECIMAL_FLOAT);
        char[] arrayOfChar = bigDecimalLayout.mantissa();
        boolean bool = (bigDecimalLayout.scale() < b) ? (b - bigDecimalLayout.scale()) : false;
        if (bigDecimalLayout.scale() == 0 && (param1Flags.contains(Formatter.Flags.ALTERNATE) || bool))
          arrayOfChar = addDot(bigDecimalLayout.mantissa()); 
        arrayOfChar = trailingZeros(arrayOfChar, bool);
        ...
        BigDecimal bigDecimal1 = BigDecimal.valueOf(1L, 4);
        BigDecimal bigDecimal2 = BigDecimal.valueOf(1L, -i);
        if (param1BigDecimal.equals(BigDecimal.ZERO) || (param1BigDecimal
          .compareTo(bigDecimal1) != -1 && param1BigDecimal
          .compareTo(bigDecimal2) == -1)) {
    ...
    private Appendable print(StringBuilder param1StringBuilder, Calendar param1Calendar, char param1Char, Locale param1Locale) throws IOException {
      ...
      switch (param1Char) {
        ...
        case 'l':
          ...
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, k, flags3, 2, param1Locale));
          return param1StringBuilder;
        case 'M':
        ...
        case 'N':
          ...
          flags3 = Formatter.Flags.ZERO_PAD;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, k, flags3, 9, param1Locale));
          return param1StringBuilder;
        case 'L':
          k = param1Calendar.get(14);
          flags3 = Formatter.Flags.ZERO_PAD;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, k, flags3, 3, param1Locale));
          return param1StringBuilder;
        case 'Q':
          l2 = param1Calendar.getTimeInMillis();
          flags5 = Formatter.Flags.NONE;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, l2, flags5, this.width, param1Locale));
          return param1StringBuilder;
        case 'p':
        ...
        case 's':
          ...
          flags5 = Formatter.Flags.NONE;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, l1, flags5, this.width, param1Locale));
          return param1StringBuilder;
        case 'S':
          j = param1Calendar.get(13);
          flags2 = Formatter.Flags.ZERO_PAD;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, j, flags2, 2, param1Locale));
          return param1StringBuilder;
        case 'z':
          ...
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, n, flags6, 4, param1Locale));
          return param1StringBuilder;
        case 'Z':
        ...
        case 'y':
          ...
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, i, flags4, b, param1Locale));
          return param1StringBuilder;
        case 'd':
        case 'e':
          i = param1Calendar.get(5);
          flags1 = (param1Char == 'd') ? Formatter.Flags.ZERO_PAD : Formatter.Flags.NONE;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, i, flags1, 2, param1Locale));
          return param1StringBuilder;
        case 'j':
          i = param1Calendar.get(6);
          flags1 = Formatter.Flags.ZERO_PAD;
          param1StringBuilder.append(localizedMagnitude((StringBuilder)null, i, flags1, 3, param1Locale));
          return param1StringBuilder;
        case 'm':
        ...
        case 'r':
          i = 58;
          print(param1StringBuilder, param1Calendar, 'I', param1Locale).append(i);
          print(param1StringBuilder, param1Calendar, 'M', param1Locale).append(i);
        ...
        case 'c':
          i = 32;
          print(param1StringBuilder, param1Calendar, 'a', param1Locale).append(i);
          print(param1StringBuilder, param1Calendar, 'b', param1Locale).append(i);
          print(param1StringBuilder, param1Calendar, 'd', param1Locale).append(i);
          print(param1StringBuilder, param1Calendar, 'T', param1Locale).append(i);
          print(param1StringBuilder, param1Calendar, 'Z', param1Locale).append(i);
        ...
        case 'F':
          i = 45;
          print(param1StringBuilder, param1Calendar, 'Y', param1Locale).append(i);
          print(param1StringBuilder, param1Calendar, 'm', param1Locale).append(i);
      ...
      try {
        ...
        switch (param1Char) {
          case 'H':
            ...
            param1StringBuilder.append(localizedMagnitude((StringBuilder)null, k, Formatter.Flags.ZERO_PAD, 2, param1Locale));
            return param1StringBuilder;
          case 'k':
            k = param1TemporalAccessor.get(ChronoField.HOUR_OF_DAY);
            param1StringBuilder.append(localizedMagnitude((StringBuilder)null, k, Formatter.Flags.NONE, 2, param1Locale));
            return param1StringBuilder;
          case 'I':
          ...
          case 'z':
            ...
            return param1StringBuilder;
          case 'Z':
            zoneId = param1TemporalAccessor.<ZoneId>query(TemporalQueries.zone());
            if (zoneId == null)
          ...
          case 'r':
            i = 58;
            print(param1StringBuilder, param1TemporalAccessor, 'I', param1Locale).append(i);
            print(param1StringBuilder, param1TemporalAccessor, 'M', param1Locale).append(i);
          ...
          case 'c':
            i = 32;
            print(param1StringBuilder, param1TemporalAccessor, 'a', param1Locale).append(i);
            print(param1StringBuilder, param1TemporalAccessor, 'b', param1Locale).append(i);
            print(param1StringBuilder, param1TemporalAccessor, 'd', param1Locale).append(i);
            print(param1StringBuilder, param1TemporalAccessor, 'T', param1Locale).append(i);
            print(param1StringBuilder, param1TemporalAccessor, 'Z', param1Locale).append(i);
          ...
          case 'F':
            i = 45;
            print(param1StringBuilder, param1TemporalAccessor, 'Y', param1Locale).append(i);
            print(param1StringBuilder, param1TemporalAccessor, 'm', param1Locale).append(i);
    ...
    private void failConversion(char param1Char, Object param1Object) {
      throw new IllegalFormatConversionException(param1Char, param1Object.getClass());
    }
    ...
    private StringBuilder localizedMagnitude(StringBuilder param1StringBuilder, char[] param1ArrayOfchar, Formatter.Flags param1Flags, int param1Int, Locale param1Locale) {
      ...
      if (param1Flags.contains(Formatter.Flags.GROUP))
        if (param1Locale == null || param1Locale.equals(Locale.US)) {
          ...
          DecimalFormatSymbols decimalFormatSymbols = DecimalFormatSymbols.getInstance(param1Locale);
          c1 = decimalFormatSymbols.getGroupingSeparator();
      ...
      for (b = 0; b < k; b++) {
        if (b == m) {
          ...
          char c3 = param1ArrayOfchar[b];
          param1StringBuilder.append((char)(c3 - 48 + c));
          if (c1 != '\000' && b != m - 1 && (m - b) % j == 1)
            param1StringBuilder.append(c1); 
        } 
      } 
      k = param1StringBuilder.length();
      if (param1Int != -1 && param1Flags.contains(Formatter.Flags.ZERO_PAD))
        for (b = 0; b < param1Int - k; b++)
          param1StringBuilder.insert(i, c);  
      return param1StringBuilder;
    }
  ...
  private static class Flags {
    ...
    public boolean contains(Flags param1Flags) {
      return ((this.flags & param1Flags.valueOf()) == param1Flags.valueOf());
    }
    ...
    public static Flags parse(String param1String) {
      ...
      for (byte b = 0; b < arrayOfChar.length; b++) {
        Flags flags1 = parse(arrayOfChar[b]);
        if (flags.contains(flags1))
          throw new DuplicateFormatFlagsException(flags1.toString()); 
        flags.add(flags1);
      } 
      return flags;
    }
  ...
  private static class Conversion {
    ...
    static boolean isValid(char param1Char) {
      return (isGeneral(param1Char) || isInteger(param1Char) || isFloat(param1Char) || isText(param1Char) || param1Char == 't' || 
        isCharacter(param1Char));
    }
