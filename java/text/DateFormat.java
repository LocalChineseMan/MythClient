...
public abstract class DateFormat extends Format {
  ...
  public static Locale[] getAvailableLocales() {
    LocaleServiceProviderPool localeServiceProviderPool = LocaleServiceProviderPool.getPool((Class)DateFormatProvider.class);
  ...
  public boolean equals(Object paramObject) {
    ...
    return (this.calendar
      .getFirstDayOfWeek() == dateFormat.calendar.getFirstDayOfWeek() && this.calendar
      .getMinimalDaysInFirstWeek() == dateFormat.calendar.getMinimalDaysInFirstWeek() && this.calendar
      .isLenient() == dateFormat.calendar.isLenient() && this.calendar
      .getTimeZone().equals(dateFormat.calendar.getTimeZone()) && this.numberFormat
      .equals(dateFormat.numberFormat));
  }
  ...
  private static DateFormat get(int paramInt1, int paramInt2, int paramInt3, Locale paramLocale) {
    ...
    LocaleProviderAdapter localeProviderAdapter = LocaleProviderAdapter.getAdapter((Class)DateFormatProvider.class, paramLocale);
