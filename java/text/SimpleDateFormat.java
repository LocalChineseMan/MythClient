...
public class SimpleDateFormat extends DateFormat {
  ...
  public SimpleDateFormat() {
    ...
    applyPatternImpl(LocaleProviderAdapter.getResourceBundleBased().getLocaleResources(this.locale)
        .getDateTimePattern(3, 3, this.calendar));
  }
  ...
  private void initialize(Locale paramLocale) {
    ...
    this.numberFormat = cachedNumberFormatData.get(paramLocale);
    ...
    for (m = 0; m < i; m++) {
      ...
      if (bool) {
        ...
        if (c < '') {
          ...
          stringBuilder1.append((char)(0x6500 | n - m));
          for (; m < n; m++)
  ...
  private StringBuffer format(Date paramDate, StringBuffer paramStringBuffer, Format.FieldDelegate paramFieldDelegate) {
    ...
    for (int i = 0; i < this.compiledPattern.length; ) {
      int j = this.compiledPattern[i] >>> 8;
      int k = this.compiledPattern[i++] & 0xFF;
      if (k == 255) {
        k = this.compiledPattern[i++] << 16;
        k |= this.compiledPattern[i++];
      } 
      switch (j) {
        case 100:
          ...
          continue;
        case 101:
          paramStringBuffer.append(this.compiledPattern, i, k);
          i += k;
          continue;
      } 
  ...
  private static final DateFormat.Field[] PATTERN_INDEX_TO_DATE_FORMAT_FIELD_ID = new DateFormat.Field[] { 
  ...
  private void subFormat(int paramInt1, int paramInt2, Format.FieldDelegate paramFieldDelegate, StringBuffer paramStringBuffer, boolean paramBoolean) {
    ...
    boolean bool = (paramInt2 >= 4) ? true : true;
    if (!paramBoolean && k < 15 && paramInt1 != 22)
      str = this.calendar.getDisplayName(k, bool, this.locale); 
    switch (paramInt1) {
      case 0:
        if (paramBoolean) {
      ...
      case 19:
        ...
        if (str == null)
          zeroPaddingNumber(m, (bool == 2) ? 1 : paramInt2, i, paramStringBuffer); 
        break;
      case 2:
        if (paramBoolean) {
          if (paramInt2 >= 4) {
          ...
          str = this.calendar.getDisplayName(k, bool | 0x8000, this.locale);
          if (str == null)
            str = this.calendar.getDisplayName(k, bool, this.locale); 
        } 
        if (str == null)
      ...
      case 17:
        if (str == null) {
          if (this.formatData.locale == null || this.formatData.isZoneStringsSet) {
            ...
            byte b = (this.calendar.get(16) == 0) ? 1 : 3;
            if (paramInt2 < 4)
              b++; 
            String[][] arrayOfString = this.formatData.getZoneStringsWrapper();
            paramStringBuffer.append(arrayOfString[i2][b]);
            break;
          } 
          TimeZone timeZone = this.calendar.getTimeZone();
          boolean bool1 = (this.calendar.get(16) != 0) ? true : false;
          boolean bool2 = (paramInt2 < 4) ? false : true;
          paramStringBuffer.append(timeZone.getDisplayName(bool1, bool2, this.formatData.locale));
        } 
        break;
      case 18:
  ...
  public Date parse(String paramString, ParsePosition paramParsePosition) {
    ...
    for (byte b = 0; b < this.compiledPattern.length; ) {
      int m = this.compiledPattern[b] >>> 8;
      int n = this.compiledPattern[b++] & 0xFF;
      if (n == 255) {
        n = this.compiledPattern[b++] << 16;
        n |= this.compiledPattern[b++];
      } 
      switch (m) {
        case 100:
          if (i >= k || paramString.charAt(i) != (char)n) {
      ...
      if (b < this.compiledPattern.length) {
        int i1 = this.compiledPattern[b] >>> 8;
        if (i1 != 100 && i1 != 101)
          bool1 = true; 
        if (this.hasFollowingMinusSign && (i1 == 100 || i1 == 101)) {
          int i2;
          if (i1 == 100) {
            i2 = this.compiledPattern[b] & 0xFF;
          } else {
            i2 = this.compiledPattern[b + 1];
          } 
          if (i2 == this.minusSign)
            bool2 = true; 
        } 
      } 
      i = subParse(paramString, i, m, n, bool1, arrayOfBoolean, paramParsePosition, bool2, calendarBuilder);
      if (i < 0) {
        paramParsePosition.index = j;
        return null;
      } 
    ...
    try {
      ...
      if (arrayOfBoolean[0] && 
        date.before(this.defaultCenturyStart))
  ...
  private int matchString(String paramString, int paramInt1, int paramInt2, String[] paramArrayOfString, CalendarBuilder paramCalendarBuilder) {
    ...
    for (; b < i; b++) {
      ...
      if (k > j && paramString
        .regionMatches(true, paramInt1, paramArrayOfString[b], 0, k)) {
        b1 = b;
        j = k;
      } 
    } 
    if (b1 >= 0) {
      paramCalendarBuilder.set(paramInt2, b1);
      return paramInt1 + j;
    } 
    return -paramInt1;
  }
    ...
    if (paramMap != null) {
      ...
      for (String str1 : paramMap.keySet()) {
        ...
        if ((str == null || i > str.length()) && 
          paramString.regionMatches(true, paramInt1, str1, 0, i))
          str = str1; 
      } 
      if (str != null) {
  ...
  private int matchZoneString(String paramString, int paramInt, String[] paramArrayOfString) {
    for (byte b = 1; b <= 4; b++) {
      ...
      if (paramString.regionMatches(true, paramInt, str, 0, str
          .length()))
        return b; 
    } 
    return -1;
  ...
  private boolean matchDSTString(String paramString, int paramInt1, int paramInt2, int paramInt3, String[][] paramArrayOfString) {
    ...
    if (paramString.regionMatches(true, paramInt1, str, 0, str
        .length()))
      return true; 
    return false;
  }
  ...
  private int subParseZoneString(String paramString, int paramInt, CalendarBuilder paramCalendarBuilder) {
    ...
    if (timeZone2 != null) {
      ...
      boolean bool1 = (j >= 3) ? timeZone2.getDSTSavings() : false;
      if (!bool && (j < 3 || bool1))
        paramCalendarBuilder.clear(15).set(16, bool1); 
    ...
    switch (paramInt2) {
      case 0:
        if (bool) {
          ...
          Map<String, Integer> map = getDisplayNamesMap(j, this.locale);
          int m;
      ...
      case 19:
        if (!(this.calendar instanceof java.util.GregorianCalendar)) {
          boolean bool1 = (paramInt3 >= 4) ? true : true;
          Map<String, Integer> map = this.calendar.getDisplayNames(j, bool1, this.locale);
          int m;
      ...
      case 9:
        if (bool) {
          ...
          for (int n : arrayOfInt) {
            Map<String, Integer> map = this.calendar.getDisplayNames(j, n, this.locale);
            int m;
            if ((m = matchString(paramString, paramInt1, j, map, paramCalendarBuilder)) > 0)
              return m; 
          } 
  ...
  public String toLocalizedPattern() {
    return translatePattern(this.pattern, "GyMdkHmsSEDFwWahKzZYuXL", this.formatData
  ...
  public void applyLocalizedPattern(String paramString) {
    String str = translatePattern(paramString, this.formatData
        .getLocalPatternChars(), "GyMdkHmsSEDFwWahKzZYuXL");
  ...
  public boolean equals(Object paramObject) {
    ...
    return (this.pattern.equals(simpleDateFormat.pattern) && this.formatData
      .equals(simpleDateFormat.formatData));
  }
  ...
  private Map<String, Integer> getDisplayNamesMap(int paramInt, Locale paramLocale) {
    Map<String, Integer> map = this.calendar.getDisplayNames(paramInt, 1, paramLocale);
    for (int i : REST_OF_STYLES) {
      Map<String, Integer> map1 = this.calendar.getDisplayNames(paramInt, i, paramLocale);
      if (map1 != null)
        map.putAll(map1); 
    } 
    return map;
  ...
  private void checkNegativeNumberExpression() {
    if (this.numberFormat instanceof DecimalFormat && 
      !this.numberFormat.equals(this.originalNumberFormat)) {
