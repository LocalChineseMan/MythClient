...
public abstract class NumberFormat extends Format {
  ...
  public void setParseIntegerOnly(boolean paramBoolean) {
    this.parseIntegerOnly = paramBoolean;
  }
  ...
  public static Locale[] getAvailableLocales() {
    LocaleServiceProviderPool localeServiceProviderPool = LocaleServiceProviderPool.getPool((Class)NumberFormatProvider.class);
  ...
  public void setGroupingUsed(boolean paramBoolean) {
    this.groupingUsed = paramBoolean;
  }
  ...
  private static NumberFormat getInstance(Locale paramLocale, int paramInt) {
    LocaleProviderAdapter localeProviderAdapter = LocaleProviderAdapter.getAdapter((Class)NumberFormatProvider.class, paramLocale);
