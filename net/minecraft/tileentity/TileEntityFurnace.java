...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
  ...
  private boolean canSmelt() {
    ...
    return (itemstack != null && (this.furnaceItemStacks[2] == null || (this.furnaceItemStacks[2].isItemEqual(itemstack) && (((this.furnaceItemStacks[2]).stackSize < getInventoryStackLimit() && (this.furnaceItemStacks[2]).stackSize < this.furnaceItemStacks[2].getMaxStackSize()) || (this.furnaceItemStacks[2]).stackSize < itemstack.getMaxStackSize()))));
  }
