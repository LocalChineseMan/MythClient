...
public abstract class TileEntity {
  ...
  public void addInfoToCrashReport(CrashReportCategory reportCategory) {
    reportCategory.addCrashSectionCallable("Name", (Callable)new Object(this));
    if (this.worldObj != null) {
      CrashReportCategory.addBlockInfo(reportCategory, this.pos, getBlockType(), getBlockMetadata());
      reportCategory.addCrashSectionCallable("Actual block type", (Callable)new Object(this));
      reportCategory.addCrashSectionCallable("Actual block data value", (Callable)new Object(this));
    } 
  }
