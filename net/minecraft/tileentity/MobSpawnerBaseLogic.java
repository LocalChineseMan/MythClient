...
public abstract class MobSpawnerBaseLogic {
  ...
  private String getEntityNameToSpawn() {
    ...
    return WeightedRandomMinecart.access$000(getRandomEntity());
  }
  ...
  private Entity spawnNewEntity(Entity entityIn, boolean spawn) {
    if (getRandomEntity() != null) {
      ...
      for (String s : WeightedRandomMinecart.access$100(getRandomEntity()).getKeySet()) {
        NBTBase nbtbase = WeightedRandomMinecart.access$100(getRandomEntity()).getTag(s);
  ...
  public void readFromNBT(NBTTagCompound nbt) {
    ...
    if (nbt.hasKey("SpawnData", 10)) {
      setRandomEntity(new WeightedRandomMinecart(this, nbt.getCompoundTag("SpawnData"), this.mobID));
    } else {
  ...
  public void writeToNBT(NBTTagCompound nbt) {
    ...
    if (!StringUtils.isNullOrEmpty(s)) {
      ...
      if (getRandomEntity() != null)
        nbt.setTag("SpawnData", WeightedRandomMinecart.access$100(getRandomEntity()).copy()); 
