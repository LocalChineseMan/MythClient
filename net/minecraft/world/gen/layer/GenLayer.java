  ...
  protected static boolean biomesEqualOrMesaPlateau(int biomeIDA, int biomeIDB) {
    ...
    if (biomeIDA != BiomeGenBase.mesaPlateau_F.biomeID && biomeIDA != BiomeGenBase.mesaPlateau.biomeID) {
      ...
      try {
        ...
        crashreportcategory.addCrashSectionCallable("Biome A", (Callable)new Object(biomegenbase));
        crashreportcategory.addCrashSectionCallable("Biome B", (Callable)new Object(biomegenbase1));
