...
public class StructureMineshaftPieces {
  ...
  public static class Corridor extends StructureComponent {
    ...
    public static StructureBoundingBox func_175814_a(List<StructureComponent> p_175814_0_, Random rand, int x, int y, int z, EnumFacing facing) {
      ...
      for (i = rand.nextInt(3) + 2; i > 0; i--) {
        int j = i * 5;
        switch (StructureMineshaftPieces.null.$SwitchMap$net$minecraft$util$EnumFacing[facing.ordinal()]) {
          case 1:
    ...
    public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
      ...
      if (this.coordBaseMode != null)
        switch (StructureMineshaftPieces.null.$SwitchMap$net$minecraft$util$EnumFacing[this.coordBaseMode.ordinal()]) {
          case 1:
            if (j <= 1) {
  ...
  public static class Cross extends StructureComponent {
    ...
    public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
      int i = getComponentType();
      switch (StructureMineshaftPieces.null.$SwitchMap$net$minecraft$util$EnumFacing[this.corridorDirection.ordinal()]) {
        case 1:
