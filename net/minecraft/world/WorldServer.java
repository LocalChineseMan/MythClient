...
public class WorldServer extends World implements IThreadListener {
      ...
      for (ChunkCoordIntPair chunkcoordintpair : this.activeChunkSet) {
        ...
        if (this.rand.nextInt(100000) == 0 && isRaining() && isThundering()) {
          ...
          if (canLightningStrike(blockpos))
            addWeatherEffect((Entity)new EntityLightningBolt((World)this, blockpos.getX(), blockpos.getY(), blockpos.getZ())); 
        } 
        ...
        if (this.rand.nextInt(16) == 0) {
          ...
          if (isRaining() && getBiomeGenForCoords(blockpos1).canSpawnLightningBolt())
            getBlockState(blockpos1).getBlock().fillWithRain((World)this, blockpos1); 
        } 
        this.theProfiler.endStartSection("tickBlocks");
  ...
  protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
    ...
    List<EntityLivingBase> list = getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb, (Predicate)new Object(this));
  ...
  public boolean isBlockModifiable(EntityPlayer player, BlockPos pos) {
    return (!this.mcServer.isBlockProtected((World)this, pos, player) && getWorldBorder().contains(pos));
  }
  ...
  protected void createBonusChest() {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      if (worldgeneratorbonuschest.generate((World)this, this.rand, blockpos))
        break; 
    } 
  }
  ...
  private boolean fireBlockEvent(BlockEventData event) {
    ...
    return (iblockstate.getBlock() == event.getBlock() && iblockstate.getBlock().onBlockEventReceived((World)this, event.getPosition(), iblockstate, event.getEventID(), event.getEventParameter()));
  }
