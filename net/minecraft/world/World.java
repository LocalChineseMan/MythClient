...
public abstract class World implements IBlockAccess {
  ...
  public BiomeGenBase getBiomeGenForCoords(BlockPos pos) {
    if (isBlockLoaded(pos)) {
      ...
      try {
        ...
        crashreportcategory.addCrashSectionCallable("Location", (Callable)new Object(this, pos));
  ...
  public void notifyBlockOfStateChange(BlockPos pos, Block blockIn) {
    if (!this.isRemote) {
      ...
      try {
        ...
        crashreportcategory.addCrashSectionCallable("Source block type", (Callable)new Object(this, blockIn));
      ...
      for (int l1 = i1; l1 < j1; l1++) {
        if (isBlockLoaded((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, 64, l1)))
          for (int i2 = k - 1; i2 < l; i2++) {
            ...
            iblockstate.getBlock().addCollisionBoxesToList(this, (BlockPos)blockpos$mutableblockpos, iblockstate, bb, list, null);
          }  
      } 
    } 
    return list;
  ...
  public Vec3 getCloudColour(float partialTicks) {
    ...
    f1 = MathHelper.clamp_float(f1, 0.0F, 1.0F);
    getClass();
    float f2 = (float)(16777215L >> 16L & 0xFFL) / 255.0F;
    getClass();
    float f3 = (float)(16777215L >> 8L & 0xFFL) / 255.0F;
    getClass();
    float f4 = (float)(0xFFFFFFL & 0xFFL) / 255.0F;
  ...
  public static boolean doesBlockHaveSolidTopSurface(IBlockAccess blockAccess, BlockPos pos) {
    ...
    Block block = iblockstate.getBlock();
    return ((block.getMaterial().isOpaque() && block.isFullCube()) || ((block instanceof BlockStairs) ? (iblockstate.getValue((IProperty)BlockStairs.HALF) == BlockStairs.EnumHalf.TOP) : ((block instanceof BlockSlab) ? (iblockstate.getValue((IProperty)BlockSlab.HALF) == BlockSlab.EnumBlockHalf.TOP) : (block instanceof net.minecraft.block.BlockHopper || (block instanceof BlockSnow && ((Integer)iblockstate.getValue((IProperty)BlockSnow.LAYERS)).intValue() == 7)))));
  }
  ...
  public int getRedstonePower(BlockPos pos, EnumFacing facing) {
    IBlockState iblockstate = getBlockState(pos);
    Block block = iblockstate.getBlock();
    return block.isNormalCube() ? getStrongPower(pos) : block.getWeakPower((IBlockAccess)this, pos, iblockstate, facing);
  }
  ...
  public boolean canLightningStrike(BlockPos strikePosition) {
    ...
    return (!biomegenbase.getEnableSnow() && !canSnowAt(strikePosition, false) && biomegenbase.canSpawnLightningBolt());
  }
  ...
  public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
    ...
    crashreportcategory.addCrashSectionCallable("All players", (Callable)new Object(this));
    crashreportcategory.addCrashSectionCallable("Chunk stats", (Callable)new Object(this));
    try {
