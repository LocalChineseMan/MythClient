...
public abstract class EntityLivingBase extends Entity {
  ...
  public float lastYaw = this.rotationYaw, lastPitch = this.rotationPitch;
  ...
  private int getArmSwingAnimationEnd() {
    int speed = (int)(6.0F * (Animations.getInstance().isEnabled() ? (Animations.getInstance()).swingSpeed.getValue().floatValue() : 1.0F));
