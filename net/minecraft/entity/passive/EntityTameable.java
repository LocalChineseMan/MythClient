...
public abstract class EntityTameable extends EntityAnimal implements IEntityOwnable {
  ...
  public void onDeath(DamageSource cause) {
    if (!this.worldObj.isRemote && this.worldObj.getGameRules().getBoolean("showDeathMessages") && hasCustomName() && getOwner() instanceof net.minecraft.entity.player.EntityPlayerMP)
