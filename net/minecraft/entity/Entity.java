...
public abstract class Entity implements ICommandSender {
  ...
  public void moveEntity(double x, double y, double z) {
    if (this.noClip) {
      ...
      boolean safeMode = (this.onGround && event.isSafe() && this instanceof EntityPlayer);
      if (flag || safeMode) {
        double d6;
  ...
  public void moveFlying(float strafe, float forward, float friction) {
    ...
    EventMoveRelative event = new EventMoveRelative(strafe, forward, friction, yaw);
    ...
    if (f >= 1.0E-4F) {
      ...
      strafe *= f;
      forward *= f;
      float f1 = MathHelper.sin(strafeEvent.getYaw() * 3.1415927F / 180.0F);
      float f2 = MathHelper.cos(strafeEvent.getYaw() * 3.1415927F / 180.0F);
  ...
  public void addEntityCrashInfo(CrashReportCategory category) {
    category.addCrashSectionCallable("Entity Type", (Callable)new Object(this));
    category.addCrashSection("Entity ID", Integer.valueOf(this.entityId));
    category.addCrashSectionCallable("Entity Name", (Callable)new Object(this));
    ...
    category.addCrashSectionCallable("Entity's Rider", (Callable)new Object(this));
    category.addCrashSectionCallable("Entity's Vehicle", (Callable)new Object(this));
  }
  ...
  public void setCommandStat(CommandResultStats.Type type, int amount) {
    this.cmdResultStats.func_179672_a((ICommandSender)this, type, amount);
  }
