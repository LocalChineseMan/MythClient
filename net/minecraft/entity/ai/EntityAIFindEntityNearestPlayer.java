...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase {
  ...
  public EntityAIFindEntityNearestPlayer(EntityLiving p_i45882_1_) {
    ...
    this.field_179435_c = new Predicate<Entity>() {
        public boolean apply(Entity p_apply_1_) {
          ...
          return (p_apply_1_.getDistanceToEntity((Entity)EntityAIFindEntityNearestPlayer.this.field_179434_b) <= d0 && EntityAITarget.isSuitableTarget(EntityAIFindEntityNearestPlayer.this.field_179434_b, (EntityLivingBase)p_apply_1_, false, true));
        }
      };
  ...
  public boolean continueExecuting() {
    ...
    if (team != null && team1 == team)
      return false; 
    double d0 = func_179431_f();
    return (this.field_179434_b.getDistanceSqToEntity((Entity)entitylivingbase) <= d0 * d0 && (!(entitylivingbase instanceof EntityPlayerMP) || !((EntityPlayerMP)entitylivingbase).theItemInWorldManager.isCreative()));
  }
