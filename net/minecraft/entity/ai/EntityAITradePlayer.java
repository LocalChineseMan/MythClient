...
public class EntityAITradePlayer extends EntityAIBase {
  ...
  public boolean shouldExecute() {
    ...
    return (entityplayer != null && this.villager.getDistanceSqToEntity((Entity)entityplayer) <= 16.0D && entityplayer.openContainer instanceof net.minecraft.inventory.Container);
  }
