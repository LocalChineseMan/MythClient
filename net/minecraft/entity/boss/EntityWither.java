...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob {
  ...
  private static final Predicate<Entity> attackEntitySelector = (Predicate<Entity>)new Object();
  ...
  public EntityWither(World worldIn) {
    ...
    this.tasks.addTask(2, (EntityAIBase)new EntityAIArrowAttack((IRangedAttackMob)this, 1.0D, 40, 20.0F));
    ...
    if (getInvulTime() > 0) {
      ...
      if (this.blockBreakCounter > 0) {
        ...
        if (this.blockBreakCounter == 0 && this.worldObj.getGameRules().getBoolean("mobGriefing")) {
          ...
          if (flag)
            this.worldObj.playAuxSFXAtEntity(null, 1012, new BlockPos((Entity)this), 0); 
        } 
      } 
  ...
  private void launchWitherSkullToCoords(int p_82209_1_, double x, double y, double z, boolean invulnerable) {
    this.worldObj.playAuxSFXAtEntity(null, 1014, new BlockPos((Entity)this), 0);
