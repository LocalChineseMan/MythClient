...
public abstract class EntityCreature extends EntityLiving {
  ...
  private final EntityAIBase aiBase = (EntityAIBase)new EntityAIMoveTowardsRestriction(this, 1.0D);
  ...
  public boolean isWithinHomeDistanceFromPosition(BlockPos pos) {
    return (this.maximumHomeDistance == -1.0F || this.homePosition.distanceSq((Vec3i)pos) < (this.maximumHomeDistance * this.maximumHomeDistance));
  }
