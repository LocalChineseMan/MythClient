...
public abstract class EntityPlayer extends EntityLivingBase {
  ...
  public float getToolDigEfficiency(Block p_180471_1_) {
    ...
    if (isInsideOfMaterial(Material.water) && !EnchantmentHelper.getAquaAffinityModifier((EntityLivingBase)this))
      f /= 5.0F; 
    if (!this.onGround)
      f /= 5.0F; 
    return f;
  ...
  private void func_175139_a(EnumFacing p_175139_1_) {
    ...
    switch (null.$SwitchMap$net$minecraft$util$EnumFacing[p_175139_1_.ordinal()]) {
      case 1:
