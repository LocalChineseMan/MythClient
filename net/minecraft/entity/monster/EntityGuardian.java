...
public class EntityGuardian extends EntityMob {
  ...
  public EntityGuardian(World worldIn) {
    ...
    this.targetTasks.addTask(1, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, EntityLivingBase.class, 10, true, false, new GuardianTargetSelector(this)));
  ...
  protected void updateAITasks() {
    ...
    if (isElder()) {
      ...
      if ((this.ticksExisted + getEntityId()) % 1200 == 0) {
        ...
        for (EntityPlayerMP entityplayermp : this.worldObj.getPlayers(EntityPlayerMP.class, (Predicate)new Object(this))) {
