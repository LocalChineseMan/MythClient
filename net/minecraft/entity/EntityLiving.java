...
public abstract class EntityLiving extends EntityLivingBase {
  ...
  public final boolean interactFirst(EntityPlayer playerIn) {
    ...
    return (interact(playerIn) || super.interactFirst(playerIn));
  }
  ...
  public void clearLeashed(boolean sendPacket, boolean dropLead) {
    if (this.isLeashed) {
      ...
      if (!this.worldObj.isRemote && sendPacket && this.worldObj instanceof WorldServer)
        ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, (Packet)new S1BPacketEntityAttach(1, this, null)); 
    } 
  }
