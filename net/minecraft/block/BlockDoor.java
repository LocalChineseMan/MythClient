...
public class BlockDoor extends Block {
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    return (pos.getY() < 255 && World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && super.canPlaceBlockAt(worldIn, pos) && super.canPlaceBlockAt(worldIn, pos.up()));
  }
