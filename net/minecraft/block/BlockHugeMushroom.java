...
public class BlockHugeMushroom extends Block {
  ...
  public MapColor getMapColor(IBlockState state) {
    switch (null.$SwitchMap$net$minecraft$block$BlockHugeMushroom$EnumType[((EnumType)state.getValue((IProperty)VARIANT)).ordinal()]) {
      case 1:
  ...
  protected BlockState createBlockState() {
    return new BlockState((Block)this, new IProperty[] { (IProperty)VARIANT });
  }
