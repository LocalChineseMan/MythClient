...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider {
  ...
  private EntityItemFrame findItemFrame(World worldIn, EnumFacing facing, BlockPos pos) {
    List<EntityItemFrame> list = worldIn.getEntitiesWithinAABB(EntityItemFrame.class, new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), (pos.getX() + 1), (pos.getY() + 1), (pos.getZ() + 1)), (Predicate)new Object(this, facing));
  ...
  protected BlockState createBlockState() {
    return new BlockState((Block)this, new IProperty[] { (IProperty)FACING, (IProperty)MODE, (IProperty)POWERED });
  }
