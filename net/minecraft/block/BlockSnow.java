...
public class BlockSnow extends Block {
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    ...
    return (block != Blocks.ice && block != Blocks.packed_ice && (block.getMaterial() == Material.leaves || (block == this && ((Integer)iblockstate.getValue((IProperty)LAYERS)).intValue() >= 7) || (block.isOpaqueCube() && block.blockMaterial.blocksMovement())));
  }
