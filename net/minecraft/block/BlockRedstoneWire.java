...
public class BlockRedstoneWire extends Block {
  ...
  private boolean func_176339_d(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
    ...
    return ((!flag1 && flag && canConnectUpwardsTo(worldIn, blockpos.up())) || canConnectTo(iblockstate, side) || (block == Blocks.powered_repeater && iblockstate.getValue((IProperty)BlockRedstoneDiode.FACING) == side) || (!flag && canConnectUpwardsTo(worldIn, blockpos.down())));
  }
