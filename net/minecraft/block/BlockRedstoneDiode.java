...
public abstract class BlockRedstoneDiode extends BlockDirectional {
  ...
  public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
    return (World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && super.canPlaceBlockAt(worldIn, pos));
  }
  ...
  public boolean isFacingTowardsRepeater(World worldIn, BlockPos pos, IBlockState state) {
    ...
    BlockPos blockpos = pos.offset(enumfacing);
    return (isRedstoneRepeaterBlockID(worldIn.getBlockState(blockpos).getBlock()) && worldIn.getBlockState(blockpos).getValue((IProperty)FACING) != enumfacing);
  }
