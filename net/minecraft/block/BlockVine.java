...
public class BlockVine extends Block {
  ...
  public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side) {
    switch (null.$SwitchMap$net$minecraft$util$EnumFacing[side.ordinal()]) {
      case 1:
  ...
  protected BlockState createBlockState() {
    return new BlockState((Block)this, new IProperty[] { (IProperty)UP, (IProperty)NORTH, (IProperty)EAST, (IProperty)SOUTH, (IProperty)WEST });
  }
