...
public class BlockBanner extends BlockContainer {
  ...
  public static class BlockBannerHanging extends BlockBanner {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
      ...
      switch (BlockBanner.null.$SwitchMap$net$minecraft$util$EnumFacing[enumfacing.ordinal()]) {
        default:
    ...
    protected BlockState createBlockState() {
      return new BlockState((Block)this, new IProperty[] { (IProperty)FACING });
    }
  }
  ...
  public static class BlockBannerStanding extends BlockBanner {
    ...
    protected BlockState createBlockState() {
      return new BlockState((Block)this, new IProperty[] { (IProperty)ROTATION });
    }
  }
}
