...
public class BlockSapling extends BlockBush implements IGrowable {
  ...
  public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
    ...
    int j = 0;
    boolean flag = false;
    switch (null.$SwitchMap$net$minecraft$block$BlockPlanks$EnumType[((BlockPlanks.EnumType)state.getValue((IProperty)TYPE)).ordinal()]) {
      case 1:
  ...
  protected BlockState createBlockState() {
    return new BlockState((Block)this, new IProperty[] { (IProperty)TYPE, (IProperty)STAGE });
  }
}
