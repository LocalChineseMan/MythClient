...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
  ...
  public void sendPacketDelayed(Packet packet, long delay) {
    try {
      (new Object(this, delay, packet))
  ...
  public void handleResourcePack(S48PacketResourcePackSend packetIn) {
    ...
    if (s.startsWith("level://")) {
      ...
      if (file2.isFile()) {
        ...
        Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(file2), (FutureCallback)new Object(this, s1));
      } else {
      ...
      this.netManager.sendPacket((Packet)new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.ACCEPTED));
      Futures.addCallback(this.gameController.getResourcePackRepository().downloadResourcePack(s, s1), (FutureCallback)new Object(this, s1));
      ...
      this.gameController.addScheduledTask((Runnable)new Object(this, s1, s));
    } 
  }
