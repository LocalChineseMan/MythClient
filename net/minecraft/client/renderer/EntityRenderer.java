...
public class EntityRenderer implements IResourceManagerReloadListener {
  ...
  public void func_181560_a(float p_181560_1_, long p_181560_2_) {
    ...
    if ((this.mc.inGameHasFocus || (ChestStealer.hideGuiMouse && this.mc.currentScreen instanceof net.minecraft.client.gui.inventory.GuiChest)) && flag && this.mc.mouseHelper != null && this.mc.thePlayer != null) {
    ...
    if (!this.mc.skipRenderWorld) {
      ...
      if (this.mc.currentScreen != null) {
        ...
        try {
          ...
          crashreportcategory.addCrashSectionCallable("Screen name", (Callable)new EntityRenderer2(this));
          crashreportcategory.addCrashSectionCallable("Mouse location", (Callable)new Object(this, j1, k1));
          crashreportcategory.addCrashSectionCallable("Screen size", (Callable)new Object(this, scaledresolution));
