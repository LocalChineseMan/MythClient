...
public class RegionRenderCache extends ChunkCache {
  ...
  private static final ArrayDeque<int[]> cacheLights = (ArrayDeque)new ArrayDeque<>();
  
  private static final ArrayDeque<IBlockState[]> cacheStates = (ArrayDeque)new ArrayDeque<>();
