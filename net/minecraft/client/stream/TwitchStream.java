...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester$IngestTestListener, IStream {
  ...
  public TwitchStream(Minecraft mcIn, Property streamProperty) {
    ...
    this.broadcastController.func_152841_a((BroadcastController.BroadcastListener)this);
    this.chatController.func_152990_a((ChatController.ChatListener)this);
    ...
    if (streamProperty != null && !Strings.isNullOrEmpty(streamProperty.getValue()) && OpenGlHelper.framebufferSupported) {
      Object object = new Object(this, "Twitch authenticator", streamProperty);
  ...
  public void func_152909_x() {
    ...
    if (ingestservertester != null)
      ingestservertester.func_153042_a((IngestServerTester$IngestTestListener)this); 
  }
