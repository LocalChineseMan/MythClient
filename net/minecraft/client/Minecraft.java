...
import notthatuwu.xyz.mythrecode.api.ui.mainmenu.GuiAuth;
...
import notthatuwu.xyz.mythrecode.events.EventWorldLoad;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
  ...
  private void startGame() throws LWJGLException, IOException {
    ...
    GuiMainMenu.shaderName = "rainbow";
    ...
    initStream();
    drawSplashScreen(0, ".", getTextureManager(), 0);
    ...
    drawSplashScreen(0, "..", getTextureManager(), 10);
    ...
    drawSplashScreen(10, "...", getTextureManager(), 50);
    ...
    GuiMainMenu.shaderName = "rainbow";
    Client.INSTANCE.startCommon();
    drawSplashScreen(50, "..", getTextureManager(), 100);
    displayGuiScreen((GuiScreen)new GuiAuth());
  ...
  private void startTimerHackThread() {
    Thread thread = new Thread("TimeHelper hack thread") {
        public void run() {
  ...
  public void drawSplashScreen(int before, String status, TextureManager tm, int much) {
    for (int i = before; i < much; i++)
      drawSplashScreen(status, tm, i); 
  }
  
  private void drawSplashScreen(String status, TextureManager tm, int much) {
    ...
    if (much > 50)
      fade -= much * 2 + 55; 
    try {
      tm.bindTexture(new ResourceLocation("myth/image/" + GuiMainMenu.shaderName + ".png"));
      Gui.drawScaledCustomSizeModalRect(0, 0, 0.0F, 0.0F, 1920, 1080, sr
          .getScaledWidth(), sr.getScaledHeight(), 1920.0F, 1080.0F);
    } catch (Exception e) {
      e.printStackTrace();
    } 
    FontLoaders.Sfui40.drawCenteredString("Loading Myth", (sr.getScaledWidth() / 2), (sr.getScaledHeight() / 2 - 15), (new Color(255, 255, 255, fade)).getRGB());
    FontLoaders.big.drawCenteredString("" + status, (sr.getScaledWidth() / 2), (sr.getScaledHeight() / 2 + 30), (new Color(255, 255, 255, fade)).getRGB());
    GlStateManager.disableLighting();
    GlStateManager.disableFog();
  ...
  public void runTick() throws IOException {
    ...
    if (this.currentScreen != null) {
      try {
        ...
        crashreportcategory.addCrashSectionCallable("Screen name", (Callable)new Object(this));
      ...
      if (this.currentScreen != null)
        try {
          ...
          crashreportcategory1.addCrashSectionCallable("Screen name", (Callable)new Object(this));
  ...
  public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
    ...
    Client.INSTANCE.discordRPC.update("Myth 1.3 - 12", "Single Player");
  }
  ...
  public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
    theCrash.getCategory().addCrashSectionCallable("Launched Version", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("LWJGL", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("OpenGL", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("GL Caps", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("Using VBOs", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("Is Modded", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("Type", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("Resource Packs", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("Current Language", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("Profiler Position", (Callable)new Object(this));
    theCrash.getCategory().addCrashSectionCallable("CPU", (Callable)new Object(this));
    if (this.theWorld != null)
  ...
  public ListenableFuture<Object> scheduleResourcesRefresh() {
    return addScheduledTask((Runnable)new Object(this));
  }
      ...
      if (Keyboard.getEventKeyState()) {
        if (i == this.gameSettings.keyBindStreamStartStop.getKeyCode()) {
          if (getTwitchStream().isBroadcasting()) {
            ...
            displayGuiScreen((GuiScreen)new GuiYesNo((GuiYesNoCallback)new Object(this), 
