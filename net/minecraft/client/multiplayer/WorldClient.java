...
public class WorldClient extends World {
  ...
  public void doVoidFogParticles(int p_73029_1_, int p_73029_2_, int p_73029_3_) {
    ...
    for (int i = 0; i < 1000; i++) {
      ...
      iblockstate.getBlock().randomDisplayTick((World)this, (BlockPos)blockposm, iblockstate, random);
  ...
  public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
    ...
    crashreportcategory.addCrashSectionCallable("Forced entities", (Callable)new Object(this));
    crashreportcategory.addCrashSectionCallable("Retry entities", (Callable)new Object(this));
    crashreportcategory.addCrashSectionCallable("Server brand", (Callable)new Object(this));
    crashreportcategory.addCrashSectionCallable("Server type", (Callable)new Object(this));
