  ...
  public void drawTextBox() {
    if (getVisible()) {
      if (getEnableBackgroundDrawing()) {
        RenderUtils.drawRoundedRect2((this.xPosition - 1), (this.yPosition - 1), (this.xPosition + this.width + 1), (this.yPosition + this.height + 1), 5.0D, (new Color(0, 0, 0, 130)).getRGB());
        RenderUtils.drawRoundedRect2(this.xPosition, this.yPosition, (this.xPosition + this.width), (this.yPosition + this.height), 5.0D, (new Color(0, 0, 0, 120)).getRGB());
      } 
      ...
      if (flag1)
        if (flag2) {
          RenderUtils.drawRoundedRect2(k1, (i1 - 1), (k1 + 1), (i1 + 1 + this.fontRendererInstance.FONT_HEIGHT), 5.0D, (new Color(0, 0, 0, 120)).getRGB());
        } else {
