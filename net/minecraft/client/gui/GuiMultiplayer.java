...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
  ...
  public void initGui() {
    Client.INSTANCE.discordRPC.update("Myth 1.3 - 12", "Select Server");
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled) {
      ...
      if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
        ...
        this.mc.displayGuiScreen((GuiScreen)new GuiScreenAddServer(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
  ...
  private void connectToServer(ServerData server) {
    Client.INSTANCE.lastServer = server;
