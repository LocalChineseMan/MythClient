...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback {
  ...
  public void initGui() {
    Client.INSTANCE.discordRPC.update("Myth 1.3 - 12", "Select World");
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled)
      if (button.id == 2) {
        ...
        this.mc.displayGuiScreen((GuiScreen)new GuiRenameWorld(this, func_146621_a(this.field_146640_r)));
      } else if (button.id == 0) {
