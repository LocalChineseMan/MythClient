...
public class GuiScreenBook extends GuiScreen {
  ...
  public void initGui() {
    ...
    if (this.bookIsUnsigned) {
      getClass();
      this.buttonList.add(this.buttonSign = new GuiButton(3, this.width / 2 - 100, 4 + 192, 98, 20, I18n.format("book.signButton", new Object[0])));
      getClass();
      this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 + 2, 4 + 192, 98, 20, I18n.format("gui.done", new Object[0])));
      getClass();
      this.buttonList.add(this.buttonFinalize = new GuiButton(5, this.width / 2 - 100, 4 + 192, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
      getClass();
      this.buttonList.add(this.buttonCancel = new GuiButton(4, this.width / 2 + 2, 4 + 192, 98, 20, I18n.format("gui.cancel", new Object[0])));
    } else {
      getClass();
      this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 - 100, 4 + 192, 200, 20, I18n.format("gui.done", new Object[0])));
    } 
    getClass();
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    getClass();
    getClass();
    drawTexturedModalRect(i, j, 0, 0, 192, 192);
    if (this.bookGettingSigned) {
