...
public class GuiOverlayDebug extends Gui {
  ...
  protected void renderDebugInfoLeft() {
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      if (!Strings.isNullOrEmpty(s)) {
        ...
        boolean flag = true;
        int l = 2 + j * i;
        drawRect(1.0D, (l - 1), (2 + k + 1), (l + j - 1), -1873784752);
  ...
  private void func_181554_e() {
    ...
    int k = i;
    int l = 0;
    drawRect(0.0D, (scaledresolution.getScaledHeight() - 60), 240.0D, scaledresolution.getScaledHeight(), -1873784752);
    while (k != j) {
    ...
    drawRect(1.0D, (scaledresolution.getScaledHeight() - 30 + 1), 14.0D, (scaledresolution.getScaledHeight() - 30 + 10), -1873784752);
    ...
    drawRect(1.0D, (scaledresolution.getScaledHeight() - 60 + 1), 14.0D, (scaledresolution.getScaledHeight() - 60 + 10), -1873784752);
