...
public class GuiInventory extends InventoryEffectRenderer {
  ...
  public static void drawEntityOnScreen(int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent) {
    drawEntityOnScreen(posX, posY, 50.0F, scale, mouseX, mouseY, ent);
  }
  
  public static void drawEntityOnScreen(int posX, int posY, float z, int scale, float mouseX, float mouseY, EntityLivingBase ent) {
    GlStateManager.enableColorMaterial();
    GlStateManager.pushMatrix();
    GlStateManager.translate(posX, posY, z);
