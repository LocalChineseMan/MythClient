...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled) {
      ...
      if (button.id == 109)
        this.mc.displayGuiScreen((GuiScreen)new GuiYesNo(this, (new ChatComponentTranslation("difficulty.lock.title", new Object[0])).getFormattedText(), (new ChatComponentTranslation("difficulty.lock.question", new Object[] { new ChatComponentTranslation(this.mc.theWorld.getWorldInfo().getDifficulty().getDifficultyResourceKey(), new Object[0]) })).getFormattedText(), 109)); 
      if (button.id == 110) {
        this.mc.gameSettings.saveOptions();
        this.mc.displayGuiScreen((GuiScreen)new GuiCustomizeSkin(this));
      } 
