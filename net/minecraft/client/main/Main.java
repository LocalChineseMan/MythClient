...
public class Main {
  public static void main(String[] p_main_0_) {
    ...
    String s1 = (String)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec8);
    String s2 = (String)optionset.valueOf((OptionSpec)argumentAcceptingOptionSpec9);
    if (!proxy.equals(Proxy.NO_PROXY) && isNullOrEmpty(s1) && isNullOrEmpty(s2))
      Authenticator.setDefault((Authenticator)new Object(s1, s2)); 
