...
public class IntegratedServer extends MinecraftServer {
  ...
  protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type, String p_71247_6_) {
    ...
    if (Reflector.DimensionManager.exists()) {
      WorldServer worldserver = isDemo() ? (WorldServer)(new DemoWorldServer((MinecraftServer)this, isavehandler, worldinfo, 0, this.theProfiler)).init() : (WorldServer)(new WorldServerOF((MinecraftServer)this, isavehandler, worldinfo, 0, this.theProfiler)).init();
      ...
      for (int l = 0; l < this.worldServers.length; l++) {
        ...
        if (l == 0) {
          if (isDemo()) {
            this.worldServers[l] = (WorldServer)(new DemoWorldServer((MinecraftServer)this, isavehandler, worldinfo, b0, this.theProfiler)).init();
          } else {
            this.worldServers[l] = (WorldServer)(new WorldServerOF((MinecraftServer)this, isavehandler, worldinfo, b0, this.theProfiler)).init();
          } 
  ...
  public CrashReport addServerInfoToCrashReport(CrashReport report) {
    ...
    report.getCategory().addCrashSectionCallable("Type", (Callable)new Object(this));
    report.getCategory().addCrashSectionCallable("Is Modded", (Callable)new Object(this));
    return report;
  }
