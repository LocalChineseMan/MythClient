...
public class PlayerProfileCache {
  ...
  private static GameProfile getGameProfile(MinecraftServer server, String username) {
    ...
    Object object = new Object(agameprofile);
    server.getGameProfileRepository().findProfilesByNames(new String[] { username }, Agent.MINECRAFT, (ProfileLookupCallback)object);
    if (!server.isServerInOnlineMode() && agameprofile[0] == null) {
      ...
      object.onProfileLookupSucceeded(gameprofile);
    } 
