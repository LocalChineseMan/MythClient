...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener, IPlayerUsage {
  ...
  private final PlayerUsageSnooper usageSnooper = new PlayerUsageSnooper("server", (IPlayerUsage)this, getCurrentTimeMillis());
  ...
  public CrashReport addServerInfoToCrashReport(CrashReport report) {
    report.getCategory().addCrashSectionCallable("Profiler Position", (Callable)new Object(this));
    if (this.serverConfigManager != null)
      report.getCategory().addCrashSectionCallable("Player Count", (Callable)new Object(this)); 
    return report;
  }
