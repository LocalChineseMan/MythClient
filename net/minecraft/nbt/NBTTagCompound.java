...
public class NBTTagCompound extends NBTBase {
  ...
  private CrashReport createCrashReport(String key, int expectedType, ClassCastException ex) {
    ...
    crashreportcategory.addCrashSectionCallable("Tag type found", (Callable)new Object(this, key));
    crashreportcategory.addCrashSectionCallable("Tag type expected", (Callable)new Object(this, expectedType));
