...
public class CrashReportCategory {
  ...
  public static void addBlockInfo(CrashReportCategory category, BlockPos pos, Block blockIn, int blockData) {
    ...
    category.addCrashSectionCallable("Block type", (Callable<String>)new Object(i, blockIn));
    category.addCrashSectionCallable("Block data value", (Callable<String>)new Object(blockData));
    category.addCrashSectionCallable("Block location", (Callable<String>)new Object(pos));
  }
  
  public static void addBlockInfo(CrashReportCategory category, BlockPos pos, IBlockState state) {
    category.addCrashSectionCallable("Block", (Callable<String>)new Object(state));
    category.addCrashSectionCallable("Block location", (Callable<String>)new Object(pos));
  }
  
  static class CrashReportCategory {}
}
