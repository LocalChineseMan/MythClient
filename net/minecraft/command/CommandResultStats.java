...
public class CommandResultStats {
  ...
  public void func_179672_a(ICommandSender sender, Type resultTypeIn, int p_179672_3_) {
    String s = this.field_179675_c[resultTypeIn.getTypeID()];
    if (s != null) {
      String s1;
      Object object = new Object(this, sender);
      try {
        s1 = CommandBase.getEntityName((ICommandSender)object, s);
