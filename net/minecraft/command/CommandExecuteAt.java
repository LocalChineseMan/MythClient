...
public class CommandExecuteAt extends CommandBase {
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    ...
    Entity entity = getEntity(sender, args[0], Entity.class);
    ...
    Object object = new Object(this, entity, sender, blockpos, d0, d1, d2);
    ICommandManager icommandmanager = MinecraftServer.getServer().getCommandManager();
    try {
      int j = icommandmanager.executeCommand((ICommandSender)object, s);
      if (j < 1)
