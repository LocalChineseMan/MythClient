...
public abstract class CommandBlockLogic implements ICommandSender {
  ...
  public void trigger(World worldIn) {
    ...
    if (minecraftserver != null && minecraftserver.isAnvilFileSet() && minecraftserver.isCommandBlockEnabled()) {
      ...
      try {
        ...
        crashreportcategory.addCrashSectionCallable("Command", (Callable)new Object(this));
        crashreportcategory.addCrashSectionCallable("Name", (Callable)new Object(this));
  ...
  public void setCommandStat(CommandResultStats.Type type, int amount) {
    this.resultStats.func_179672_a((ICommandSender)this, type, amount);
  }
