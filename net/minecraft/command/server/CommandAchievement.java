      ...
      if (statbase == null) {
        ...
        if (statbase instanceof Achievement) {
          ...
          if (flag) {
            ...
            List<Achievement> list1 = Lists.newArrayList((Iterator)Iterators.filter(AchievementList.achievementList.iterator(), (Predicate)new Object(this, entityplayermp, statbase)));
