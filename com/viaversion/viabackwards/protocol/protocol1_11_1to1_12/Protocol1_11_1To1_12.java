...
public class Protocol1_11_1To1_12 extends BackwardsProtocol<ClientboundPackets1_12, ClientboundPackets1_9_3, ServerboundPackets1_12, ServerboundPackets1_9_3> {
  ...
  protected void registerPackets() {
    ...
    registerClientbound((ClientboundPacketType)ClientboundPackets1_12.TITLE, new PacketRemapper() {
    ...
    cancelClientbound((ClientboundPacketType)ClientboundPackets1_12.ADVANCEMENTS);
    cancelClientbound((ClientboundPacketType)ClientboundPackets1_12.UNLOCK_RECIPES);
    cancelClientbound((ClientboundPacketType)ClientboundPackets1_12.SELECT_ADVANCEMENTS_TAB);
  }
  
  public void init(UserConnection user) {
    if (!user.has(ClientWorld.class))
      user.put((StorableObject)new ClientWorld(user)); 
    user.addEntityTracker(getClass(), (EntityTracker)new EntityTrackerBase(user, (EntityType)Entity1_12Types.EntityType.PLAYER, true));
