...
public class ComponentRewriter1_13 extends ComponentRewriter {
  ...
  protected void handleHoverEvent(JsonObject hoverEvent) {
    ...
    dataItem.setData(damage);
    dataItem.setTag(itemTag);
    this.protocol.getItemRewriter().handleItemToClient((Item)dataItem);
    if (damage != dataItem.data())
      tag.put("Damage", (Tag)new ShortTag(dataItem.data())); 
    if (itemTag != null)
