...
public final class $Gson$Types {
  ...
  public static WildcardType subtypeOf(Type bound) {
    return (WildcardType)new WildcardTypeImpl(new Type[] { bound }, EMPTY_TYPE_ARRAY);
  }
  
  public static WildcardType supertypeOf(Type bound) {
    return (WildcardType)new WildcardTypeImpl(new Type[] { Object.class }, new Type[] { bound });
  }
  ...
  private static final class $Gson$Types {}
}
