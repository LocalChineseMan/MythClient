  ...
  public static UnsafeAllocator create() {
    try {
      ...
      try {
        ...
        return (UnsafeAllocator)new Object(newInstance);
        ...
        try {
          ...
          Method newInstance = ObjectStreamClass.class.getDeclaredMethod("newInstance", new Class[] { Class.class, int.class });
          newInstance.setAccessible(true);
          return (UnsafeAllocator)new Object(newInstance, constructorId);
        } catch (Exception exception1) {
          return (UnsafeAllocator)new Object();
        } 
      } 
    } 
  }
