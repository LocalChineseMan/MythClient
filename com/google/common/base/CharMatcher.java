...
public abstract class CharMatcher implements Predicate<Character> {
  ...
  public static CharMatcher isNot(char match) {
    ...
    return (CharMatcher)new Object(description, match);
  }
  ...
  public static CharMatcher anyOf(CharSequence sequence) {
    ...
    description.append("\")");
    return (CharMatcher)new Object(description.toString(), chars);
  }
  ...
  private static CharMatcher isEither(char match1, char match2) {
    ...
    return (CharMatcher)new Object(description, match1, match2);
  }
  ...
  public static CharMatcher forPredicate(Predicate<? super Character> predicate) {
    ...
    return (CharMatcher)new Object(description, predicate);
  }
  ...
  public CharMatcher negate() {
    return (CharMatcher)new NegatedMatcher(this);
  }
  
  public CharMatcher and(CharMatcher other) {
    return (CharMatcher)new And(this, Preconditions.<CharMatcher>checkNotNull(other));
  }
  ...
  CharMatcher precomputedInternal() {
    ...
    return (CharMatcher)new NegatedFastMatcher(toString(), precomputedPositive(negatedCharacters, table, negatedDescription));
  }
  ...
  static abstract class FastMatcher extends CharMatcher {
    ...
    public CharMatcher negate() {
      return (CharMatcher)new CharMatcher.NegatedFastMatcher(this);
    }
  }
  ...
  private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
    ...
    return isSmall(totalCharacters, table.length()) ? SmallCharMatcher.from(table, description) : (CharMatcher)new BitSetMatcher(table, description, null);
  }
