...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
  ...
  private static final class BelowValue<C extends Comparable> extends Cut<C> {
    ...
    Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> domain) {
      ...
      switch (Cut.null.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()]) {
        case 1:
          return this;
        case 2:
          comparable = domain.previous((Comparable)this.endpoint);
          return (comparable == null) ? Cut.<C>belowAll() : (Cut<C>)new Cut.AboveValue(comparable);
      } 
      throw new AssertionError();
    }
    ...
    Cut<C> withUpperBoundType(BoundType boundType, DiscreteDomain<C> domain) {
      ...
      switch (Cut.null.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()]) {
        case 1:
          comparable = domain.previous((Comparable)this.endpoint);
          return (comparable == null) ? Cut.<C>aboveAll() : (Cut<C>)new Cut.AboveValue(comparable);
        case 2:
          return this;
      } 
      throw new AssertionError();
    ...
    C greatestValueBelow(DiscreteDomain<C> domain) {
      return (C)domain.previous((Comparable)this.endpoint);
    }
  ...
  static <C extends Comparable> Cut<C> aboveValue(C endpoint) {
    return (Cut<C>)new AboveValue((Comparable)endpoint);
  }
