...
final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
  ...
  DenseImmutableTable(ImmutableList<Table.Cell<R, C, V>> cellList, ImmutableSet<R> rowSpace, ImmutableSet<C> columnSpace) {
    ...
    this.rowMap = (ImmutableMap<R, Map<C, V>>)new RowMap();
    this.columnMap = (ImmutableMap<C, Map<R, V>>)new ColumnMap();
  }
  ...
  private static abstract class ImmutableArrayMap<K, V> extends ImmutableMap<K, V> {
    ...
    ImmutableSet<Map.Entry<K, V>> createEntrySet() {
      return (ImmutableSet<Map.Entry<K, V>>)new Object(this);
    }
  }
  
  private final class DenseImmutableTable {}
  ...
  private final class RowMap extends ImmutableArrayMap<R, Map<C, V>> {
    ...
    Map<C, V> getValue(int keyIndex) {
      return (Map<C, V>)new DenseImmutableTable.Row(DenseImmutableTable.this, keyIndex);
    }
  ...
  private final class ColumnMap extends ImmutableArrayMap<C, Map<R, V>> {
    ...
    Map<R, V> getValue(int keyIndex) {
      return (Map<R, V>)new DenseImmutableTable.Column(DenseImmutableTable.this, keyIndex);
    }
