...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
  ...
  public BiMap<V, K> inverse() {
    return (this.inverse == null) ? (this.inverse = (BiMap<V, K>)new Inverse()) : this.inverse;
  }
  ...
  private final class Inverse extends AbstractMap<V, K> implements BiMap<V, K>, Serializable {
    ...
    private final class InverseKeySet extends Maps.KeySet<V, K> {
      InverseKeySet() {
        super((Map<V, K>)HashBiMap.Inverse.this);
      }
      
      public boolean remove(@Nullable Object o) {
        HashBiMap.BiEntry<K, V> entry = this.this$1.this$0.seekByValue(o, HashBiMap.hash(o));
        if (entry == null)
          return false; 
    ...
    public Set<Map.Entry<V, K>> entrySet() {
      return (Set<Map.Entry<V, K>>)new Object(this);
    }
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    init(size);
    Serialization.populateMap((Map)this, stream, size);
  }
  
  private static final class HashBiMap {}
}
