...
public final class Native implements Version {
  ...
  static {
    ...
    if (!isCompatibleVersion("5.2.0", getNativeVersion())) {
      ...
      throw new Error(LS + LS + "There is an incompatible JNA native library installed on this system" + LS + "Expected: " + "5.2.0" + LS + "Found:    " + 
  ...
  static final int MAX_ALIGNMENT = (Platform.isSPARC() || Platform.isWindows() || (
    ...
    Platform.isAIX() || 
    Platform.isAndroid()) ? 8 : LONG_SIZE;
  ...
  public static Map<String, Object> getLibraryOptions(Class<?> type) {
    ...
    synchronized (libraries) {
      Map<String, Object> libraryOptions = typeOptions.get(mappingClass);
      if (libraryOptions != null) {
  ...
  public static Library synchronizedLibrary(Library library) {
    ...
    Object object = new Object(handler, library);
    return (Library)Proxy.newProxyInstance(cls.getClassLoader(), cls
        .getInterfaces(), (InvocationHandler)object);
  }
  ...
  public static String getWebStartLibraryPath(String libName) {
    ...
    try {
      ...
      Method m = AccessController.<Method>doPrivileged((PrivilegedAction<Method>)new Object());
  ...
  static Class<?> getCallingClass() {
    Class<?>[] context = (new Object()).getClassContext();
    if (context == null)
  ...
  private static Map<Class<?>, long[]> registeredClasses = (Map)new WeakHashMap<Class<?>, long>();
