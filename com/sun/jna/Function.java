...
public class Function extends Pointer {
  ...
  Object invoke(Method invokingMethod, Class<?>[] paramTypes, Class<?> returnType, Object[] inArgs, Map<String, ?> options) {
    ...
    if (NativeMapped.class.isAssignableFrom(returnType)) {
      ...
      NativeMappedConverter nativeMappedConverter1 = tc;
  ...
  private Object convertArgument(Object[] args, int index, Method invokingMethod, TypeMapper mapper, boolean allowObjects, Class<?> expectedType) {
    ...
    if (arg != null) {
      ...
      if (converter != null) {
        ...
        if (invokingMethod != null) {
          MethodParameterContext methodParameterContext = new MethodParameterContext(this, args, index, invokingMethod);
        } else {
          functionParameterContext = new FunctionParameterContext(this, args, index);
        } 
        arg = converter.toNative(arg, (ToNativeContext)functionParameterContext);
      } 
    } 
