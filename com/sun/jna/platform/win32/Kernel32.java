...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
  ...
  boolean Process32First(WinNT.HANDLE paramHANDLE, Tlhelp32$PROCESSENTRY32 paramTlhelp32$PROCESSENTRY32);
  
  boolean Process32Next(WinNT.HANDLE paramHANDLE, Tlhelp32$PROCESSENTRY32 paramTlhelp32$PROCESSENTRY32);
  
  boolean Thread32First(WinNT.HANDLE paramHANDLE, Tlhelp32$THREADENTRY32 paramTlhelp32$THREADENTRY32);
  
  boolean Thread32Next(WinNT.HANDLE paramHANDLE, Tlhelp32$THREADENTRY32 paramTlhelp32$THREADENTRY32);
  ...
  boolean Module32FirstW(WinNT.HANDLE paramHANDLE, Tlhelp32$MODULEENTRY32W paramTlhelp32$MODULEENTRY32W);
  
  boolean Module32NextW(WinNT.HANDLE paramHANDLE, Tlhelp32$MODULEENTRY32W paramTlhelp32$MODULEENTRY32W);
