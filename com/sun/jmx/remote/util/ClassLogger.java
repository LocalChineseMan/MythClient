...
public class ClassLogger {
  ...
  public final void finest(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.FINEST, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
  ...
  public final void finer(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.FINER, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
  ...
  public final void fine(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.FINE, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
  ...
  public final void config(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.CONFIG, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
  ...
  public final void info(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.INFO, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
  ...
  public final void warning(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.WARNING, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
  ...
  public final void severe(String paramString, Throwable paramThrowable) {
    if (ok)
      this.logger.logp(Level.SEVERE, this.className, paramString, paramThrowable
          .toString(), paramThrowable); 
  }
