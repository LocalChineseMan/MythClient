...
public abstract class MBeanSupport<M> implements DynamicMBean2, MBeanRegistration {
  ...
  public final Object getAttribute(String paramString) throws AttributeNotFoundException, MBeanException, ReflectionException {
    return this.perInterface.getAttribute(this.resource, paramString, getCookie());
  }
  ...
  public final AttributeList setAttributes(AttributeList paramAttributeList) {
    ...
    for (Attribute attribute1 : paramAttributeList) {
      Attribute attribute2 = attribute1;
      try {
        setAttribute(attribute2);
        attributeList.add(new Attribute(attribute2.getName(), attribute2.getValue()));
      } catch (Exception exception) {}
    } 
    return attributeList;
  }
  ...
  public final Object invoke(String paramString, Object[] paramArrayOfObject, String[] paramArrayOfString) throws MBeanException, ReflectionException {
    return this.perInterface.invoke(this.resource, paramString, paramArrayOfObject, paramArrayOfString, 
        getCookie());
  }
