...
public class MBeanInstantiator {
  ...
  public Class<?>[] findSignatureClasses(String[] paramArrayOfString, ClassLoader paramClassLoader) throws ReflectionException {
    ...
    try {
      for (byte b = 0; b < i; b++) {
        Class clazz = primitiveClasses.get(paramArrayOfString[b]);
        if (clazz != null) {
          ...
          if (classLoader != null) {
            ...
            arrayOfClass[b] = findClass(paramArrayOfString[b], 
      ...
      if (JmxProperties.MBEANSERVER_LOGGER.isLoggable(Level.FINEST))
        JmxProperties.MBEANSERVER_LOGGER.logp(Level.FINEST, MBeanInstantiator.class
            .getName(), "findSignatureClasses", "The parameter class could not be found", classNotFoundException); 
      throw new ReflectionException(classNotFoundException, "The parameter class could not be found");
    } catch (RuntimeException runtimeException) {
      if (JmxProperties.MBEANSERVER_LOGGER.isLoggable(Level.FINEST))
        JmxProperties.MBEANSERVER_LOGGER.logp(Level.FINEST, MBeanInstantiator.class
            .getName(), "findSignatureClasses", "Unexpected exception", runtimeException); 
  ...
  public Object instantiate(Class<?> paramClass) throws ReflectionException, MBeanException {
    Object object;
    checkMBeanPermission(paramClass, (String)null, (ObjectName)null, "instantiate");
  ...
  public ObjectInputStream deserialize(String paramString, ObjectName paramObjectName, byte[] paramArrayOfbyte, ClassLoader paramClassLoader) throws InstanceNotFoundException, OperationsException, ReflectionException {
    ...
    if (paramObjectName == null) {
      ...
      try {
        ...
        throw new ReflectionException(classNotFoundException, "The MBean class could not be loaded by the " + paramObjectName
  ...
  public Object instantiate(String paramString) throws ReflectionException, MBeanException {
    return instantiate(paramString, (Object[])null, (String[])null, (ClassLoader)null);
  }
  ...
  private ClassLoader getClassLoader(ObjectName paramObjectName) {
    if (this.clr == null)
      return null; 
    ...
    return AccessController.<ClassLoader>doPrivileged((PrivilegedAction<ClassLoader>)new Object(this, paramObjectName), accessControlContext);
  }
}
