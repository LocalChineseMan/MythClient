...
public class Continuation extends ResolveResult {
  ...
  public Continuation(Name paramName, Hashtable<?, ?> paramHashtable) {
    ...
    this
      .environment = (paramHashtable == null) ? null : (Hashtable<?, ?>)paramHashtable.clone();
  }
  ...
  public NamingException fillInException(NamingException paramNamingException) {
    ...
    if (this.starter == null || this.starter.isEmpty()) {
      ...
      paramNamingException.setResolvedName(this.starter
          .getPrefix(this.starter.size() - this.remainingName
            .size()));
    } 
  ...
  public void setContinue(Object paramObject, Name paramName, Context paramContext) {
    setContinueAux(paramObject, paramName, paramContext, (Name)PartialCompositeContext._EMPTY_NAME
        .clone());
  }
  ...
  public void setContinue(Object paramObject1, Object paramObject2) {
    setContinue(paramObject1, (Name)null, (Context)paramObject2);
  }
  ...
  public String toString(boolean paramBoolean) {
    if (!paramBoolean || this.resolvedObj == null)
      return toString(); 
    return toString() + "; resolvedObj: " + this.resolvedObj + "; relativeResolvedName: " + this.relativeResolvedName + "; resolvedContext: " + this.resolvedContext;
  }
}
