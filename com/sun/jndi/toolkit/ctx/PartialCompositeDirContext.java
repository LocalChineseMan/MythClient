...
public abstract class PartialCompositeDirContext extends AtomicContext implements DirContext {
  ...
  public Attributes getAttributes(String paramString) throws NamingException {
    return getAttributes(paramString, (String[])null);
  }
  
  public Attributes getAttributes(Name paramName) throws NamingException {
    return getAttributes(paramName, (String[])null);
  }
  ...
  public Attributes getAttributes(Name paramName, String[] paramArrayOfString) throws NamingException {
    ...
    Name name = paramName;
    try {
      attributes = partialCompositeDirContext.p_getAttributes(name, paramArrayOfString, continuation);
  ...
  public DirContext createSubcontext(Name paramName, Attributes paramAttributes) throws NamingException {
    ...
    Name name = paramName;
    try {
      dirContext = partialCompositeDirContext.p_createSubcontext(name, paramAttributes, continuation);
      while (continuation.isContinue()) {
        name = continuation.getRemainingName();
        partialCompositeDirContext = getPCDirContext(continuation);
        dirContext = partialCompositeDirContext.p_createSubcontext(name, paramAttributes, continuation);
  ...
  public NamingEnumeration<SearchResult> search(Name paramName, Attributes paramAttributes, String[] paramArrayOfString) throws NamingException {
    ...
    Name name = paramName;
    try {
      namingEnumeration = partialCompositeDirContext.p_search(name, paramAttributes, paramArrayOfString, continuation);
      while (continuation.isContinue()) {
        name = continuation.getRemainingName();
        partialCompositeDirContext = getPCDirContext(continuation);
        namingEnumeration = partialCompositeDirContext.p_search(name, paramAttributes, paramArrayOfString, continuation);
  ...
  public NamingEnumeration<SearchResult> search(Name paramName, String paramString, SearchControls paramSearchControls) throws NamingException {
    ...
    Name name = paramName;
    try {
      namingEnumeration = partialCompositeDirContext.p_search(name, paramString, paramSearchControls, continuation);
      while (continuation.isContinue()) {
        name = continuation.getRemainingName();
        partialCompositeDirContext = getPCDirContext(continuation);
        namingEnumeration = partialCompositeDirContext.p_search(name, paramString, paramSearchControls, continuation);
  ...
  public NamingEnumeration<SearchResult> search(Name paramName, String paramString, Object[] paramArrayOfObject, SearchControls paramSearchControls) throws NamingException {
    ...
    Name name = paramName;
    try {
      namingEnumeration = partialCompositeDirContext.p_search(name, paramString, paramArrayOfObject, paramSearchControls, continuation);
      while (continuation.isContinue()) {
        name = continuation.getRemainingName();
        partialCompositeDirContext = getPCDirContext(continuation);
        namingEnumeration = partialCompositeDirContext.p_search(name, paramString, paramArrayOfObject, paramSearchControls, continuation);
  ...
  public DirContext getSchema(Name paramName) throws NamingException {
    ...
    Name name = paramName;
    try {
      dirContext = partialCompositeDirContext.p_getSchema(name, continuation);
      while (continuation.isContinue()) {
        name = continuation.getRemainingName();
        partialCompositeDirContext = getPCDirContext(continuation);
        dirContext = partialCompositeDirContext.p_getSchema(name, continuation);
  ...
  public DirContext getSchemaClassDefinition(Name paramName) throws NamingException {
    ...
    Name name = paramName;
    try {
      dirContext = partialCompositeDirContext.p_getSchemaClassDefinition(name, continuation);
      while (continuation.isContinue()) {
        name = continuation.getRemainingName();
        partialCompositeDirContext = getPCDirContext(continuation);
        dirContext = partialCompositeDirContext.p_getSchemaClassDefinition(name, continuation);
