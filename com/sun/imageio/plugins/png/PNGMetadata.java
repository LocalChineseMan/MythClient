...
public class PNGMetadata extends IIOMetadata implements Cloneable {
  ...
  public ArrayList<byte[]> unknownChunkData = (ArrayList)new ArrayList<>();
    ...
    if (colorModel instanceof IndexColorModel) {
      ...
      if (!this.IHDR_present || this.IHDR_colorType != 3) {
        ...
        for (byte b1 = 0; b1 < j; b1++) {
          ...
          if (b2 != (byte)(b1 * k) || b2 != arrayOfByte2[b1] || b2 != arrayOfByte3[b1]) {
            bool = false;
            break;
          } 
        } 
  ...
  private ArrayList<byte[]> cloneBytesArrayList(ArrayList<byte[]> paramArrayList) {
    if (paramArrayList == null)
      return null; 
    ArrayList<byte[]> arrayList = new ArrayList(paramArrayList.size());
  ...
  public Object clone() {
    ...
    pNGMetadata
      .unknownChunkData = cloneBytesArrayList(this.unknownChunkData);
    return pNGMetadata;
  }
  ...
  private Node getNativeTree() {
    ...
    if (this.IHDR_present) {
      ...
      iIOMetadataNode.setAttribute("bitDepth", 
          Integer.toString(this.IHDR_bitDepth));
    ...
    if (this.PLTE_present) {
      ...
      for (byte b = 0; b < i; b++) {
        ...
        iIOMetadataNode3.setAttribute("red", 
            Integer.toString(this.PLTE_red[b] & 0xFF));
        iIOMetadataNode3.setAttribute("green", 
            Integer.toString(this.PLTE_green[b] & 0xFF));
        iIOMetadataNode3.setAttribute("blue", 
            Integer.toString(this.PLTE_blue[b] & 0xFF));
    ...
    if (this.cHRM_present) {
      ...
      iIOMetadataNode.setAttribute("whitePointX", 
          Integer.toString(this.cHRM_whitePointX));
      iIOMetadataNode.setAttribute("whitePointY", 
          Integer.toString(this.cHRM_whitePointY));
    ...
    if (this.hIST_present) {
      ...
      for (byte b = 0; b < this.hIST_histogram.length; b++) {
        ...
        iIOMetadataNode3.setAttribute("index", Integer.toString(b));
        iIOMetadataNode3.setAttribute("value", 
            Integer.toString(this.hIST_histogram[b]));
        iIOMetadataNode.appendChild(iIOMetadataNode3);
      } 
      iIOMetadataNode2.appendChild(iIOMetadataNode);
    } 
    ...
    if (this.iTXt_keyword.size() > 0) {
      ...
      for (byte b = 0; b < this.iTXt_keyword.size(); b++) {
        ...
        iIOMetadataNode3.setAttribute("keyword", this.iTXt_keyword.get(b));
        iIOMetadataNode3.setAttribute("compressionFlag", 
            ((Boolean)this.iTXt_compressionFlag.get(b)).booleanValue() ? "TRUE" : "FALSE");
        iIOMetadataNode3.setAttribute("compressionMethod", ((Integer)this.iTXt_compressionMethod
            .get(b)).toString());
        iIOMetadataNode3.setAttribute("languageTag", this.iTXt_languageTag
            .get(b));
        iIOMetadataNode3.setAttribute("translatedKeyword", this.iTXt_translatedKeyword
            .get(b));
        iIOMetadataNode3.setAttribute("text", this.iTXt_text.get(b));
        iIOMetadataNode.appendChild(iIOMetadataNode3);
      } 
      iIOMetadataNode2.appendChild(iIOMetadataNode);
    } 
    if (this.pHYs_present) {
      ...
      iIOMetadataNode.setAttribute("pixelsPerUnitXAxis", 
          Integer.toString(this.pHYs_pixelsPerUnitXAxis));
      iIOMetadataNode.setAttribute("pixelsPerUnitYAxis", 
          Integer.toString(this.pHYs_pixelsPerUnitYAxis));
    ...
    if (this.sBIT_present) {
      ...
      if (this.sBIT_colorType == 0) {
        ...
        iIOMetadataNode1.setAttribute("gray", 
            Integer.toString(this.sBIT_grayBits));
      } else if (this.sBIT_colorType == 4) {
        iIOMetadataNode1 = new IIOMetadataNode("sBIT_GrayAlpha");
        iIOMetadataNode1.setAttribute("gray", 
            Integer.toString(this.sBIT_grayBits));
        iIOMetadataNode1.setAttribute("alpha", 
            Integer.toString(this.sBIT_alphaBits));
      } else if (this.sBIT_colorType == 2) {
        iIOMetadataNode1 = new IIOMetadataNode("sBIT_RGB");
        iIOMetadataNode1.setAttribute("red", 
            Integer.toString(this.sBIT_redBits));
        iIOMetadataNode1.setAttribute("green", 
            Integer.toString(this.sBIT_greenBits));
        iIOMetadataNode1.setAttribute("blue", 
            Integer.toString(this.sBIT_blueBits));
    ...
    if (this.sPLT_present) {
      ...
      iIOMetadataNode.setAttribute("sampleDepth", 
          Integer.toString(this.sPLT_sampleDepth));
      ...
      for (byte b = 0; b < i; b++) {
        ...
        iIOMetadataNode3.setAttribute("frequency", 
            Integer.toString(this.sPLT_frequency[b]));
        iIOMetadataNode.appendChild(iIOMetadataNode3);
      } 
      iIOMetadataNode2.appendChild(iIOMetadataNode);
    } 
    ...
    if (this.tEXt_keyword.size() > 0) {
      ...
      for (byte b = 0; b < this.tEXt_keyword.size(); b++) {
        ...
        iIOMetadataNode3.setAttribute("keyword", this.tEXt_keyword.get(b));
        iIOMetadataNode3.setAttribute("value", this.tEXt_text.get(b));
        iIOMetadataNode.appendChild(iIOMetadataNode3);
      } 
      iIOMetadataNode2.appendChild(iIOMetadataNode);
    } 
    ...
    if (this.tRNS_present) {
      ...
      if (this.tRNS_colorType == 3) {
        ...
        for (byte b = 0; b < this.tRNS_alpha.length; b++) {
          ...
          iIOMetadataNode3.setAttribute("index", Integer.toString(b));
          iIOMetadataNode3.setAttribute("alpha", 
              Integer.toString(this.tRNS_alpha[b] & 0xFF));
    ...
    if (this.zTXt_keyword.size() > 0) {
      ...
      for (byte b = 0; b < this.zTXt_keyword.size(); b++) {
        ...
        iIOMetadataNode3.setAttribute("keyword", this.zTXt_keyword.get(b));
        ...
        iIOMetadataNode3.setAttribute("text", this.zTXt_text.get(b));
        iIOMetadataNode.appendChild(iIOMetadataNode3);
      } 
      iIOMetadataNode2.appendChild(iIOMetadataNode);
    } 
    if (this.unknownChunkType.size() > 0) {
      ...
      for (byte b = 0; b < this.unknownChunkType.size(); b++) {
        ...
        iIOMetadataNode3.setAttribute("type", this.unknownChunkType
            .get(b));
        iIOMetadataNode3.setUserObject(this.unknownChunkData.get(b));
        iIOMetadataNode.appendChild(iIOMetadataNode3);
      } 
      iIOMetadataNode2.appendChild(iIOMetadataNode);
    } 
  ...
  public IIOMetadataNode getStandardChromaNode() {
    ...
    iIOMetadataNode1.appendChild(iIOMetadataNode2);
    if (this.PLTE_present) {
      boolean bool = (this.tRNS_present && this.tRNS_colorType == 3) ? true : false;
      ...
      for (byte b = 0; b < this.PLTE_red.length; b++) {
        ...
        iIOMetadataNode.setAttribute("red", 
            Integer.toString(this.PLTE_red[b] & 0xFF));
        iIOMetadataNode.setAttribute("green", 
            Integer.toString(this.PLTE_green[b] & 0xFF));
        iIOMetadataNode.setAttribute("blue", 
            Integer.toString(this.PLTE_blue[b] & 0xFF));
        if (bool) {
          boolean bool1 = (b < this.tRNS_alpha.length) ? (this.tRNS_alpha[b] & 0xFF) : true;
          iIOMetadataNode.setAttribute("alpha", Integer.toString(bool1));
        } 
        iIOMetadataNode2.appendChild(iIOMetadataNode);
      } 
      iIOMetadataNode1.appendChild(iIOMetadataNode2);
  ...
  public IIOMetadataNode getStandardDimensionNode() {
    ...
    if (this.pHYs_present && this.pHYs_unitSpecifier == 1) {
      ...
      iIOMetadataNode2.setAttribute("value", 
          Float.toString(1000.0F / this.pHYs_pixelsPerUnitXAxis));
      iIOMetadataNode1.appendChild(iIOMetadataNode2);
      iIOMetadataNode2 = new IIOMetadataNode("VerticalPixelSize");
      iIOMetadataNode2.setAttribute("value", 
          Float.toString(1000.0F / this.pHYs_pixelsPerUnitYAxis));
      iIOMetadataNode1.appendChild(iIOMetadataNode2);
    } 
    return iIOMetadataNode1;
  }
  ...
  public IIOMetadataNode getStandardTextNode() {
    ...
    for (b = 0; b < this.tEXt_keyword.size(); b++) {
      ...
      iIOMetadataNode2.setAttribute("keyword", this.tEXt_keyword.get(b));
      iIOMetadataNode2.setAttribute("value", this.tEXt_text.get(b));
    ...
    for (b = 0; b < this.iTXt_keyword.size(); b++) {
      iIOMetadataNode2 = new IIOMetadataNode("TextEntry");
      iIOMetadataNode2.setAttribute("keyword", this.iTXt_keyword.get(b));
      iIOMetadataNode2.setAttribute("value", this.iTXt_text.get(b));
      iIOMetadataNode2.setAttribute("language", this.iTXt_languageTag
          .get(b));
    ...
    for (b = 0; b < this.zTXt_keyword.size(); b++) {
      iIOMetadataNode2 = new IIOMetadataNode("TextEntry");
      iIOMetadataNode2.setAttribute("keyword", this.zTXt_keyword.get(b));
      iIOMetadataNode2.setAttribute("value", this.zTXt_text.get(b));
      iIOMetadataNode2.setAttribute("compression", "zip");
      iIOMetadataNode1.appendChild(iIOMetadataNode2);
    } 
    return iIOMetadataNode1;
  ...
  public IIOMetadataNode getStandardTransparencyNode() {
    ...
    boolean bool = (this.IHDR_colorType == 6 || this.IHDR_colorType == 4 || (this.IHDR_colorType == 3 && this.tRNS_present && this.tRNS_colorType == this.IHDR_colorType && this.tRNS_alpha != null)) ? true : false;
    ...
    if (this.tRNS_present) {
      ...
      if (this.tRNS_colorType == 2) {
        iIOMetadataNode2.setAttribute("value", 
            Integer.toString(this.tRNS_red) + " " + 
            Integer.toString(this.tRNS_green) + " " + 
            Integer.toString(this.tRNS_blue));
      } else if (this.tRNS_colorType == 0) {
  ...
  private void mergeNativeTree(Node paramNode) throws IIOInvalidTreeException {
    ...
    while (node != null) {
      ...
      if (str.equals("IHDR")) {
        ...
        this
          .IHDR_bitDepth = Integer.valueOf(IHDR_bitDepths[
              getEnumeratedAttribute(node, "bitDepth", IHDR_bitDepths)]).intValue();
        ...
        while (node1 != null) {
          ...
          if (k > i)
            i = k; 
          arrayOfByte1[k] = 
            (byte)getIntAttribute(node1, "red");
          arrayOfByte2[k] = 
            (byte)getIntAttribute(node1, "green");
          arrayOfByte3[k] = 
            (byte)getIntAttribute(node1, "blue");
        ...
        while (node1 != null) {
          ...
          if (k > i)
            i = k; 
          arrayOfChar[k] = 
            (char)getIntAttribute(node1, "value");
          node1 = node1.getNextSibling();
        } 
        int j = i + 1;
        ...
        this
          .iCCP_compressedProfile = (byte[])((byte[])object).clone();
        ...
        while (node1 != null) {
          ...
          arrayOfInt5[k] = 
            getIntAttribute(node1, "frequency");
          node1 = node1.getNextSibling();
        } 
        int j = i + 1;
        ...
        if (str1.equals("tRNS_Palette")) {
          ...
          while (node2 != null) {
            ...
            if (k > i)
              i = k; 
            arrayOfByte[k] = 
              (byte)getIntAttribute(node2, "alpha");
    ...
    while (node != null) {
      ...
      if (str.equals("Chroma")) {
        ...
        while (node1 != null) {
          ...
          if (str1.equals("Gamma")) {
            ...
            while (node2 != null) {
              ...
              if (k >= 0 && k <= 255) {
                arrayOfByte1[k] = 
                  (byte)getIntAttribute(node2, "red");
                arrayOfByte2[k] = 
                  (byte)getIntAttribute(node2, "green");
                arrayOfByte3[k] = 
                  (byte)getIntAttribute(node2, "blue");
                if (k > i)
                  i = k; 
              } 
              node2 = node2.getNextSibling();
        ...
        if (bool1 && bool2) {
          ...
          for (; b < 100; b++) {
            int i = (int)(f3 * b);
            if (Math.abs((i / b) - f3) < 0.001D)
              break; 
          } 
          this.pHYs_pixelsPerUnitXAxis = (int)(f3 * b);
          this.pHYs_pixelsPerUnitYAxis = b;
        } 
        ...
        while (node1 != null) {
          ...
          if (str1.equals("ImageModificationTime")) {
            ...
            this
              .tIME_hour = getIntAttribute(node1, "hour", 0, false);
            this
              .tIME_minute = getIntAttribute(node1, "minute", 0, false);
            this
              .tIME_second = getIntAttribute(node1, "second", 0, false);
          } 
          node1 = node1.getNextSibling();
        } 
      } else if (str.equals("Text")) {
  ...
  public void reset() {
    ...
    this.unknownChunkData = (ArrayList)new ArrayList<>();
  }
}
