...
public class JPEG {
  ...
  static boolean isNonStandardICC(ColorSpace paramColorSpace) {
    boolean bool = false;
    if (paramColorSpace instanceof java.awt.color.ICC_ColorSpace && 
      !paramColorSpace.isCS_sRGB() && 
      !paramColorSpace.equals(ColorSpace.getInstance(1001)) && 
      !paramColorSpace.equals(ColorSpace.getInstance(1003)) && 
      !paramColorSpace.equals(ColorSpace.getInstance(1004)) && 
      !paramColorSpace.equals(ColorSpace.getInstance(1002)))
      bool = true; 
    return bool;
  }
