...
public class GcInfo implements CompositeData, CompositeDataView {
  ...
  private GcInfo(GcInfoBuilder paramGcInfoBuilder, long paramLong1, long paramLong2, long paramLong3, MemoryUsage[] paramArrayOfMemoryUsage1, MemoryUsage[] paramArrayOfMemoryUsage2, Object[] paramArrayOfObject) {
    ...
    this.cdata = (CompositeData)new GcInfoCompositeData(this, paramGcInfoBuilder, paramArrayOfObject);
  }
  ...
  public boolean containsKey(String paramString) {
    return this.cdata.containsKey(paramString);
  }
  
  public boolean containsValue(Object paramObject) {
    return this.cdata.containsValue(paramObject);
  }
  
  public boolean equals(Object paramObject) {
    return this.cdata.equals(paramObject);
  }
  
  public Object get(String paramString) {
    return this.cdata.get(paramString);
  }
  
  public Object[] getAll(String[] paramArrayOfString) {
    return this.cdata.getAll(paramArrayOfString);
  }
