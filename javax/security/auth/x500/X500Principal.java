...
public final class X500Principal implements Principal, Serializable {
  ...
  X500Principal(X500Name paramX500Name) {
    this.thisX500Name = paramX500Name;
  }
  ...
  public X500Principal(String paramString, Map<String, String> paramMap) {
    if (paramString == null)
      throw new NullPointerException(
          ...
          ResourcesMgr.getString("provided.null.name")); 
    if (paramMap == null)
      throw new NullPointerException(
          
          ResourcesMgr.getString("provided.null.keyword.map")); 
    try {
  ...
  public String getName(String paramString, Map<String, String> paramMap) {
    if (paramMap == null)
      throw new NullPointerException(
          ...
          ResourcesMgr.getString("provided.null.OID.map")); 
    if (paramString != null) {
      if (paramString.equalsIgnoreCase("RFC1779"))
  ...
  private void writeObject(ObjectOutputStream paramObjectOutputStream) throws IOException {
    paramObjectOutputStream.writeObject(this.thisX500Name.getEncodedInternal());
  }
  ...
  private void readObject(ObjectInputStream paramObjectInputStream) throws IOException, NotActiveException, ClassNotFoundException {
    this.thisX500Name = new X500Name((byte[])paramObjectInputStream.readObject());
  }
}
