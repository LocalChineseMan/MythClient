...
public class MBeanFeatureInfo implements Serializable, DescriptorRead {
  ...
  public boolean equals(Object paramObject) {
    ...
    return (Objects.equals(mBeanFeatureInfo.getName(), getName()) && 
      Objects.equals(mBeanFeatureInfo.getDescription(), getDescription()) && 
      Objects.equals(mBeanFeatureInfo.getDescriptor(), getDescriptor()));
  }
  ...
  private void writeObject(ObjectOutputStream paramObjectOutputStream) throws IOException {
    ...
    if (this.descriptor != null && this.descriptor
