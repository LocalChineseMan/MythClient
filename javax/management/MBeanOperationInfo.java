...
public class MBeanOperationInfo extends MBeanFeatureInfo implements Cloneable {
  ...
  public MBeanOperationInfo(String paramString, Method paramMethod) {
    this(paramMethod.getName(), paramString, 
        
        methodSignature(paramMethod), paramMethod
        .getReturnType().getName(), 3, 
        
        Introspector.descriptorForElement(paramMethod));
  }
    ...
    switch (getImpact()) {
      case 1:
        ...
        return getClass().getName() + "[" + "description=" + 
          ...
          Arrays.<MBeanParameterInfo>asList(fastGetSignature()) + ", " + "impact=" + str + ", " + "descriptor=" + 
          
          getDescriptor() + "]";
      case 2:
        str = "action/info";
        return getClass().getName() + "[" + "description=" + getDescription() + ", " + "name=" + getName() + ", " + "returnType=" + getReturnType() + ", " + "signature=" + Arrays.<MBeanParameterInfo>asList(fastGetSignature()) + ", " + "impact=" + str + ", " + "descriptor=" + getDescriptor() + "]";
      case 0:
        str = "info";
        return getClass().getName() + "[" + "description=" + getDescription() + ", " + "name=" + getName() + ", " + "returnType=" + getReturnType() + ", " + "signature=" + Arrays.<MBeanParameterInfo>asList(fastGetSignature()) + ", " + "impact=" + str + ", " + "descriptor=" + getDescriptor() + "]";
      case 3:
  ...
  public boolean equals(Object paramObject) {
    ...
    return (Objects.equals(mBeanOperationInfo.getName(), getName()) && 
      Objects.equals(mBeanOperationInfo.getReturnType(), getReturnType()) && 
      Objects.equals(mBeanOperationInfo.getDescription(), getDescription()) && mBeanOperationInfo
      .getImpact() == getImpact() && 
      Arrays.equals((Object[])mBeanOperationInfo.fastGetSignature(), (Object[])fastGetSignature()) && 
      Objects.equals(mBeanOperationInfo.getDescriptor(), getDescriptor()));
  }
  ...
  static MBeanParameterInfo[] parameters(Class<?>[] paramArrayOfClass, Annotation[][] paramArrayOfAnnotation) {
    ...
    for (byte b = 0; b < paramArrayOfClass.length; b++) {
      ...
      String str = "p" + (b + 1);
      arrayOfMBeanParameterInfo[b] = new MBeanParameterInfo(str, paramArrayOfClass[b]
          .getName(), "", descriptor);
    } 
