...
public class TabularType extends OpenType<TabularData> {
  ...
  public TabularType(String paramString1, String paramString2, CompositeType paramCompositeType, String[] paramArrayOfString) throws OpenDataException {
    ...
    checkForNullElement((Object[])paramArrayOfString, "indexNames");
    ...
    ArrayList<String> arrayList = new ArrayList(paramArrayOfString.length + 1);
  ...
  boolean isAssignableFrom(OpenType<?> paramOpenType) {
    ...
    if (!getTypeName().equals(tabularType.getTypeName()) || 
  ...
  public boolean equals(Object paramObject) {
    ...
    if (!this.rowType.equals(tabularType.rowType))
      return false; 
    if (!this.indexNames.equals(tabularType.indexNames))
      return false; 
    return true;
  }
