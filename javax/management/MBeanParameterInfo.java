...
public class MBeanParameterInfo extends MBeanFeatureInfo implements Cloneable {
  ...
  public boolean equals(Object paramObject) {
    ...
    return (Objects.equals(mBeanParameterInfo.getName(), getName()) && 
      Objects.equals(mBeanParameterInfo.getType(), getType()) && 
      Objects.equals(mBeanParameterInfo.getDescription(), getDescription()) && 
      Objects.equals(mBeanParameterInfo.getDescriptor(), getDescriptor()));
  }
