...
public class MBeanServerFactory {
  ...
  private static synchronized void removeMBeanServer(MBeanServer paramMBeanServer) {
    ...
    if (!bool) {
      JmxProperties.MBEANSERVER_LOGGER.logp(Level.FINER, MBeanServerFactory.class
          .getName(), "removeMBeanServer(MBeanServer)", "MBeanServer was not in list!");
  ...
  private static synchronized void checkMBeanServerBuilder() {
    try {
      ...
      if (JmxProperties.MBEANSERVER_LOGGER.isLoggable(Level.FINEST)) {
        ...
        JmxProperties.MBEANSERVER_LOGGER.logp(Level.FINEST, MBeanServerFactory.class
            .getName(), "checkMBeanServerBuilder", stringBuilder
