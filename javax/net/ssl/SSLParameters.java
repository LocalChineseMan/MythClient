...
public class SSLParameters {
  ...
  public void setEndpointIdentificationAlgorithm(String paramString) {
    this.identificationAlgorithm = paramString;
  }
      ...
      if (!paramList.isEmpty()) {
        ...
        for (SNIServerName sNIServerName : paramList) {
          if (this.sniNames.put(Integer.valueOf(sNIServerName.getType()), sNIServerName) != null)
            throw new IllegalArgumentException("Duplicated server name of type " + sNIServerName
  ...
  public final List<SNIServerName> getServerNames() {
    if (this.sniNames != null) {
      if (!this.sniNames.isEmpty())
        return Collections.unmodifiableList(new ArrayList<>(this.sniNames
              .values())); 
      ...
      if (!paramCollection.isEmpty()) {
        ...
        for (SNIMatcher sNIMatcher : paramCollection) {
          if (this.sniMatchers.put(Integer.valueOf(sNIMatcher.getType()), sNIMatcher) != null)
            throw new IllegalArgumentException("Duplicated server name of type " + sNIMatcher
  ...
  public final Collection<SNIMatcher> getSNIMatchers() {
    if (this.sniMatchers != null) {
      if (!this.sniMatchers.isEmpty())
        return Collections.unmodifiableList(new ArrayList<>(this.sniMatchers
              .values())); 
      return Collections.emptyList();
    } 
    return null;
