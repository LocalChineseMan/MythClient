...
public abstract class ImageWriter implements ImageTranscoder {
  ...
  protected ImageWriter(ImageWriterSpi paramImageWriterSpi) {
    this.originatingProvider = paramImageWriterSpi;
  }
  ...
  public Locale[] getAvailableLocales() {
    return (this.availableLocales == null) ? null : (Locale[])this.availableLocales
      .clone();
  }
  ...
  public void removeIIOWriteProgressListener(IIOWriteProgressListener paramIIOWriteProgressListener) {
    if (paramIIOWriteProgressListener == null || this.progressListeners == null)
      return; 
    this
      .progressListeners = ImageReader.removeFromList(this.progressListeners, paramIIOWriteProgressListener);
  }
  ...
  protected void processImageStarted(int paramInt) {
    ...
    for (byte b = 0; b < i; b++) {
      IIOWriteProgressListener iIOWriteProgressListener = this.progressListeners.get(b);
  ...
  protected void processWarningOccurred(int paramInt, String paramString) {
    ...
    for (byte b = 0; b < i; b++) {
      IIOWriteWarningListener iIOWriteWarningListener = this.warningListeners.get(b);
