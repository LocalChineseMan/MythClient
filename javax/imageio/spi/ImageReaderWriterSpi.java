...
public abstract class ImageReaderWriterSpi extends IIOServiceProvider {
  ...
  public String[] getExtraStreamMetadataFormatNames() {
    return (this.extraStreamMetadataFormatNames == null) ? null : (String[])this.extraStreamMetadataFormatNames
      .clone();
  }
  ...
  public String[] getExtraImageMetadataFormatNames() {
    return (this.extraImageMetadataFormatNames == null) ? null : (String[])this.extraImageMetadataFormatNames
      .clone();
  }
  
  public IIOMetadataFormat getStreamMetadataFormat(String paramString) {
    return getMetadataFormat(paramString, this.supportsStandardStreamMetadataFormat, this.nativeStreamMetadataFormatName, this.nativeStreamMetadataFormatClassName, this.extraStreamMetadataFormatNames, this.extraStreamMetadataFormatClassNames);
  }
  
  public IIOMetadataFormat getImageMetadataFormat(String paramString) {
    return getMetadataFormat(paramString, this.supportsStandardImageMetadataFormat, this.nativeImageMetadataFormatName, this.nativeImageMetadataFormatClassName, this.extraImageMetadataFormatNames, this.extraImageMetadataFormatClassNames);
  }
