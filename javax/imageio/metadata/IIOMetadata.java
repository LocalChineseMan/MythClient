...
public abstract class IIOMetadata {
  ...
  public IIOMetadataFormat getMetadataFormat(String paramString) {
    ...
    if (this.standardFormatSupported && paramString
    ...
    try {
      ...
      ClassLoader classLoader = AccessController.<ClassLoader>doPrivileged((PrivilegedAction<ClassLoader>)new Object(this, iIOMetadata));
      try {
        clazz = Class.forName(str, true, classLoader);
      } catch (ClassNotFoundException classNotFoundException) {
        classLoader = AccessController.<ClassLoader>doPrivileged((PrivilegedAction<ClassLoader>)new Object(this));
        try {
          clazz = Class.forName(str, true, classLoader);
        } catch (ClassNotFoundException classNotFoundException1) {
          clazz = Class.forName(str, true, 
