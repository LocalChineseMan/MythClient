...
class NameImpl {
  ...
  private final boolean isMeta(String paramString, int paramInt) {
    return (isA(paramString, paramInt, this.syntaxEscape) || 
      isA(paramString, paramInt, this.syntaxBeginQuote1) || 
      isA(paramString, paramInt, this.syntaxBeginQuote2) || 
      isSeparator(paramString, paramInt));
  }
  
  private final boolean isSeparator(String paramString, int paramInt) {
    return (isA(paramString, paramInt, this.syntaxSeparator) || 
      isA(paramString, paramInt, this.syntaxSeparator2));
  }
  ...
  private final int extractComp(String paramString, int paramInt1, int paramInt2, Vector<String> paramVector) throws InvalidNameException {
    ...
    while (paramInt1 < paramInt2) {
      if (bool && ((bool1 = isA(paramString, paramInt1, this.syntaxBeginQuote1)) || 
        isA(paramString, paramInt1, this.syntaxBeginQuote2))) {
        ...
        for (; paramInt1 < paramInt2 && !paramString.startsWith(str2, paramInt1); 
          paramInt1++) {
          if (isA(paramString, paramInt1, this.syntaxEscape) && 
            isA(paramString, paramInt1 + this.syntaxEscape.length(), str2))
      ...
      } else if (isA(paramString, paramInt1, this.syntaxTypevalSeparator) && ((
        bool1 = isA(paramString, paramInt1 + this.syntaxTypevalSeparator.length(), this.syntaxBeginQuote1)) || 
        isA(paramString, paramInt1 + this.syntaxTypevalSeparator.length(), this.syntaxBeginQuote2))) {
        String str1 = bool1 ? this.syntaxBeginQuote1 : this.syntaxBeginQuote2;
        String str2 = bool1 ? this.syntaxEndQuote1 : this.syntaxEndQuote2;
  ...
  NameImpl(Properties paramProperties, String paramString) throws InvalidNameException {
    ...
    boolean bool1 = (this.syntaxDirection == 2) ? true : false;
    boolean bool2 = true;
    int i = paramString.length();
    for (int j = 0; j < i; ) {
      j = extractComp(paramString, j, i, this.components);
      String str = bool1 ? this.components.firstElement() : this.components.lastElement();
      if (str.length() >= 1)
        bool2 = false; 
      if (j < i) {
  ...
  private final String stringifyComp(String paramString) {
    ...
    if (this.syntaxSeparator != null && paramString
      .indexOf(this.syntaxSeparator) >= 0)
    ...
    if (this.syntaxSeparator2 != null && paramString
      .indexOf(this.syntaxSeparator2) >= 0)
      if (this.syntaxBeginQuote1 != null) {
        if (str1 == null) {
          str1 = this.syntaxBeginQuote1;
          str2 = this.syntaxEndQuote1;
    ...
    if (str1 != null) {
      ...
      for (int j = 0; j < i; ) {
        ...
        } else if (bool2 && paramString
          .startsWith(this.syntaxSeparator2, j)) {
  ...
  public String toString() {
    ...
    for (byte b = 0; b < i; b++) {
      String str;
      if (this.syntaxDirection == 2) {
        str = stringifyComp(this.components.elementAt(i - 1 - b));
      } else {
        str = stringifyComp(this.components.elementAt(b));
      } 
      if (b != 0 && this.syntaxSeparator != null)
  ...
  public boolean equals(Object paramObject) {
    if (paramObject != null && paramObject instanceof NameImpl) {
      ...
      if (nameImpl.size() == size()) {
        Enumeration<String> enumeration1 = getAll();
        Enumeration<String> enumeration2 = nameImpl.getAll();
        while (enumeration1.hasMoreElements()) {
          String str1 = enumeration1.nextElement();
          String str2 = enumeration2.nextElement();
  ...
  public String get(int paramInt) {
    return this.components.elementAt(paramInt);
  }
  ...
  public boolean startsWith(int paramInt, Enumeration<String> paramEnumeration) {
    if (paramInt < 0 || paramInt > size())
      return false; 
    try {
      Enumeration<String> enumeration = getPrefix(paramInt);
      while (enumeration.hasMoreElements()) {
        String str1 = enumeration.nextElement();
        String str2 = paramEnumeration.nextElement();
        if (this.syntaxTrimBlanks) {
          str1 = str1.trim();
          str2 = str2.trim();
        } 
  ...
  public boolean endsWith(int paramInt, Enumeration<String> paramEnumeration) {
    ...
    if (i < 0 || i > size())
      return false; 
    try {
      Enumeration<String> enumeration = getSuffix(i);
      while (enumeration.hasMoreElements()) {
        String str1 = enumeration.nextElement();
        String str2 = paramEnumeration.nextElement();
        if (this.syntaxTrimBlanks) {
  ...
  public boolean addAll(Enumeration<String> paramEnumeration) throws InvalidNameException {
    ...
    while (paramEnumeration.hasMoreElements()) {
      try {
        String str = paramEnumeration.nextElement();
  ...
  public int hashCode() {
    int i = 0;
    for (Enumeration<String> enumeration = getAll(); enumeration.hasMoreElements(); ) {
