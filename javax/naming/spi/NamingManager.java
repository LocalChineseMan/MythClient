...
public class NamingManager {
  ...
  static ObjectFactory getObjectFactoryFromReference(Reference paramReference, String paramString) throws IllegalAccessException, InstantiationException, MalformedURLException {
    ...
    String str;
    if (clazz == null && (
      str = paramReference.getFactoryClassLocation()) != null)
      try {
  ...
  private static Object createObjectFromFactories(Object paramObject, Name paramName, Context paramContext, Hashtable<?, ?> paramHashtable) throws Exception {
    ...
    if (factoryEnumeration == null)
      return null; 
    Object object = null;
    while (object == null && factoryEnumeration.hasMore()) {
      ObjectFactory objectFactory = (ObjectFactory)factoryEnumeration.next();
      object = objectFactory.getObjectInstance(paramObject, paramName, paramContext, paramHashtable);
    } 
    return object;
  }
    ...
    if (reference != null) {
      ...
      if (str != null) {
        ...
        if (objectFactory != null)
          return objectFactory.getObjectInstance(reference, paramName, paramContext, paramHashtable); 
        return paramObject;
      } 
  ...
  static Object processURLAddrs(Reference paramReference, Name paramName, Context paramContext, Hashtable<?, ?> paramHashtable) throws NamingException {
    for (byte b = 0; b < paramReference.size(); b++) {
      ...
      if (refAddr instanceof javax.naming.StringRefAddr && refAddr
        .getType().equalsIgnoreCase("URL")) {
  ...
  public static Object getStateToBind(Object paramObject, Name paramName, Context paramContext, Hashtable<?, ?> paramHashtable) throws NamingException {
    ...
    while (object == null && factoryEnumeration.hasMore()) {
      ...
      object = stateFactory.getStateToBind(paramObject, paramName, paramContext, paramHashtable);
    } 
    return (object != null) ? object : paramObject;
  }
}
