...
public class BasicAttribute implements Attribute {
  ...
  public Object clone() {
    ...
    basicAttribute.values = (Vector<Object>)this.values.clone();
  ...
  public boolean equals(Object paramObject) {
    if (paramObject != null && paramObject instanceof Attribute) {
      ...
      if (isOrdered() != attribute.isOrdered())
        return false; 
      int i;
      if (this.attrID.equals(attribute.getID()) && (
        i = size()) == attribute.size()) {
        try {
          if (isOrdered()) {
            for (byte b = 0; b < i; b++) {
  ...
  public String toString() {
    ...
    if (this.values.size() == 0) {
      ...
      boolean bool = true;
      for (Enumeration enumeration = this.values.elements(); enumeration.hasMoreElements(); ) {
        if (!bool)
          stringBuffer.append(", "); 
      ...
      if ((clazz = paramObject.getClass()).isArray()) {
        ...
        for (byte b = 0; b < i; b++) {
          ...
          if (object != null && clazz == object.getClass() && 
            arrayEquals(paramObject, object))
            return b; 
        } 
      } else {
  ...
  private static boolean valueEquals(Object paramObject1, Object paramObject2) {
    ...
    if (paramObject1 == null)
      return false; 
    if (paramObject1.getClass().isArray() && paramObject2
      .getClass().isArray())
