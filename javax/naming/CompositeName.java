...
public class CompositeName implements Name {
  ...
  public boolean equals(Object paramObject) {
    return (paramObject != null && paramObject instanceof CompositeName && this.impl
      
      .equals(((CompositeName)paramObject).impl));
  }
  ...
  public Name getPrefix(int paramInt) {
    Enumeration<String> enumeration = this.impl.getPrefix(paramInt);
    return new CompositeName(enumeration);
  }
  
  public Name getSuffix(int paramInt) {
    Enumeration<String> enumeration = this.impl.getSuffix(paramInt);
    return new CompositeName(enumeration);
  }
  ...
  public Name addAll(Name paramName) throws InvalidNameException {
    ...
    throw new InvalidNameException("Not a composite name: " + paramName
        .toString());
  }
  ...
  private void writeObject(ObjectOutputStream paramObjectOutputStream) throws IOException {
    ...
    Enumeration<String> enumeration = getAll();
