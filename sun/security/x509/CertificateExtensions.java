...
public class CertificateExtensions implements CertAttrSet<Extension> {
  ...
  public void encode(OutputStream paramOutputStream, boolean paramBoolean) throws CertificateException, IOException {
    DerOutputStream derOutputStream3, derOutputStream1 = new DerOutputStream();
  ...
  public Extension get(String paramString) throws IOException {
    Extension extension = this.map.get(paramString);
    if (extension == null)
  ...
  public boolean equals(Object paramObject) {
    ...
    if (!(paramObject instanceof CertificateExtensions))
      return false; 
    Collection<Extension> collection = ((CertificateExtensions)paramObject).getAllExtensions();
    Object[] arrayOfObject = collection.toArray();
    ...
    return getUnparseableExtensions().equals(((CertificateExtensions)paramObject)
