...
public class X509CertInfo implements CertAttrSet<String> {
  ...
  public String toString() {
    ...
    if (this.extensions != null) {
      ...
      Extension[] arrayOfExtension = collection.<Extension>toArray(new Extension[0]);
  ...
  private Object getX500Name(String paramString, boolean paramBoolean) throws IOException {
    ...
    if (paramString.equalsIgnoreCase("x500principal"))
      return paramBoolean ? this.issuer.asX500Principal() : this.subject
        .asX500Principal(); 
  ...
  private void parse(DerValue paramDerValue) throws CertificateParsingException, IOException {
    ...
    if (this.version.compare(0) == 0 && this.subject
      .isEmpty())
  ...
  private void emit(DerOutputStream paramDerOutputStream) throws CertificateException, IOException {
    ...
    if (this.version.compare(0) == 0 && this.issuer
      .toString() == null)
  ...
  private int attributeMap(String paramString) {
    Integer integer = map.get(paramString);
    if (integer == null)
      return 0; 
