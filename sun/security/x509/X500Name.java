...
public class X500Name implements GeneralNameInterface, Principal {
  ...
  private void parseDN(String paramString, Map<String, String> paramMap) throws IOException {
    ...
    ArrayList<RDN> arrayList = new ArrayList();
    int i = 0;
    int j = 0;
    ...
    this.names = arrayList.<RDN>toArray(new RDN[arrayList.size()]);
  }
  ...
  static int countQuotes(String paramString, int paramInt1, int paramInt2) {
    ...
    for (int i = paramInt1; i < paramInt2; i++) {
      if ((paramString.charAt(i) == '"' && i == paramInt1) || (paramString
        .charAt(i) == '"' && paramString.charAt(i - 1) != '\\'))
        b++; 
    } 
    return b;
  }
  ...
  private static boolean escaped(int paramInt1, int paramInt2, String paramString) {
    if (paramInt1 == 1 && paramString.charAt(paramInt1 - 1) == '\\')
      return true; 
    if (paramInt1 > 1 && paramString.charAt(paramInt1 - 1) == '\\' && paramString
      .charAt(paramInt1 - 2) != '\\')
      return true; 
    if (paramInt1 > 1 && paramString.charAt(paramInt1 - 1) == '\\' && paramString
      .charAt(paramInt1 - 2) == '\\') {
  ...
  static ObjectIdentifier intern(ObjectIdentifier paramObjectIdentifier) {
    ObjectIdentifier objectIdentifier = internedOIDs.get(paramObjectIdentifier);
  ...
  private static final int[] ipAddress_data = new int[] { 
  ...
  static {
    ...
    PrivilegedExceptionAction<Object[]> privilegedExceptionAction = new PrivilegedExceptionAction<Object[]>() {
        public Object[] run() throws Exception {
          ...
          Constructor<X500Principal> constructor = clazz.getDeclaredConstructor(arrayOfClass);
    ...
    try {
      Object[] arrayOfObject = AccessController.<Object[]>doPrivileged(privilegedExceptionAction);
      Constructor<X500Principal> constructor = (Constructor)arrayOfObject[0];
  ...
  public X500Principal asX500Principal() {
    if (this.x500Principal == null)
      try {
        ...
        this.x500Principal = principalConstructor.newInstance(arrayOfObject);
      } catch (Exception exception) {
