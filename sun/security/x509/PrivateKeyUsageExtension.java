...
public class PrivateKeyUsageExtension extends Extension implements CertAttrSet<String> {
  ...
  public String toString() {
    return super.toString() + "PrivateKeyUsage: [\n" + ((this.notBefore == null) ? "" : ("From: " + this.notBefore
      ...
      .toString() + ", ")) + ((this.notAfter == null) ? "" : ("To: " + this.notAfter
      .toString())) + "]\n";
  }
  ...
  public void valid(Date paramDate) throws CertificateNotYetValidException, CertificateExpiredException {
    if (this.notBefore.after(paramDate))
      throw new CertificateNotYetValidException("NotBefore: " + this.notBefore
          .toString()); 
    if (this.notAfter.before(paramDate))
      throw new CertificateExpiredException("NotAfter: " + this.notAfter
          .toString()); 
  }
