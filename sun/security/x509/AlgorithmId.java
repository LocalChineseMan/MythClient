...
public class AlgorithmId implements Serializable, DerEncoder {
  ...
  public boolean equals(AlgorithmId paramAlgorithmId) {
    boolean bool = (this.params == null) ? ((paramAlgorithmId.params == null) ? true : false) : this.params.equals(paramAlgorithmId.params);
  ...
  private static ObjectIdentifier algOID(String paramString) throws IOException {
    ...
    if (paramString.equalsIgnoreCase("MD2"))
      return MD2_oid; 
    if (paramString.equalsIgnoreCase("SHA") || paramString.equalsIgnoreCase("SHA1") || paramString
      .equalsIgnoreCase("SHA-1"))
      return SHA_oid; 
    if (paramString.equalsIgnoreCase("SHA-256") || paramString
      .equalsIgnoreCase("SHA256"))
      return SHA256_oid; 
    if (paramString.equalsIgnoreCase("SHA-384") || paramString
      .equalsIgnoreCase("SHA384"))
      return SHA384_oid; 
    if (paramString.equalsIgnoreCase("SHA-512") || paramString
      .equalsIgnoreCase("SHA512"))
      return SHA512_oid; 
    if (paramString.equalsIgnoreCase("SHA-224") || paramString
      .equalsIgnoreCase("SHA224"))
      return SHA224_oid; 
    if (paramString.equalsIgnoreCase("RSA"))
      return RSAEncryption_oid; 
    if (paramString.equalsIgnoreCase("Diffie-Hellman") || paramString
      .equalsIgnoreCase("DH"))
      return DH_oid; 
    ...
    if (paramString.equalsIgnoreCase("AES"))
      return AES_oid; 
    if (paramString.equalsIgnoreCase("MD5withRSA") || paramString
      .equalsIgnoreCase("MD5/RSA"))
      return md5WithRSAEncryption_oid; 
    if (paramString.equalsIgnoreCase("MD2withRSA") || paramString
      .equalsIgnoreCase("MD2/RSA"))
      return md2WithRSAEncryption_oid; 
    if (paramString.equalsIgnoreCase("SHAwithDSA") || paramString
      .equalsIgnoreCase("SHA1withDSA") || paramString
      .equalsIgnoreCase("SHA/DSA") || paramString
      .equalsIgnoreCase("SHA1/DSA") || paramString
      .equalsIgnoreCase("DSAWithSHA1") || paramString
      .equalsIgnoreCase("DSS") || paramString
      .equalsIgnoreCase("SHA-1/DSA"))
    ...
    if (paramString.equalsIgnoreCase("SHA1WithRSA") || paramString
      .equalsIgnoreCase("SHA1/RSA"))
      return sha1WithRSAEncryption_oid; 
    if (paramString.equalsIgnoreCase("SHA1withECDSA") || paramString
    ...
    return oidTable.get(paramString.toUpperCase(Locale.ENGLISH));
  }
