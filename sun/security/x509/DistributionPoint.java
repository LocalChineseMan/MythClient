...
public class DistributionPoint {
  ...
  public DistributionPoint(DerValue paramDerValue) throws IOException {
    ...
    while (paramDerValue.data != null && paramDerValue.data.available() != 0) {
      ...
      if (derValue.isContextSpecific((byte)0) && derValue.isConstructed()) {
        ...
        if (derValue1.isContextSpecific((byte)0) && derValue1
          .isConstructed()) {
          derValue1.resetTag((byte)48);
          this.fullName = new GeneralNames(derValue1);
          continue;
        } 
        if (derValue1.isContextSpecific((byte)1) && derValue1
          .isConstructed()) {
      ...
      if (derValue.isContextSpecific((byte)2) && derValue
        .isConstructed()) {
  ...
  public void encode(DerOutputStream paramDerOutputStream) throws IOException {
    ...
    if (this.fullName != null || this.relativeName != null) {
      ...
      if (this.fullName != null) {
        ...
        derOutputStream1.writeImplicit(
            DerValue.createTag(-128, true, (byte)0), derOutputStream2);
      } else if (this.relativeName != null) {
        DerOutputStream derOutputStream2 = new DerOutputStream();
        this.relativeName.encode(derOutputStream2);
        derOutputStream1.writeImplicit(
            DerValue.createTag(-128, true, (byte)1), derOutputStream2);
      } 
      derOutputStream.write(
          DerValue.createTag(-128, true, (byte)0), derOutputStream1);
    } 
    if (this.reasonFlags != null) {
      DerOutputStream derOutputStream1 = new DerOutputStream();
      ...
      derOutputStream.writeImplicit(
          DerValue.createTag(-128, false, (byte)1), derOutputStream1);
    } 
    if (this.crlIssuer != null) {
      DerOutputStream derOutputStream1 = new DerOutputStream();
      this.crlIssuer.encode(derOutputStream1);
      derOutputStream.writeImplicit(
          DerValue.createTag(-128, true, (byte)2), derOutputStream1);
    } 
  ...
  public boolean equals(Object paramObject) {
    ...
    return (Objects.equals(this.fullName, distributionPoint.fullName) && 
      Objects.equals(this.relativeName, distributionPoint.relativeName) && 
      Objects.equals(this.crlIssuer, distributionPoint.crlIssuer) && 
      Arrays.equals(this.reasonFlags, distributionPoint.reasonFlags));
  }
