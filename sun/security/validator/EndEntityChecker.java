...
class EndEntityChecker {
  ...
  private boolean checkEKU(X509Certificate paramX509Certificate, Set<String> paramSet, String paramString) throws CertificateException {
    ...
    if (list == null)
      return true; 
    return (list.contains(paramString) || list.contains("2.5.29.37.0"));
  }
  ...
  private boolean checkKeyUsage(X509Certificate paramX509Certificate, int paramInt) throws CertificateException {
    ...
    if (arrayOfBoolean == null)
      return true; 
    return (arrayOfBoolean.length > paramInt && arrayOfBoolean[paramInt]);
  }
  
  private void checkTLSClient(X509Certificate paramX509Certificate) throws CertificateException {
    Set<String> set = getCriticalExtensions(paramX509Certificate);
    ...
    if (!checkEKU(paramX509Certificate, set, "1.3.6.1.5.5.7.3.2"))
  ...
  private void checkTLSServer(X509Certificate paramX509Certificate, String paramString) throws CertificateException {
    Set<String> set = getCriticalExtensions(paramX509Certificate);
    ...
    if (!checkEKU(paramX509Certificate, set, "1.3.6.1.5.5.7.3.1"))
      if (!checkEKU(paramX509Certificate, set, "1.3.6.1.4.1.311.10.3.3") && 
        !checkEKU(paramX509Certificate, set, "2.16.840.1.113730.4.1"))
  ...
  private void checkCodeSigning(X509Certificate paramX509Certificate) throws CertificateException {
    Set<String> set = getCriticalExtensions(paramX509Certificate);
    if (!checkKeyUsage(paramX509Certificate, 0))
      throw new ValidatorException("KeyUsage does not allow digital signatures", ValidatorException.T_EE_EXTENSIONS, paramX509Certificate); 
    if (!checkEKU(paramX509Certificate, set, "1.3.6.1.5.5.7.3.3"))
  ...
  private void checkTSAServer(X509Certificate paramX509Certificate) throws CertificateException {
    Set<String> set = getCriticalExtensions(paramX509Certificate);
    if (!checkKeyUsage(paramX509Certificate, 0))
      throw new ValidatorException("KeyUsage does not allow digital signatures", ValidatorException.T_EE_EXTENSIONS, paramX509Certificate); 
    ...
    if (!checkEKU(paramX509Certificate, set, "1.3.6.1.5.5.7.3.8"))
