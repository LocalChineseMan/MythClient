...
public final class RSAKeyFactory extends KeyFactorySpi {
  ...
  private static final boolean restrictExpLen = "true"
    .equalsIgnoreCase(AccessController.<String>doPrivileged(new GetPropertyAction("sun.security.rsa.restrictRSAExponent", "true")));
  ...
  static void checkRSAProviderKeyLengths(int paramInt, BigInteger paramBigInteger) throws InvalidKeyException {
    checkKeyLengths(paramInt + 7 & 0xFFFFFFF8, paramBigInteger, 512, 2147483647);
  }
  ...
  public static void checkKeyLengths(int paramInt1, BigInteger paramBigInteger, int paramInt2, int paramInt3) throws InvalidKeyException {
    ...
    if (restrictExpLen && paramBigInteger != null && paramInt1 > 3072 && paramBigInteger
  ...
  private PrivateKey translatePrivateKey(PrivateKey paramPrivateKey) throws InvalidKeyException {
    if (paramPrivateKey instanceof RSAPrivateCrtKey) {
      ...
      try {
        return new RSAPrivateCrtKeyImpl(rSAPrivateCrtKey
            .getModulus(), rSAPrivateCrtKey
            .getPublicExponent(), rSAPrivateCrtKey
            .getPrivateExponent(), rSAPrivateCrtKey
            .getPrimeP(), rSAPrivateCrtKey
            .getPrimeQ(), rSAPrivateCrtKey
            .getPrimeExponentP(), rSAPrivateCrtKey
            .getPrimeExponentQ(), rSAPrivateCrtKey
            .getCrtCoefficient());
      } catch (RuntimeException runtimeException) {
        throw new InvalidKeyException("Invalid key", runtimeException);
      } 
    ...
    if (paramPrivateKey instanceof RSAPrivateKey) {
      ...
      try {
        return new RSAPrivateKeyImpl(rSAPrivateKey
            .getModulus(), rSAPrivateKey
            .getPrivateExponent());
      } catch (RuntimeException runtimeException) {
        throw new InvalidKeyException("Invalid key", runtimeException);
      } 
  ...
  private PublicKey generatePublic(KeySpec paramKeySpec) throws GeneralSecurityException {
    ...
    if (paramKeySpec instanceof RSAPublicKeySpec) {
      ...
      return new RSAPublicKeyImpl(rSAPublicKeySpec
          .getModulus(), rSAPublicKeySpec
          .getPublicExponent());
    } 
  ...
  private PrivateKey generatePrivate(KeySpec paramKeySpec) throws GeneralSecurityException {
    ...
    if (paramKeySpec instanceof RSAPrivateCrtKeySpec) {
      ...
      return new RSAPrivateCrtKeyImpl(rSAPrivateCrtKeySpec
          .getModulus(), rSAPrivateCrtKeySpec
          .getPublicExponent(), rSAPrivateCrtKeySpec
          .getPrivateExponent(), rSAPrivateCrtKeySpec
          .getPrimeP(), rSAPrivateCrtKeySpec
          .getPrimeQ(), rSAPrivateCrtKeySpec
          .getPrimeExponentP(), rSAPrivateCrtKeySpec
          .getPrimeExponentQ(), rSAPrivateCrtKeySpec
          .getCrtCoefficient());
    } 
    if (paramKeySpec instanceof RSAPrivateKeySpec) {
      RSAPrivateKeySpec rSAPrivateKeySpec = (RSAPrivateKeySpec)paramKeySpec;
      return new RSAPrivateKeyImpl(rSAPrivateKeySpec
          .getModulus(), rSAPrivateKeySpec
          .getPrivateExponent());
    } 
  ...
  protected <T extends KeySpec> T engineGetKeySpec(Key paramKey, Class<T> paramClass) throws InvalidKeySpecException {
    ...
    if (paramKey instanceof RSAPublicKey) {
      ...
      if (rsaPublicKeySpecClass.isAssignableFrom(paramClass))
        return paramClass.cast(new RSAPublicKeySpec(rSAPublicKey
              .getModulus(), rSAPublicKey
              .getPublicExponent())); 
    ...
    if (paramKey instanceof RSAPrivateKey) {
      ...
      if (rsaPrivateCrtKeySpecClass.isAssignableFrom(paramClass)) {
        if (paramKey instanceof RSAPrivateCrtKey) {
          ...
          return paramClass.cast(new RSAPrivateCrtKeySpec(rSAPrivateCrtKey
                .getModulus(), rSAPrivateCrtKey
                .getPublicExponent(), rSAPrivateCrtKey
                .getPrivateExponent(), rSAPrivateCrtKey
                .getPrimeP(), rSAPrivateCrtKey
      ...
      if (rsaPrivateKeySpecClass.isAssignableFrom(paramClass)) {
        ...
        return paramClass.cast(new RSAPrivateKeySpec(rSAPrivateKey
              .getModulus(), rSAPrivateKey
              .getPrivateExponent()));
      } 
