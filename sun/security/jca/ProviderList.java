...
public final class ProviderList {
  ...
  static ProviderList fromSecurityProperties() {
    return AccessController.<ProviderList>doPrivileged(new PrivilegedAction<ProviderList>() {
  ...
  public static ProviderList insertAt(ProviderList paramProviderList, Provider paramProvider, int paramInt) {
    ...
    ArrayList<ProviderConfig> arrayList = new ArrayList(Arrays.asList((Object[])paramProviderList.configs));
    int i = arrayList.size();
    if (paramInt < 0 || paramInt > i)
      paramInt = i; 
    arrayList.add(paramInt, new ProviderConfig(paramProvider));
    return new ProviderList(arrayList.<ProviderConfig>toArray(PC0), true);
  }
  ...
  private final List<Provider> userList = new AbstractList<Provider>() {
      ...
      public Provider get(int param1Int) {
        return ProviderList.this.getProvider(param1Int);
      }
    };
  ...
  private ProviderList() {
    ...
    this.configs = arrayList.<ProviderConfig>toArray(PC0);
    if (debug != null)
  ...
  ProviderList getJarList(String[] paramArrayOfString) {
    ...
    ProviderConfig[] arrayOfProviderConfig = arrayList.<ProviderConfig>toArray(PC0);
  ...
  ProviderList removeInvalid() {
    ...
    for (byte b1 = 0, b2 = 0; b1 < this.configs.length; b1++) {
  ...
  public Provider[] toArray() {
    return providers().<Provider>toArray(P0);
  }
  
  public String toString() {
    return Arrays.<ProviderConfig>asList(this.configs).toString();
  }
    ...
    private Provider.Service tryGet(int param1Int) {
      while (true) {
        ...
        if (this.services != null && this.services.size() > param1Int)
          return this.services.get(param1Int); 
    ...
    public Iterator<Provider.Service> iterator() {
      return new Iterator<Provider.Service>() {
          ...
          public boolean hasNext() {
            return (ProviderList.ServiceList.this.tryGet(this.index) != null);
          }
