...
class BasicChecker extends PKIXCertPathChecker {
  ...
  private void verifyTimestamp(X509Certificate paramX509Certificate) throws CertPathValidatorException {
  ...
  private void updateState(X509Certificate paramX509Certificate) throws CertPathValidatorException {
    ...
    if (debug != null)
      debug.println("BasicChecker.updateState issuer: " + paramX509Certificate
          .getIssuerX500Principal().toString() + "; subject: " + paramX509Certificate
          .getSubjectX500Principal() + "; serial#: " + paramX509Certificate
