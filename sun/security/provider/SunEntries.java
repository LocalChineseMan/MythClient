...
final class SunEntries {
  ...
  static void putEntries(Map<Object, Object> paramMap) {
    ...
    boolean bool1 = (seedSource.equals("file:/dev/urandom") || seedSource.equals("file:/dev/random")) ? true : false;
    if (bool && bool1)
    ...
    paramMap.put("Signature.SHA224withDSA SupportedKeyClasses", str);
    paramMap.put("Signature.SHA256withDSA SupportedKeyClasses", str);
  ...
  private static final String seedSource = AccessController.<String>doPrivileged(new PrivilegedAction<String>() {
        public String run() {
