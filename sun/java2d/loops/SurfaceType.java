...
public final class SurfaceType {
  ...
  public static final SurfaceType IntRgb = AnyDcm
    .deriveSubType("Integer RGB", PixelConverter.Xrgb.instance);
  
  public static final SurfaceType IntArgb = AnyDcm
    .deriveSubType("Integer ARGB", PixelConverter.Argb.instance);
  
  public static final SurfaceType IntArgbPre = AnyDcm
    .deriveSubType("Integer ARGB Premultiplied", PixelConverter.ArgbPre.instance);
  
  public static final SurfaceType IntBgr = AnyDcm
    .deriveSubType("Integer BGR", PixelConverter.Xbgr.instance);
  
  public static final SurfaceType ThreeByteBgr = Any3Byte
    .deriveSubType("3 Byte BGR", PixelConverter.Xrgb.instance);
  
  public static final SurfaceType FourByteAbgr = Any4Byte
    .deriveSubType("4 Byte ABGR", PixelConverter.Rgba.instance);
  
  public static final SurfaceType FourByteAbgrPre = Any4Byte
    .deriveSubType("4 Byte ABGR Premultiplied", PixelConverter.RgbaPre.instance);
  
  public static final SurfaceType Ushort565Rgb = AnyShort
    .deriveSubType("Short 565 RGB", PixelConverter.Ushort565Rgb.instance);
  
  public static final SurfaceType Ushort555Rgb = AnyShort
    .deriveSubType("Short 555 RGB", PixelConverter.Ushort555Rgb.instance);
  
  public static final SurfaceType Ushort555Rgbx = AnyShort
    .deriveSubType("Short 555 RGBx", PixelConverter.Ushort555Rgbx.instance);
  
  public static final SurfaceType Ushort4444Argb = AnyShort
    .deriveSubType("Short 4444 ARGB", PixelConverter.Ushort4444Argb.instance);
  
  public static final SurfaceType UshortIndexed = AnyShort
    .deriveSubType("16-bit Indexed");
  
  public static final SurfaceType ByteGray = AnyByte
    .deriveSubType("8-bit Gray", PixelConverter.ByteGray.instance);
  
  public static final SurfaceType UshortGray = AnyShort
    .deriveSubType("16-bit Gray", PixelConverter.UshortGray.instance);
  
  public static final SurfaceType ByteBinary1Bit = AnyByteBinary
    .deriveSubType("Packed Binary 1-bit Bitmap");
  
  public static final SurfaceType ByteBinary2Bit = AnyByteBinary
    .deriveSubType("Packed Binary 2-bit Bitmap");
  
  public static final SurfaceType ByteBinary4Bit = AnyByteBinary
    .deriveSubType("Packed Binary 4-bit Bitmap");
  
  public static final SurfaceType ByteIndexed = AnyByte
    .deriveSubType("8-bit Indexed");
  
  public static final SurfaceType IntRgbx = AnyDcm
    .deriveSubType("Integer RGBx", PixelConverter.Rgbx.instance);
  
  public static final SurfaceType IntBgrx = AnyDcm
    .deriveSubType("Integer BGRx", PixelConverter.Bgrx.instance);
  
  public static final SurfaceType ThreeByteRgb = Any3Byte
    .deriveSubType("3 Byte RGB", PixelConverter.Xbgr.instance);
  
  public static final SurfaceType IntArgbBm = AnyDcm
    .deriveSubType("Int ARGB (Bitmask)", PixelConverter.ArgbBm.instance);
  
  public static final SurfaceType ByteIndexedBm = ByteIndexed
    .deriveSubType("8-bit Indexed (Bitmask)");
  
  public static final SurfaceType ByteIndexedOpaque = ByteIndexedBm
    .deriveSubType("8-bit Indexed (Opaque)");
  
  public static final SurfaceType Index8Gray = ByteIndexedOpaque
    .deriveSubType("8-bit Palettized Gray");
  
  public static final SurfaceType Index12Gray = Any
    .deriveSubType("12-bit Palettized Gray");
  
  public static final SurfaceType AnyPaint = Any
    .deriveSubType("Paint Object");
  
  public static final SurfaceType AnyColor = AnyPaint
    .deriveSubType("Single Color");
  
  public static final SurfaceType OpaqueColor = AnyColor
    .deriveSubType("Opaque Color");
  
  public static final SurfaceType GradientPaint = AnyPaint
    .deriveSubType("Gradient Paint");
  
  public static final SurfaceType OpaqueGradientPaint = GradientPaint
    .deriveSubType("Opaque Gradient Paint");
  
  public static final SurfaceType LinearGradientPaint = AnyPaint
    .deriveSubType("Linear Gradient Paint");
  
  public static final SurfaceType OpaqueLinearGradientPaint = LinearGradientPaint
    .deriveSubType("Opaque Linear Gradient Paint");
  
  public static final SurfaceType RadialGradientPaint = AnyPaint
    .deriveSubType("Radial Gradient Paint");
  
  public static final SurfaceType OpaqueRadialGradientPaint = RadialGradientPaint
    .deriveSubType("Opaque Radial Gradient Paint");
  
  public static final SurfaceType TexturePaint = AnyPaint
    .deriveSubType("Texture Paint");
  
  public static final SurfaceType OpaqueTexturePaint = TexturePaint
    .deriveSubType("Opaque Texture Paint");
  ...
  public static final synchronized int makeUniqueID(String paramString) {
    Integer integer = surfaceUIDMap.get(paramString);
    if (integer == null) {
      if (unusedUID > 255)
