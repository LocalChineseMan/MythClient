...
public final class CompositeType {
  ...
  public static final CompositeType OpaqueSrcOverNoEa = SrcOverNoEa.deriveSubType("Porter-Duff Src")
    .deriveSubType("Porter-Duff Src, No Extra Alpha");
  ...
  public static final synchronized int makeUniqueID(String paramString) {
    Integer integer = compositeUIDMap.get(paramString);
    if (integer == null) {
      if (unusedUID > 255)
