...
public abstract class AbstractDelegateHttpsURLConnection extends HttpURLConnection {
  ...
  public void setNewClient(URL paramURL, boolean paramBoolean) throws IOException {
    this.http = HttpsClient.New(getSSLSocketFactory(), paramURL, 
        
        getHostnameVerifier(), paramBoolean, this);
  ...
  protected void proxiedConnect(URL paramURL, String paramString, int paramInt, boolean paramBoolean) throws IOException {
    ...
    this.http = HttpsClient.New(getSSLSocketFactory(), paramURL, 
        ...
        getHostnameVerifier(), paramString, paramInt, paramBoolean, this);
    this.connected = true;
  }
  ...
  protected HttpClient getNewHttpClient(URL paramURL, Proxy paramProxy, int paramInt) throws IOException {
    return HttpsClient.New(getSSLSocketFactory(), paramURL, 
        getHostnameVerifier(), paramProxy, true, paramInt, this);
  }
  
  protected HttpClient getNewHttpClient(URL paramURL, Proxy paramProxy, int paramInt, boolean paramBoolean) throws IOException {
    return HttpsClient.New(getSSLSocketFactory(), paramURL, 
        getHostnameVerifier(), paramProxy, paramBoolean, paramInt, this);
  }
  ...
  public Certificate[] getLocalCertificates() {
    if (this.cachedResponse != null) {
      ...
      if (list == null)
        return null; 
      return list.<Certificate>toArray(new Certificate[0]);
    } 
    if (this.http == null)
      throw new IllegalStateException("connection not yet open"); 
