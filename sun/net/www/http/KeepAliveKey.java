...
class KeepAliveKey {
  ...
  public boolean equals(Object paramObject) {
    ...
    return (this.host.equals(keepAliveKey.host) && this.port == keepAliveKey.port && this.protocol
      
      .equals(keepAliveKey.protocol) && this.obj == keepAliveKey.obj);
  }
  
  public int hashCode() {
    String str = this.protocol + this.host + this.port;
    return (this.obj == null) ? str.hashCode() : (str
