...
public final class InetAddressCachePolicy {
  ...
  static {
    Integer integer = AccessController.<Integer>doPrivileged(new PrivilegedAction<Integer>() {
          public Integer run() {
            try {
    ...
    integer = AccessController.<Integer>doPrivileged(new PrivilegedAction<Integer>() {
          public Integer run() {
            try {
