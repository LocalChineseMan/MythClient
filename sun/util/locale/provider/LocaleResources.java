...
public class LocaleResources {
  ...
  Object getBreakIteratorInfo(String paramString) {
    ...
    ResourceReference resourceReference = this.cache.get(str);
    Object object;
  ...
  public String getCollationData() {
    ...
    String str2 = "";
    removeEmptyReferences();
    ResourceReference resourceReference = this.cache.get("COLD");
  ...
  public Object[] getDecimalFormatSymbolsData() {
    removeEmptyReferences();
    ResourceReference resourceReference = this.cache.get("DFSD");
    ...
    if (resourceReference == null || (arrayOfObject = (Object[])resourceReference.get()) == null) {
      ...
      if (arrayOfObject[0] == null && resourceBundle.containsKey("DefaultNumberingSystem")) {
  ...
  String[] getTimeZoneNames(String paramString, int paramInt) {
    String[] arrayOfString = null;
    String str = "TZN." + paramInt + '.' + paramString;
    removeEmptyReferences();
    ResourceReference resourceReference = this.cache.get(str);
    if (resourceReference == null || (arrayOfString = (String[])resourceReference.get()) == null) {
      ...
      if (timeZoneNamesBundle.containsKey(paramString)) {
        arrayOfString = timeZoneNamesBundle.getStringArray(paramString, paramInt);
  ...
  Set<String> getZoneIDs() {
    Set<String> set = null;
    removeEmptyReferences();
    ResourceReference resourceReference = this.cache.get("ZID");
  ...
  public String getDateTimePattern(int paramInt1, int paramInt2, Calendar paramCalendar) {
    ...
    return getDateTimePattern((String)null, paramInt1, paramInt2, paramCalendar.getCalendarType());
  }
  ...
  public String getJavaTimeDateTimePattern(int paramInt1, int paramInt2, String paramString) {
    ...
    if (str == null)
      str = getDateTimePattern((String)null, paramInt1, paramInt2, paramString); 
    return str;
  }
  ...
  private String getDateTimePattern(String paramString1, int paramInt1, int paramInt2, String paramString2) {
    ...
    if (paramInt1 >= 0) {
      ...
      if (str2 == null)
        str2 = getDateTimePattern((String)null, "TimePatterns", paramInt1, paramString2); 
    } 
    if (paramInt2 >= 0) {
      if (paramString1 != null)
        str3 = getDateTimePattern(paramString1, "DatePatterns", paramInt2, paramString2); 
      if (str3 == null)
        str3 = getDateTimePattern((String)null, "DatePatterns", paramInt2, paramString2); 
    } 
    if (paramInt1 >= 0) {
      if (paramInt2 >= 0) {
        String str = null;
        ...
        if (str == null)
          str = getDateTimePattern((String)null, "DateTimePatterns", 0, paramString2); 
        switch (str) {
          case "{1} {0}":
            str1 = str3 + " " + str2;
            return str1;
  ...
  public String[] getNumberPatterns() {
    String[] arrayOfString = null;
    removeEmptyReferences();
    ResourceReference resourceReference = this.cache.get("NP");
    if (resourceReference == null || (arrayOfString = (String[])resourceReference.get()) == null) {
      ResourceBundle resourceBundle = this.localeData.getNumberFormatData(this.locale);
  ...
  private String getDateTimePattern(String paramString1, String paramString2, int paramInt, String paramString3) {
    ...
    if (resourceReference == null || (object = resourceReference.get()) == null) {
      ...
      if (resourceBundle.containsKey(str1)) {
        object = resourceBundle.getStringArray(str1);
      } else {
        assert !str1.equals(paramString2);
        if (resourceBundle.containsKey(paramString2))
          object = resourceBundle.getStringArray(paramString2); 
      } 
