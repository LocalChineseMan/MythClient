...
public class LanguageTag {
  ...
  private static final Map<String, String[]> GRANDFATHERED = (Map)new HashMap<>();
  ...
  public static LanguageTag parse(String paramString, ParseStatus paramParseStatus) {
    ...
    String[] arrayOfString = GRANDFATHERED.get(LocaleUtils.toLowerString(paramString));
  ...
  public static LanguageTag parseLocale(BaseLocale paramBaseLocale, LocaleExtensions paramLocaleExtensions) {
    ...
    if (paramLocaleExtensions != null) {
      Set<Character> set = paramLocaleExtensions.getKeys();
  ...
  public static boolean isRegion(String paramString) {
    return ((paramString.length() == 2 && LocaleUtils.isAlphaString(paramString)) || (paramString
      .length() == 3 && LocaleUtils.isNumericString(paramString)));
  }
  ...
  public static boolean isVariant(String paramString) {
    ...
    if (i == 4)
      return (LocaleUtils.isNumeric(paramString.charAt(0)) && 
        LocaleUtils.isAlphaNumeric(paramString.charAt(1)) && 
        LocaleUtils.isAlphaNumeric(paramString.charAt(2)) && 
        LocaleUtils.isAlphaNumeric(paramString.charAt(3))); 
    return false;
  }
  
  public static boolean isExtensionSingleton(String paramString) {
    return (paramString.length() == 1 && 
      LocaleUtils.isAlphaString(paramString) && 
      !LocaleUtils.caseIgnoreMatch("x", paramString));
  }
