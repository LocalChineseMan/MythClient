...
public class LoggingSupport {
  private static final LoggingProxy proxy = AccessController.<LoggingProxy>doPrivileged(new PrivilegedAction<LoggingProxy>() {
        public LoggingProxy run() {
          try {
            Class<?> clazz = Class.forName("java.util.logging.LoggingProxyImpl", true, (ClassLoader)null);
