...
public class BytePackedRaster extends SunWritableRaster {
  ...
  public BytePackedRaster(SampleModel paramSampleModel, Point paramPoint) {
    this(paramSampleModel, paramSampleModel
        .createDataBuffer(), new Rectangle(paramPoint.x, paramPoint.y, paramSampleModel
          ...
          .getHeight()), paramPoint, (BytePackedRaster)null);
  }
  ...
  public byte[] getByteData(int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfbyte) {
    ...
    for (byte b2 = 0; b2 < paramInt4; b2++) {
      ...
      switch (i) {
        case 1:
          for (; b < paramInt3 - 7; b += 8) {
            byte b3 = arrayOfByte[n++];
            paramArrayOfbyte[b1++] = (byte)(b3 >> 7 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 >> 6 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 >> 5 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 >> 4 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 >> 3 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 >> 2 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 >> 1 & 0x1);
            paramArrayOfbyte[b1++] = (byte)(b3 & 0x1);
            m += 8;
          } 
          break;
        case 2:
    ...
    if ((k & 0x7) == (m & 0x7)) {
      ...
      if (i1 != 0) {
        ...
        for (byte b = 0; b < paramInt6; b++) {
          ...
          int i6 = b1 & (i5 ^ 0xFFFFFFFF);
          i6 |= arrayOfByte1[i3] & i5;
      ...
      if (n > 0) {
        ...
        for (byte b = 0; b < paramInt6; b++) {
          ...
          int i5 = b1 & (i4 ^ 0xFFFFFFFF);
          i5 |= arrayOfByte1[i2] & i4;
          arrayOfByte2[i3] = (byte)i5;
          i2 += i;
          i3 += j;
        } 
      } 
      ...
      if (i1 != 0 || n < 8) {
        ...
        for (byte b = 0; b < paramInt6; b++) {
          ...
          int i9 = b3 & (i7 ^ 0xFFFFFFFF);
          i9 |= (b1 << i5 | (b2 & 0xFF) >> i6) >> i1 & i7;
      ...
      if (n >= 8) {
        ...
        for (i7 = 0; i7 < paramInt6; i7++) {
          ...
          for (byte b1 = 0; b1 < i4; b1++) {
            ...
            int i10 = b << i5 | (b2 & 0xFF) >> i6;
            arrayOfByte2[i9] = (byte)i10;
            b = b2;
            i8++;
            i9++;
          } 
      ...
      if (n > 0) {
        ...
        for (byte b = 0; b < paramInt6; b++) {
          ...
          int i8 = b3 & (i4 ^ 0xFFFFFFFF);
          i8 |= (b1 << i5 | (b2 & 0xFF) >> i6) & i4;
          arrayOfByte2[i3] = (byte)i8;
          i2 += i;
          i3 += j;
        } 
      } 
  ...
  public void putByteData(int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfbyte) {
    ...
    for (byte b2 = 0; b2 < paramInt4; b2++) {
      ...
      byte b = 0;
      while (b < paramInt3 && (m & 0x7) != 0) {
        int i2 = this.shiftOffset - (m & 0x7);
        byte b3 = arrayOfByte[k + (m >> 3)];
        int i1 = b3 & (this.bitMask << i2 ^ 0xFFFFFFFF);
        i1 |= (paramArrayOfbyte[b1++] & this.bitMask) << i2;
        arrayOfByte[k + (m >> 3)] = (byte)i1;
        m += i;
        b++;
      } 
      int n = k + (m >> 3);
      switch (i) {
        case 1:
          for (; b < paramInt3 - 7; b += 8) {
            int i1 = (paramArrayOfbyte[b1++] & 0x1) << 7;
            i1 |= (paramArrayOfbyte[b1++] & 0x1) << 6;
            i1 |= (paramArrayOfbyte[b1++] & 0x1) << 5;
            i1 |= (paramArrayOfbyte[b1++] & 0x1) << 4;
            i1 |= (paramArrayOfbyte[b1++] & 0x1) << 3;
            i1 |= (paramArrayOfbyte[b1++] & 0x1) << 2;
            i1 |= (paramArrayOfbyte[b1++] & 0x1) << 1;
            i1 |= paramArrayOfbyte[b1++] & 0x1;
        ...
        case 2:
          for (; b < paramInt3 - 7; b += 8) {
            int i1 = (paramArrayOfbyte[b1++] & 0x3) << 6;
            i1 |= (paramArrayOfbyte[b1++] & 0x3) << 4;
            i1 |= (paramArrayOfbyte[b1++] & 0x3) << 2;
            i1 |= paramArrayOfbyte[b1++] & 0x3;
            arrayOfByte[n++] = (byte)i1;
            i1 = (paramArrayOfbyte[b1++] & 0x3) << 6;
            i1 |= (paramArrayOfbyte[b1++] & 0x3) << 4;
            i1 |= (paramArrayOfbyte[b1++] & 0x3) << 2;
            i1 |= paramArrayOfbyte[b1++] & 0x3;
            arrayOfByte[n++] = (byte)i1;
        ...
        case 4:
          for (; b < paramInt3 - 7; b += 8) {
            int i1 = (paramArrayOfbyte[b1++] & 0xF) << 4;
            i1 |= paramArrayOfbyte[b1++] & 0xF;
            arrayOfByte[n++] = (byte)i1;
            i1 = (paramArrayOfbyte[b1++] & 0xF) << 4;
            i1 |= paramArrayOfbyte[b1++] & 0xF;
            arrayOfByte[n++] = (byte)i1;
            i1 = (paramArrayOfbyte[b1++] & 0xF) << 4;
            i1 |= paramArrayOfbyte[b1++] & 0xF;
    ...
    for (byte b2 = 0; b2 < paramInt4; b2++) {
      ...
      switch (i) {
        case 1:
          for (; b < paramInt3 - 7; b += 8) {
            byte b3 = arrayOfByte[n++];
            paramArrayOfint[b1++] = b3 >> 7 & 0x1;
            paramArrayOfint[b1++] = b3 >> 6 & 0x1;
            paramArrayOfint[b1++] = b3 >> 5 & 0x1;
            paramArrayOfint[b1++] = b3 >> 4 & 0x1;
            paramArrayOfint[b1++] = b3 >> 3 & 0x1;
            paramArrayOfint[b1++] = b3 >> 2 & 0x1;
            paramArrayOfint[b1++] = b3 >> 1 & 0x1;
            paramArrayOfint[b1++] = b3 & 0x1;
            m += 8;
          } 
          break;
        case 2:
  ...
  public void setPixels(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint) {
    ...
    for (byte b2 = 0; b2 < paramInt4; b2++) {
      ...
      while (b < paramInt3 && (m & 0x7) != 0) {
        ...
        byte b3 = arrayOfByte[k + (m >> 3)];
        int i1 = b3 & (this.bitMask << i2 ^ 0xFFFFFFFF);
        i1 |= (paramArrayOfint[b1++] & this.bitMask) << i2;
        arrayOfByte[k + (m >> 3)] = (byte)i1;
        m += i;
        b++;
      } 
      ...
      switch (i) {
        case 1:
          for (; b < paramInt3 - 7; b += 8) {
            int i1 = (paramArrayOfint[b1++] & 0x1) << 7;
            i1 |= (paramArrayOfint[b1++] & 0x1) << 6;
            i1 |= (paramArrayOfint[b1++] & 0x1) << 5;
            i1 |= (paramArrayOfint[b1++] & 0x1) << 4;
            i1 |= (paramArrayOfint[b1++] & 0x1) << 3;
            i1 |= (paramArrayOfint[b1++] & 0x1) << 2;
            i1 |= (paramArrayOfint[b1++] & 0x1) << 1;
            i1 |= paramArrayOfint[b1++] & 0x1;
            arrayOfByte[n++] = (byte)i1;
            m += 8;
          } 
          break;
