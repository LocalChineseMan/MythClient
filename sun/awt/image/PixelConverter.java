...
public class PixelConverter {
  ...
  public static class Ushort565Rgb extends PixelConverter {
    ...
    public int rgbToPixel(int param1Int, ColorModel param1ColorModel) {
      return param1Int >> 8 & 0xF800 | param1Int >> 5 & 0x7E0 | param1Int >> 3 & 0x1F;
    }
  ...
  public static class Ushort555Rgbx extends PixelConverter {
    ...
    public int rgbToPixel(int param1Int, ColorModel param1ColorModel) {
      return param1Int >> 8 & 0xF800 | param1Int >> 5 & 0x7C0 | param1Int >> 2 & 0x3E;
    }
  ...
  public static class Ushort555Rgb extends PixelConverter {
    ...
    public int rgbToPixel(int param1Int, ColorModel param1ColorModel) {
      return param1Int >> 9 & 0x7C00 | param1Int >> 6 & 0x3E0 | param1Int >> 3 & 0x1F;
    }
  ...
  public static class Xbgr extends PixelConverter {
    ...
    public int rgbToPixel(int param1Int, ColorModel param1ColorModel) {
      return (param1Int & 0xFF) << 16 | param1Int & 0xFF00 | param1Int >> 16 & 0xFF;
    }
    
    public int pixelToRgb(int param1Int, ColorModel param1ColorModel) {
      return 0xFF000000 | (param1Int & 0xFF) << 16 | param1Int & 0xFF00 | param1Int >> 16 & 0xFF;
    }
  }
  ...
  public static class Bgrx extends PixelConverter {
    ...
    public int rgbToPixel(int param1Int, ColorModel param1ColorModel) {
      return param1Int << 24 | (param1Int & 0xFF00) << 8 | param1Int >> 8 & 0xFF00;
    }
    
    public int pixelToRgb(int param1Int, ColorModel param1ColorModel) {
      return 0xFF000000 | (param1Int & 0xFF00) << 8 | param1Int >> 8 & 0xFF00 | param1Int >>> 24;
    }
  }
  ...
  public static class Rgba extends PixelConverter {
    ...
    public int pixelToRgb(int param1Int, ColorModel param1ColorModel) {
      return param1Int << 24 | param1Int >>> 8;
    }
  }
  ...
  public static class ArgbBm extends PixelConverter {
    ...
    public int rgbToPixel(int param1Int, ColorModel param1ColorModel) {
      return param1Int | param1Int >> 31 << 24;
    }
    
    public int pixelToRgb(int param1Int, ColorModel param1ColorModel) {
      return param1Int << 7 >> 7;
    }
  }
