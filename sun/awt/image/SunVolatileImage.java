...
public class SunVolatileImage extends VolatileImage implements DestSurfaceProvider {
  ...
  public SunVolatileImage(Component paramComponent, int paramInt1, int paramInt2) {
    this(paramComponent, paramInt1, paramInt2, (Object)null);
  }
  
  public SunVolatileImage(Component paramComponent, int paramInt1, int paramInt2, Object paramObject) {
    this(paramComponent, paramComponent.getGraphicsConfiguration(), paramInt1, paramInt2, paramObject, (ImageCapabilities)null);
  }
  ...
  public SunVolatileImage(GraphicsConfiguration paramGraphicsConfiguration, int paramInt1, int paramInt2, int paramInt3, ImageCapabilities paramImageCapabilities) {
    this((Component)null, paramGraphicsConfiguration, paramInt1, paramInt2, (Object)null, paramInt3, paramImageCapabilities, 0);
  }
  ...
  protected VolatileSurfaceManager createSurfaceManager(Object paramObject, ImageCapabilities paramImageCapabilities) {
    if (this.graphicsConfig instanceof BufferedImageGraphicsConfig || this.graphicsConfig instanceof sun.print.PrinterGraphicsConfig || (paramImageCapabilities != null && 
      
      !paramImageCapabilities.isAccelerated()))
  ...
  public Graphics2D createGraphics() {
    return new SunGraphics2D(this.volSurfaceManager.getPrimarySurfaceData(), 
        getForeground(), 
        getBackground(), 
        getFont());
  }
  ...
  public BufferedImage getSnapshot() {
    ...
    graphics2D.drawImage(this, 0, 0, (ImageObserver)null);
    graphics2D.dispose();
