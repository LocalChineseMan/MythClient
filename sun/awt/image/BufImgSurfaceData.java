...
public class BufImgSurfaceData extends SurfaceData {
  ...
  public static SurfaceData createData(BufferedImage paramBufferedImage) {
    ...
    switch (i) {
      ...
      case 7:
        ...
        return surfaceData;
      case 8:
        surfaceData = createDataSC(paramBufferedImage, SurfaceType.Ushort565Rgb, (IndexColorModel)null);
        ((BufImgSurfaceData)surfaceData).initSolidLoops();
        return surfaceData;
      case 9:
        surfaceData = createDataSC(paramBufferedImage, SurfaceType.Ushort555Rgb, (IndexColorModel)null);
        ((BufImgSurfaceData)surfaceData).initSolidLoops();
        return surfaceData;
      case 13:
      ...
      case 10:
        ...
        return surfaceData;
      case 11:
        surfaceData = createDataSC(paramBufferedImage, SurfaceType.UshortGray, (IndexColorModel)null);
        ((BufImgSurfaceData)surfaceData).initSolidLoops();
        return surfaceData;
      case 12:
  ...
  public static SurfaceData createDataIC(BufferedImage paramBufferedImage, SurfaceType paramSurfaceType) {
    ...
    bufImgSurfaceData.initRaster(integerComponentRaster.getDataStorage(), integerComponentRaster
        .getDataOffset(0) * 4, 0, integerComponentRaster
        .getWidth(), integerComponentRaster
        .getHeight(), integerComponentRaster
        .getPixelStride() * 4, integerComponentRaster
        .getScanlineStride() * 4, (IndexColorModel)null);
  ...
  public static SurfaceData createDataSC(BufferedImage paramBufferedImage, SurfaceType paramSurfaceType, IndexColorModel paramIndexColorModel) {
    ...
    bufImgSurfaceData.initRaster(shortComponentRaster.getDataStorage(), shortComponentRaster
        .getDataOffset(0) * 2, 0, shortComponentRaster
        .getWidth(), shortComponentRaster
        .getHeight(), shortComponentRaster
        .getPixelStride() * 2, shortComponentRaster
        .getScanlineStride() * 2, paramIndexColorModel);
    return bufImgSurfaceData;
  }
  ...
  public static SurfaceData createDataBC(BufferedImage paramBufferedImage, SurfaceType paramSurfaceType, int paramInt) {
    ...
    bufImgSurfaceData.initRaster(byteComponentRaster.getDataStorage(), byteComponentRaster
        .getDataOffset(paramInt), 0, byteComponentRaster
        .getWidth(), byteComponentRaster
        .getHeight(), byteComponentRaster
        .getPixelStride(), byteComponentRaster
        .getScanlineStride(), indexColorModel);
    return bufImgSurfaceData;
  }
  ...
  public static SurfaceData createDataBP(BufferedImage paramBufferedImage, SurfaceType paramSurfaceType) {
    ...
    ColorModel colorModel = paramBufferedImage.getColorModel();
    IndexColorModel indexColorModel = (colorModel instanceof IndexColorModel) ? (IndexColorModel)colorModel : null;
    bufImgSurfaceData.initRaster(bytePackedRaster.getDataStorage(), bytePackedRaster
        .getDataBitOffset() / 8, bytePackedRaster
        .getDataBitOffset() & 0x7, bytePackedRaster
        .getWidth(), bytePackedRaster
        .getHeight(), 0, bytePackedRaster
  ...
  public BufImgSurfaceData(DataBuffer paramDataBuffer, BufferedImage paramBufferedImage, SurfaceType paramSurfaceType) {
    super(SunWritableRaster.stealTrackable(paramDataBuffer), paramSurfaceType, paramBufferedImage
        .getColorModel());
