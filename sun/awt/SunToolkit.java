...
public abstract class SunToolkit extends Toolkit implements WindowClosingSupport, WindowClosingListener, ComponentFactory, InputMethodSupport, KeyboardFocusManagerPeerProvider {
  ...
  static {
    if (((Boolean)AccessController.<Boolean>doPrivileged(new GetBooleanAction("sun.awt.nativedebug"))).booleanValue())
      DebugSettings.init(); 
  }
  ...
  public static final void awtLockWait(long paramLong) throws InterruptedException {
  ...
  public static AppContext targetToAppContext(Object paramObject) {
    ...
    if (appContext == null)
      appContext = appContextMap.get(paramObject); 
    return appContext;
  }
  ...
  public static void postPriorityEvent(AWTEvent paramAWTEvent) {
    PeerEvent peerEvent = new PeerEvent(Toolkit.getDefaultToolkit(), (Runnable)new Object(paramAWTEvent), 2L);
  ...
  public static void executeOnEventHandlerThread(Object paramObject, Runnable paramRunnable, long paramLong) {
    executeOnEventHandlerThread((PeerEvent)new Object(paramObject, paramRunnable, 1L, paramLong));
  }
  ...
  public static void executeOnEDTAndWait(Object paramObject, Runnable paramRunnable) throws InterruptedException, InvocationTargetException {
  ...
  public static boolean getSunAwtNoerasebackground() {
    return ((Boolean)AccessController.<Boolean>doPrivileged(new GetBooleanAction("sun.awt.noerasebackground"))).booleanValue();
  }
  
  public static boolean getSunAwtErasebackgroundonresize() {
    return ((Boolean)AccessController.<Boolean>doPrivileged(new GetBooleanAction("sun.awt.erasebackgroundonresize"))).booleanValue();
  }
  ...
  static Image getImageFromHash(Toolkit paramToolkit, URL paramURL) {
    ...
    synchronized (imgCache) {
      Image image = (Image)imgCache.get(paramURL);
      if (image == null)
        try {
          image = paramToolkit.createImage(new URLImageSource(paramURL));
          imgCache.put(paramURL, image);
        } catch (Exception exception) {} 
      return image;
    } 
  }
  ...
  static Image getImageFromHash(Toolkit paramToolkit, String paramString) {
    ...
    synchronized (imgCache) {
      Image image = (Image)imgCache.get(paramString);
      if (image == null)
        try {
          image = paramToolkit.createImage(new FileImageSource(paramString));
          imgCache.put(paramString, image);
        } catch (Exception exception) {} 
      return image;
    } 
  }
  ...
  public Image getImage(String paramString) {
    return getImageFromHash((Toolkit)this, paramString);
  }
  
  public Image getImage(URL paramURL) {
    return getImageFromHash((Toolkit)this, paramURL);
  }
  
  protected Image getImageWithResolutionVariant(String paramString1, String paramString2) {
    synchronized (imgCache) {
      Image image1 = getImageFromHash((Toolkit)this, paramString1);
      if (image1 instanceof sun.awt.image.MultiResolutionImage)
        return image1; 
      Image image2 = getImageFromHash((Toolkit)this, paramString2);
      image1 = createImageWithResolutionVariant(image1, image2);
      imgCache.put(paramString1, image1);
      return image1;
    } 
  }
  ...
  protected Image getImageWithResolutionVariant(URL paramURL1, URL paramURL2) {
    synchronized (imgCache) {
      Image image1 = getImageFromHash((Toolkit)this, paramURL1);
      if (image1 instanceof sun.awt.image.MultiResolutionImage)
        return image1; 
      Image image2 = getImageFromHash((Toolkit)this, paramURL2);
      image1 = createImageWithResolutionVariant(image1, image2);
      imgCache.put(paramURL1, image1);
      return image1;
    } 
  }
  ...
  protected static boolean imageCached(Object paramObject) {
    return imgCache.containsKey(paramObject);
  }
  ...
  public static EventQueue getSystemEventQueueImplPP(AppContext paramAppContext) {
    return (EventQueue)paramAppContext.get(AppContext.EVENT_QUEUE_KEY);
  }
  ...
  public static Locale getStartupLocale() {
    if (startupLocale == null) {
      String str3, str4, str1 = AccessController.<String>doPrivileged(new GetPropertyAction("user.language", "en"));
      String str2 = AccessController.<String>doPrivileged(new GetPropertyAction("user.region"));
      if (str2 != null) {
        ...
        str3 = AccessController.<String>doPrivileged(new GetPropertyAction("user.country", ""));
        str4 = AccessController.<String>doPrivileged(new GetPropertyAction("user.variant", ""));
      } 
  ...
  protected synchronized MouseInfoPeer getMouseInfoPeer() {
    ...
    return (MouseInfoPeer)mPeer;
  }
  
  public static boolean needsXEmbed() {
    String str = AccessController.<String>doPrivileged(new GetPropertyAction("sun.awt.noxembed", "false"));
    if ("true".equals(str))
      return false; 
  ...
  protected final boolean isXEmbedServerRequested() {
    return ((Boolean)AccessController.<Boolean>doPrivileged(new GetBooleanAction("sun.awt.xembedserver"))).booleanValue();
  }
  ...
  public static class SunToolkit {}
  ...
  static class ModalityListenerList implements ModalityListener {
    ...
    void add(ModalityListener param1ModalityListener) {
      this.listeners.addElement(param1ModalityListener);
    }
    
    void remove(ModalityListener param1ModalityListener) {
      this.listeners.removeElement(param1ModalityListener);
    }
  ...
  public void realSync(long paramLong) throws OperationTimedOut, InfiniteLoop {
    if (EventQueue.isDispatchThread())
  ...
  protected final boolean waitForIdle(long paramLong) {
    ...
    synchronized (this.waitLock) {
      postEvent(AppContext.getAppContext(), (AWTEvent)new Object(this, 
            getSystemEventQueueImpl(), null, 4L, paramLong));
      try {
  ...
  private void fireDesktopFontPropertyChanges() {
    setDesktopProperty("awt.font.desktophints", 
        getDesktopFontHints());
  }
  ...
  private static boolean useSystemAAFontSettings() {
    if (!checkedSystemAAFontSettings) {
      ...
      Toolkit toolkit = Toolkit.getDefaultToolkit();
      if (toolkit instanceof SunToolkit)
        str = AccessController.<String>doPrivileged(new GetPropertyAction("awt.useSystemAAFontSettings")); 
      if (str != null) {
  ...
  public static RenderingHints getDesktopFontHints() {
    if (useSystemAAFontSettings()) {
      Toolkit toolkit = Toolkit.getDefaultToolkit();
      if (toolkit instanceof SunToolkit)
        return ((SunToolkit)toolkit).getDesktopAAHints(); 
      return null;
    } 
  ...
  public static synchronized void consumeNextKeyTyped(KeyEvent paramKeyEvent) {
    try {
      AWTAccessor.getDefaultKeyboardFocusManagerAccessor().consumeNextKeyTyped(
          ...
          (DefaultKeyboardFocusManager)KeyboardFocusManager.getCurrentKeyboardFocusManager(), paramKeyEvent);
  ...
  public static synchronized boolean getSunAwtDisableMixing() {
    if (sunAwtDisableMixing == null)
      sunAwtDisableMixing = AccessController.<Boolean>doPrivileged(new GetBooleanAction("sun.awt.disableMixing")); 
  ...
  public synchronized void setWindowDeactivationTime(Window paramWindow, long paramLong) {
    ...
    WeakHashMap<Object, Object> weakHashMap = (WeakHashMap)appContext.get(DEACTIVATION_TIMES_MAP_KEY);
    if (weakHashMap == null) {
  ...
  public synchronized long getWindowDeactivationTime(Window paramWindow) {
    ...
    if (weakHashMap == null)
      return -1L; 
    Long long_ = (Long)weakHashMap.get(paramWindow);
    return (long_ == null) ? -1L : long_.longValue();
  }
  ...
  protected static LightweightFrame getLightweightFrame(Component paramComponent) {
    for (; paramComponent != null; paramComponent = paramComponent.getParent()) {
