...
public class SunHints {
  ...
  public static class Key extends RenderingHints.Key {
    ...
    public boolean isCompatibleValue(Object param1Object) {
      if (param1Object instanceof SunHints.Value)
        return ((SunHints.Value)param1Object).isCompatibleKey(this); 
      return false;
    }
  }
  ...
  public static class Value {
    ...
    public static Value get(int param1Int1, int param1Int2) {
      return ValueObjects[param1Int1][param1Int2];
    }
