...
class WindowsFileAttributes implements DosFileAttributes {
  ...
  static {
    String str = AccessController.<String>doPrivileged(new GetPropertyAction("sun.nio.fs.ensureAccurateMetadata", "false"));
  ...
  private static WindowsFileAttributes fromFileInformation(long paramLong, int paramInt) {
    ...
    long l4 = (unsafe.getInt(paramLong + 32L) << 32L) + (unsafe.getInt(paramLong + 36L) & 0xFFFFFFFFL);
  ...
  private static WindowsFileAttributes fromFileAttributeData(long paramLong, int paramInt) {
    ...
    long l2 = unsafe.getLong(paramLong + 12L);
    long l3 = unsafe.getLong(paramLong + 20L);
    long l4 = (unsafe.getInt(paramLong + 28L) << 32L) + (unsafe.getInt(paramLong + 32L) & 0xFFFFFFFFL);
  ...
  static WindowsFileAttributes fromFindData(long paramLong) {
    ...
    long l3 = unsafe.getLong(paramLong + 20L);
    long l4 = (unsafe.getInt(paramLong + 28L) << 32L) + (unsafe.getInt(paramLong + 32L) & 0xFFFFFFFFL);
    boolean bool = isReparsePoint(i) ? unsafe.getInt(paramLong + 36L) : false;
    return new WindowsFileAttributes(i, l1, l2, l3, l4, bool, 0, 0, 0);
  }
  ...
  static WindowsFileAttributes readAttributes(long paramLong) throws WindowsException {
    ...
    try {
      ...
      if (isReparsePoint(j)) {
        char c = '䀀';
        NativeBuffer nativeBuffer1 = NativeBuffers.getNativeBuffer(c);
        try {
  ...
  static WindowsFileAttributes get(WindowsPath paramWindowsPath, boolean paramBoolean) throws WindowsException {
    ...
    long l = paramWindowsPath.openForReadAttributeAccess(paramBoolean);
    try {
  ...
  static boolean isSameFile(WindowsFileAttributes paramWindowsFileAttributes1, WindowsFileAttributes paramWindowsFileAttributes2) {
    return (paramWindowsFileAttributes1.volSerialNumber == paramWindowsFileAttributes2.volSerialNumber && paramWindowsFileAttributes1.fileIndexHigh == paramWindowsFileAttributes2.fileIndexHigh && paramWindowsFileAttributes1.fileIndexLow == paramWindowsFileAttributes2.fileIndexLow);
  }
  ...
  public boolean isReadOnly() {
    return ((this.fileAttrs & 0x1) != 0);
  }
  
  public boolean isHidden() {
    return ((this.fileAttrs & 0x2) != 0);
  }
