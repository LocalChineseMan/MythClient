...
public final class FontDesignMetrics extends FontMetrics {
  ...
  private static class MetricsKey {
    ...
    MetricsKey(Font param1Font, FontRenderContext param1FontRenderContext) {
      init(param1Font, param1FontRenderContext);
    }
    ...
    public boolean equals(Object param1Object) {
      if (!(param1Object instanceof MetricsKey))
        return false; 
      return (this.font
        .equals(((MetricsKey)param1Object).font) && this.frc
        .equals(((MetricsKey)param1Object).frc));
    }
  ...
  public static FontDesignMetrics getMetrics(Font paramFont, FontRenderContext paramFontRenderContext) {
    ...
    if (sunFontManager.maybeUsingAlternateCompositeFonts() && 
      FontUtilities.getFont2D(paramFont) instanceof CompositeFont)
    ...
    if (bool) {
      keyReference = metricsCache.get(paramFont);
    } else {
