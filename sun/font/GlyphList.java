...
public final class GlyphList {
  ...
  public void setGlyphIndex(int paramInt) {
    ...
    if (this.usePositions) {
      ...
      this.gposx += StrikeCache.unsafe
        .getFloat(this.images[paramInt] + StrikeCache.xAdvanceOffset);
      this.gposy += StrikeCache.unsafe
        .getFloat(this.images[paramInt] + StrikeCache.yAdvanceOffset);
    } 
    this.metrics[2] = StrikeCache.unsafe
      .getChar(this.images[paramInt] + StrikeCache.widthOffset);
    this.metrics[3] = StrikeCache.unsafe
      .getChar(this.images[paramInt] + StrikeCache.heightOffset);
    this.metrics[4] = StrikeCache.unsafe
      .getChar(this.images[paramInt] + StrikeCache.rowBytesOffset);
  }
  ...
  private void fillBounds(int[] paramArrayOfint) {
    ...
    float f2 = Float.POSITIVE_INFINITY, f1 = f2;
    float f4 = Float.NEGATIVE_INFINITY, f3 = f4;
    byte b1 = 0;
    float f5 = this.x + 0.5F;
    float f6 = this.y + 0.5F;
    for (byte b2 = 0; b2 < this.len; b2++) {
      float f9, f10, f7 = StrikeCache.unsafe.getFloat(this.images[b2] + i);
