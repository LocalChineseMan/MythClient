...
public class HotSpotDiagnostic implements HotSpotDiagnosticMXBean {
  ...
  public List<VMOption> getDiagnosticOptions() {
    ...
    ArrayList<VMOption> arrayList = new ArrayList();
    for (Flag flag : list) {
  ...
  public void setVMOption(String paramString1, String paramString2) {
    ...
    if (object instanceof Long) {
      ...
      if (!paramString2.equalsIgnoreCase("true") && 
        !paramString2.equalsIgnoreCase("false"))
      ...
      throw new IllegalArgumentException("VM Option \"" + paramString1 + "\" is of an unsupported type: " + object
