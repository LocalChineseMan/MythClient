...
class MemoryPoolImpl implements MemoryPoolMXBean {
  ...
  public void setUsageThreshold(long paramLong) {
    ...
    if (memoryUsage.getMax() != -1L && paramLong > memoryUsage.getMax())
      throw new IllegalArgumentException("Invalid threshold: " + paramLong + " must be <= maxSize." + " Committed = " + memoryUsage
          
          .getCommitted() + " Max = " + memoryUsage
          .getMax()); 
    synchronized (this) {
  ...
  public boolean isUsageThresholdExceeded() {
    ...
    if (this.usageThreshold == 0L)
      return false; 
    MemoryUsage memoryUsage = getUsage0();
    return (memoryUsage.getUsed() >= this.usageThreshold || this.usageSensor
      .isOn());
  }
  ...
  public void setCollectionUsageThreshold(long paramLong) {
    ...
    if (paramLong < 0L)
      throw new IllegalArgumentException("Invalid threshold: " + paramLong); 
    if (memoryUsage.getMax() != -1L && paramLong > memoryUsage.getMax())
      throw new IllegalArgumentException("Invalid threshold: " + paramLong + " > max (" + memoryUsage
  ...
  public boolean isCollectionUsageThresholdExceeded() {
    ...
    return (this.gcSensor.isOn() || (memoryUsage != null && memoryUsage
      .getUsed() >= this.collectionThreshold));
  }
  ...
  class PoolSensor extends Sensor {
    ...
    void triggerAction(MemoryUsage param1MemoryUsage) {
      MemoryImpl.createNotification("java.management.memory.threshold.exceeded", this.pool
          .getName(), param1MemoryUsage, 
  ...
  class CollectionSensor extends Sensor {
    ...
    void triggerAction(MemoryUsage param1MemoryUsage) {
      MemoryImpl.createNotification("java.management.memory.collection.threshold.exceeded", this.pool
          .getName(), param1MemoryUsage, MemoryPoolImpl.this
