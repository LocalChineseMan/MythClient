...
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
  ...
  private void notifyListeners() {
      ...
      if (stackDepth < 8) {
        ...
        try {
          if (listeners instanceof DefaultFutureListeners) {
            notifyListeners0((Future<?>)this, (DefaultFutureListeners)listeners);
          } else {
            GenericFutureListener<? extends Future<V>> l = (GenericFutureListener<? extends Future<V>>)listeners;
            notifyListener0((Future)this, l);
          } 
        } finally {
          this.listeners = null;
    ...
    if (listeners instanceof DefaultFutureListeners) {
      ...
      execute(executor, (Runnable)new Object(this, dfl));
    } else {
      GenericFutureListener<? extends Future<V>> l = (GenericFutureListener<? extends Future<V>>)listeners;
      execute(executor, (Runnable)new Object(this, l));
    } 
  }
  ...
  protected static void notifyListener(EventExecutor eventExecutor, Future<?> future, GenericFutureListener<?> l) {
    ...
    execute(eventExecutor, (Runnable)new Object(future, l));
  }
  ...
  void notifyProgressiveListeners(long progress, long total) {
    ...
    if (listeners == null)
      return; 
    ProgressiveFuture<V> self = (ProgressiveFuture<V>)this;
    EventExecutor executor = executor();
    if (executor.inEventLoop()) {
      if (listeners instanceof GenericProgressiveFutureListener[]) {
      ...
      GenericProgressiveFutureListener[] arrayOfGenericProgressiveFutureListener = (GenericProgressiveFutureListener[])listeners;
      execute(executor, (Runnable)new Object(this, self, arrayOfGenericProgressiveFutureListener, progress, total));
    } else {
      GenericProgressiveFutureListener<ProgressiveFuture<V>> l = (GenericProgressiveFutureListener<ProgressiveFuture<V>>)listeners;
      execute(executor, (Runnable)new Object(this, self, l, progress, total));
    } 
  }
    ...
    public void run() {
      if (DefaultPromise.this.listeners == null) {
        while (true) {
          ...
          if (l == null)
            break; 
          DefaultPromise.notifyListener0((Future)DefaultPromise.this, l);
        } 
      } else {
