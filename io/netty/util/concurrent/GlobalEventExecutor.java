...
public final class GlobalEventExecutor extends AbstractEventExecutor {
  ...
  final ScheduledFutureTask<Void> purgeTask = new ScheduledFutureTask<Void>((EventExecutor)this, this.delayedTaskQueue, Executors.callable(new PurgeTask(), null), ScheduledFutureTask.deadlineNanos(SCHEDULE_PURGE_INTERVAL), -SCHEDULE_PURGE_INTERVAL);
  ...
  private final Future<?> terminationFuture = new FailedFuture((EventExecutor)this, new UnsupportedOperationException());
  ...
  public ScheduledFuture<?> schedule(Runnable command, long delay, TimeUnit unit) {
    ...
    return schedule(new ScheduledFutureTask((EventExecutor)this, this.delayedTaskQueue, command, null, ScheduledFutureTask.deadlineNanos(unit.toNanos(delay))));
  }
  ...
  public <V> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
    ...
    if (delay < 0L)
      throw new IllegalArgumentException(String.format("delay: %d (expected: >= 0)", new Object[] { Long.valueOf(delay) })); 
    return schedule(new ScheduledFutureTask<V>((EventExecutor)this, this.delayedTaskQueue, callable, ScheduledFutureTask.deadlineNanos(unit.toNanos(delay))));
  }
  ...
  public ScheduledFuture<?> scheduleAtFixedRate(Runnable command, long initialDelay, long period, TimeUnit unit) {
    ...
    return schedule(new ScheduledFutureTask((EventExecutor)this, this.delayedTaskQueue, Executors.callable(command, null), ScheduledFutureTask.deadlineNanos(unit.toNanos(initialDelay)), unit.toNanos(period)));
  }
  ...
  public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay, long delay, TimeUnit unit) {
    ...
    if (delay <= 0L)
      throw new IllegalArgumentException(String.format("delay: %d (expected: > 0)", new Object[] { Long.valueOf(delay) })); 
    return schedule(new ScheduledFutureTask((EventExecutor)this, this.delayedTaskQueue, Executors.callable(command, null), ScheduledFutureTask.deadlineNanos(unit.toNanos(initialDelay)), -unit.toNanos(delay)));
  }
  ...
  private <V> ScheduledFuture<V> schedule(ScheduledFutureTask<V> task) {
    ...
    if (inEventLoop()) {
      ...
      execute((Runnable)new Object(this, task));
    } 
    return task;
  }
