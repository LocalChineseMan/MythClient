...
public abstract class SingleThreadEventExecutor extends AbstractEventExecutor {
  ...
  private void startThread() {
    if (STATE_UPDATER.get(this) == 1 && 
      ...
      this.delayedTaskQueue.add(new ScheduledFutureTask((EventExecutor)this, this.delayedTaskQueue, Executors.callable(new PurgeTask(), null), ScheduledFutureTask.deadlineNanos(SCHEDULE_PURGE_INTERVAL), -SCHEDULE_PURGE_INTERVAL));
      this.thread.start();
    } 
  }
