...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
  ...
  protected AbstractChannel(Channel parent) {
    this.parent = parent;
    this.unsafe = (Channel.Unsafe)newUnsafe();
  ...
  public ChannelFuture newFailedFuture(Throwable cause) {
    return (ChannelFuture)new FailedChannelFuture(this, null, cause);
  }
  ...
  protected abstract class AbstractUnsafe implements Channel.Unsafe {
    ...
    public final void disconnect(ChannelPromise promise) {
      ...
      if (wasActive && !AbstractChannel.this.isActive())
        invokeLater((Runnable)new Object(this)); 
      safeSetSuccess(promise);
      closeIfClosed();
    }
    ...
    public final void close(ChannelPromise promise) {
      if (!promise.setUncancellable())
        return; 
      if (this.inFlush0) {
        invokeLater((Runnable)new Object(this, promise));
        return;
      } 
    ...
    public final void beginRead() {
      ...
      try {
        ...
        invokeLater((Runnable)new Object(this, e));
        close(voidPromise());
      } 
    }
